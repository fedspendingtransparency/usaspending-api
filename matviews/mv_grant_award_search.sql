...
CREATE MATERIALIZED VIEW mv_grant_award_search_temp AS
SELECT
...
WHERE
  ...
  AND awards.type IN ('02','03','04','05')
ORDER BY
...
CREATE INDEX idx_e4637983$8ce_recipient_hash_temp ON mv_grant_award_search_temp USING BTREE(recipient_hash) WITH (fillfactor = 97);
CREATE INDEX idx_e4637983$8ce_recipient_unique_id_temp ON mv_grant_award_search_temp USING BTREE(recipient_unique_id) WITH (fillfactor = 97) WHERE recipient_unique_id IS NOT NULL;
...
CREATE INDEX idx_e4637983$8ce_funding_agency_id_temp ON mv_grant_award_search_temp USING BTREE(funding_agency_id ASC NULLS LAST) WITH (fillfactor = 97) WHERE funding_agency_id IS NOT NULL;
CREATE INDEX idx_e4637983$8ce_recipient_location_state_code_temp ON mv_grant_award_search_temp USING BTREE(recipient_location_state_code) WITH (fillfactor = 97) WHERE recipient_location_state_code IS NOT NULL;
...
CREATE INDEX idx_e4637983$8ce_recipient_location_cong_code_temp ON mv_grant_award_search_temp USING BTREE(recipient_location_congressional_code) WITH (fillfactor = 97) WHERE recipient_location_congressional_code IS NOT NULL;


ALTER MATERIALIZED VIEW IF EXISTS mv_grant_award_search RENAME TO mv_grant_award_search_old;
ALTER INDEX IF EXISTS idx_e4637983$8ce_id RENAME TO idx_e4637983$8ce_id_old;
ALTER INDEX IF EXISTS idx_e4637983$8ce_recipient_hash RENAME TO idx_e4637983$8ce_recipient_hash_old;
ALTER INDEX IF EXISTS idx_e4637983$8ce_recipient_unique_id RENAME TO idx_e4637983$8ce_recipient_unique_id_old;
ALTER INDEX IF EXISTS idx_e4637983$8ce_action_date RENAME TO idx_e4637983$8ce_action_date_old;
ALTER INDEX IF EXISTS idx_e4637983$8ce_funding_agency_id RENAME TO idx_e4637983$8ce_funding_agency_id_old;
ALTER INDEX IF EXISTS idx_e4637983$8ce_recipient_location_state_code RENAME TO idx_e4637983$8ce_recipient_location_state_code_old;
ALTER INDEX IF EXISTS idx_e4637983$8ce_recipient_location_county_code RENAME TO idx_e4637983$8ce_recipient_location_county_code_old;
ALTER INDEX IF EXISTS idx_e4637983$8ce_recipient_location_cong_code RENAME TO idx_e4637983$8ce_recipient_location_cong_code_old;


ALTER MATERIALIZED VIEW mv_grant_award_search_temp RENAME TO mv_grant_award_search;
ALTER INDEX idx_e4637983$8ce_id_temp RENAME TO idx_e4637983$8ce_id;
ALTER INDEX idx_e4637983$8ce_recipient_hash_temp RENAME TO idx_e4637983$8ce_recipient_hash;
ALTER INDEX idx_e4637983$8ce_recipient_unique_id_temp RENAME TO idx_e4637983$8ce_recipient_unique_id;
ALTER INDEX idx_e4637983$8ce_action_date_temp RENAME TO idx_e4637983$8ce_action_date;
ALTER INDEX idx_e4637983$8ce_funding_agency_id_temp RENAME TO idx_e4637983$8ce_funding_agency_id;
ALTER INDEX idx_e4637983$8ce_recipient_location_state_code_temp RENAME TO idx_e4637983$8ce_recipient_location_state_code;
ALTER INDEX idx_e4637983$8ce_recipient_location_county_code_temp RENAME TO idx_e4637983$8ce_recipient_location_county_code;
ALTER INDEX idx_e4637983$8ce_recipient_location_cong_code_temp RENAME TO idx_e4637983$8ce_recipient_location_cong_code;


ANALYZE VERBOSE mv_grant_award_search;
GRANT SELECT ON mv_grant_award_search TO readonly;
