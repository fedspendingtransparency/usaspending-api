...
def disaster_account_data():
    ...
    a1 = baker.make(
        "search.AwardSearch", award_id=1, total_loan_value=333, type="07", funding_agency=ag1, latest_transaction_id=10
    )  # Loan
    a2 = baker.make(
        "search.AwardSearch", award_id=2, total_loan_value=444, type="02", funding_agency=ag2, latest_transaction_id=20
    )  # Block Grant - subtier sister to a4
    a3 = baker.make(
        "search.AwardSearch", award_id=3, total_loan_value=444, type="A", funding_agency=ag3, latest_transaction_id=30
    )  # BPA Call
    a4 = baker.make(
        "search.AwardSearch", award_id=4, total_loan_value=555, type="02", funding_agency=ag3, latest_transaction_id=40
    )  # Block Grant - subtier sister to a2
    a5 = baker.make(
        "search.AwardSearch", award_id=5, total_loan_value=666, type="02", funding_agency=ag4, latest_transaction_id=50
    )
