...
def awards_and_transactions():
    # Awards
    award1 = baker.make("search.AwardSearch", latest_transaction_id=10, type="07", total_loan_value=3)
    award2 = baker.make("search.AwardSearch", latest_transaction_id=20, type="07", total_loan_value=30)
    award3 = baker.make("search.AwardSearch", latest_transaction_id=30, type="08", total_loan_value=300)
    award4 = baker.make("search.AwardSearch", latest_transaction_id=50, type="B", total_loan_value=0)
    award5 = baker.make("search.AwardSearch", latest_transaction_id=40, type="A", total_loan_value=0)
    award6 = baker.make("search.AwardSearch", latest_transaction_id=60, type="C", total_loan_value=0)
    award7 = baker.make("search.AwardSearch", latest_transaction_id=70, type="D", total_loan_value=0)
