...
class Command(BaseCommand):
    ...
    compute_flavors = {
        ...
        "databricks": {
            ...
            "working_dir_path": S3Path("/dti-usaspending-bulk-download-qat/csv_downloads"),
            "covid_profile_output_dir_path": S3Path("/dti-usaspending-bulk-download-qat"),
    ...
    def store_record_in_database(self):
        download_record = DownloadJob.objects.create(
            file_name=self.covid_profile_zip_file_name,
