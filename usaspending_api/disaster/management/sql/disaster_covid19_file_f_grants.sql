SELECT
    ...
    (SELECT STRING_AGG(DISTINCT CONCAT(U0."cfda_number", ': ', U0."cfda_title"), '; ' ) AS "total" FROM "transaction_fabs" U0 INNER JOIN "transaction_normalized" U1 ON (U0."transaction_id" = U1."id") WHERE U1."award_id" = ("subaward_view"."award_id") GROUP BY U1."award_id") AS "prime_award_cfda_numbers_and_titles",    "broker_subaward"."subaward_type" AS "subaward_type",
