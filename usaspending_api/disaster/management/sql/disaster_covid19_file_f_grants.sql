SELECT
    ...
    "subaward_search"."transaction_fabs"."uei" AS "prime_awardee_uei",
    ...
    "subaward_search"."transaction_fabs"."ultimate_parent_uei" AS "prime_awardee_parent_uei",
    ...
    "subaward_search"."transaction_fabs"."legal_entity_county_name" AS "prime_awardee_county_name",
