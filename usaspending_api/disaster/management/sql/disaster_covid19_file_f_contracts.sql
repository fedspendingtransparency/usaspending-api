SELECT
    ...
    "subaward_search"."transaction_fpds"."awardee_or_recipient_uei" AS "prime_awardee_uei",
    ...
    "subaward_search"."transaction_fpds"."ultimate_parent_uei" AS "prime_awardee_parent_uei",
    ...
    "subaward_search"."transaction_fpds"."legal_entity_county_name" AS "prime_awardee_county_name",
    ...
    "subaward_search"."transaction_fpds"."national_interest_action" AS "prime_award_national_interest_action_code",
    "subaward_search"."transaction_fpds"."national_interest_desc" AS "prime_award_national_interest_action",
