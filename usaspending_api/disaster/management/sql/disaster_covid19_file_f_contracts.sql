SELECT
    ...
    "subaward_search"."legal_entity_congressional" AS "prime_award_summary_recipient_cd_original",
    "subaward_search"."legal_entity_congressional_current" AS "prime_award_summary_recipient_cd_current",
    ...
    "subaward_search"."place_of_perform_congressio" AS "prime_award_summary_place_of_performance_cd_original",
    "subaward_search"."place_of_performance_congressional_current" AS "prime_award_summary_place_of_performance_cd_current",
    ...
    "subaward_search"."sub_legal_entity_congressional" AS "subaward_recipient_cd_original",
    "subaward_search"."sub_legal_entity_congressional_current" AS "subaward_recipient_cd_current",
    ...
    "subaward_search"."sub_place_of_perform_congressio" AS "subaward_place_of_performance_cd_original",
    "subaward_search"."sub_place_of_performance_congressional_current" AS "subaward_place_of_performance_cd_current",
