SELECT
    "unique_award_key" AS "prime_award_unique_key",
    "award_id" AS "prime_award_piid",
    "parent_award_id" AS "prime_award_parent_piid",
    "award_amount" AS "prime_award_amount",
    ...
    "action_date" AS "prime_award_base_action_date",
    ...
    "awarding_agency_code" AS "prime_award_awarding_agency_code",
    "awarding_agency_name" AS "prime_award_awarding_agency_name",
    "awarding_sub_tier_agency_c" AS "prime_award_awarding_sub_agency_code",
    "awarding_sub_tier_agency_n" AS "prime_award_awarding_sub_agency_name",
    "awarding_office_code" AS "prime_award_awarding_office_code",
    "awarding_office_name" AS "prime_award_awarding_office_name",
    "funding_agency_code" AS "prime_award_funding_agency_code",
    "funding_agency_name" AS "prime_award_funding_agency_name",
    "funding_sub_tier_agency_co" AS "prime_award_funding_sub_agency_code",
    "funding_sub_tier_agency_na" AS "prime_award_funding_sub_agency_name",
    "funding_office_code" AS "prime_award_funding_office_code",
    "funding_office_name" AS "prime_award_funding_office_name",
    ...
    "awardee_or_recipient_uniqu" AS "prime_awardee_duns",
    "transaction_fpds"."awardee_or_recipient_uei" AS "prime_awardee_uei",
    "awardee_or_recipient_legal" AS "prime_awardee_name",
    "dba_name" AS "prime_awardee_dba_name",
    "ultimate_parent_unique_ide" AS "prime_awardee_parent_duns",
    "transaction_fpds"."ultimate_parent_uei" AS "prime_awardee_parent_uei",
    "ultimate_parent_legal_enti" AS "prime_awardee_parent_name",
    "legal_entity_country_code" AS "prime_awardee_country_code",
    "legal_entity_country_name" AS "prime_awardee_country_name",
    "legal_entity_address_line1" AS "prime_awardee_address_line_1",
    "legal_entity_city_name" AS "prime_awardee_city_name",
    "transaction_fpds"."legal_entity_county_name" AS "prime_awardee_county_name",
    "legal_entity_state_code" AS "prime_awardee_state_code",
    "legal_entity_state_name" AS "prime_awardee_state_name",
    "legal_entity_zip" AS "prime_awardee_zip_code",
    "legal_entity_congressional" AS "prime_awardee_congressional_district",
    "legal_entity_foreign_posta" AS "prime_awardee_foreign_postal_code",
    "business_types" AS "prime_awardee_business_types",
    "place_of_perform_city_name" AS "prime_award_primary_place_of_performance_city_name",
    "place_of_perform_state_code" AS "prime_award_primary_place_of_performance_state_code",
    "place_of_perform_state_name" AS "prime_award_primary_place_of_performance_state_name",
    "place_of_performance_zip" AS "prime_award_primary_place_of_performance_address_zip_code",
    "place_of_perform_congressio" AS "prime_award_primary_place_of_performance_congressional_district",
    "place_of_perform_country_co" AS "prime_award_primary_place_of_performance_country_code",
    "place_of_perform_country_na" AS "prime_award_primary_place_of_performance_country_name",
    "award_description" AS "prime_award_base_transaction_description",
    "program_title" AS "prime_award_project_title",
    "naics" AS "prime_award_naics_code",
    "naics_description" AS "prime_award_naics_description",
    ...
    "subaward_type" AS "subaward_type",
    "internal_id" AS "subaward_fsrs_report_id",
    "subaward_report_year" AS "subaward_fsrs_report_year",
    "subaward_report_month" AS "subaward_fsrs_report_month",
    ...
    "sub_ultimate_parent_unique_ide" AS "subawardee_parent_duns",
    "sub_ultimate_parent_legal_enti" AS "subawardee_parent_name",
    "sub_legal_entity_country_code" AS "subawardee_country_code",
    "sub_legal_entity_country_name" AS "subawardee_country_name",
    "sub_legal_entity_address_line1" AS "subawardee_address_line_1",
    "sub_legal_entity_city_name" AS "subawardee_city_name",
    "sub_legal_entity_state_code" AS "subawardee_state_code",
    "sub_legal_entity_state_name" AS "subawardee_state_name",
    "sub_legal_entity_zip" AS "subawardee_zip_code",
    "sub_legal_entity_congressional" AS "subawardee_congressional_district",
    "sub_legal_entity_foreign_posta" AS "subawardee_foreign_postal_code",
    "sub_business_types" AS "subawardee_business_types",
    "place_of_perform_street" AS "subaward_primary_place_of_performance_address_line_1",
    "sub_place_of_perform_city_name" AS "subaward_primary_place_of_performance_city_name",
    "sub_place_of_perform_state_code" AS "subaward_primary_place_of_performance_state_code",
    "sub_place_of_perform_state_name" AS "subaward_primary_place_of_performance_state_name",
    "sub_place_of_performance_zip" AS "subaward_primary_place_of_performance_address_zip_code",
    "sub_place_of_perform_congressio" AS "subaward_primary_place_of_performance_congressional_district",
    "sub_place_of_perform_country_co" AS "subaward_primary_place_of_performance_country_code",
    "sub_place_of_perform_country_na" AS "subaward_primary_place_of_performance_country_name",
    "subaward_description" AS "subaward_description",
    "sub_high_comp_officer1_full_na" AS "subawardee_highly_compensated_officer_1_name",
    "sub_high_comp_officer1_amount" AS "subawardee_highly_compensated_officer_1_amount",
    "sub_high_comp_officer2_full_na" AS "subawardee_highly_compensated_officer_2_name",
    "sub_high_comp_officer2_amount" AS "subawardee_highly_compensated_officer_2_amount",
    "sub_high_comp_officer3_full_na" AS "subawardee_highly_compensated_officer_3_name",
    "sub_high_comp_officer3_amount" AS "subawardee_highly_compensated_officer_3_amount",
    "sub_high_comp_officer4_full_na" AS "subawardee_highly_compensated_officer_4_name",
    "sub_high_comp_officer4_amount" AS "subawardee_highly_compensated_officer_4_amount",
    "sub_high_comp_officer5_full_na" AS "subawardee_highly_compensated_officer_5_name",
    "sub_high_comp_officer5_amount" AS "subawardee_highly_compensated_officer_5_amount",
    CONCAT ('https://www.usaspending.gov/award/' , urlencode("awards"."generated_unique_award_id"), '/') AS "usaspending_permalink",
    "date_submitted" AS "subaward_fsrs_report_last_modified_date"
...
WHERE (
    "subaward_search"."subaward_type" IN ('procurement')
