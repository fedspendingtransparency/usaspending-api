...
def copy_fields(apps, _):
    SourceProcurementTransaction = apps.get_model(
        "transactions", "SourceProcurementTransaction"
    )
    SourceProcurementTransaction.objects.all().update(
        small_business_competitive_temp=Cast(
            F("small_business_competitive"), output_field=models.BooleanField()
        ),
        city_local_government_temp=Cast(
            F("city_local_government"), output_field=models.BooleanField()
        ),
        county_local_government_temp=Cast(
            F("county_local_government"), output_field=models.BooleanField()
        ),
        inter_municipal_local_gove_temp=Cast(
            F("inter_municipal_local_gove"), output_field=models.BooleanField()
        ),
        local_government_owned_temp=Cast(
            F("local_government_owned"), output_field=models.BooleanField()
        ),
        municipality_local_governm_temp=Cast(
            F("municipality_local_governm"), output_field=models.BooleanField()
        ),
        school_district_local_gove_temp=Cast(
            F("school_district_local_gove"), output_field=models.BooleanField()
        ),
        township_local_government_temp=Cast(
            F("township_local_government"), output_field=models.BooleanField()
        ),
        us_state_government_temp=Cast(
            F("us_state_government"), output_field=models.BooleanField()
        ),
        us_federal_government_temp=Cast(
            F("us_federal_government"), output_field=models.BooleanField()
        ),
        federal_agency_temp=Cast(
            F("federal_agency"), output_field=models.BooleanField()
        ),
        federally_funded_research_temp=Cast(
            F("federally_funded_research"), output_field=models.BooleanField()
        ),
        us_tribal_government_temp=Cast(
            F("us_tribal_government"), output_field=models.BooleanField()
        ),
        foreign_government_temp=Cast(
            F("foreign_government"), output_field=models.BooleanField()
        ),
        community_developed_corpor_temp=Cast(
            F("community_developed_corpor"), output_field=models.BooleanField()
        ),
        labor_surplus_area_firm_temp=Cast(
            F("labor_surplus_area_firm"), output_field=models.BooleanField()
        ),
        corporate_entity_not_tax_e_temp=Cast(
            F("corporate_entity_not_tax_e"), output_field=models.BooleanField()
        ),
        corporate_entity_tax_exemp_temp=Cast(
            F("corporate_entity_tax_exemp"), output_field=models.BooleanField()
        ),
        partnership_or_limited_lia_temp=Cast(
            F("partnership_or_limited_lia"), output_field=models.BooleanField()
        ),
        sole_proprietorship_temp=Cast(
            F("sole_proprietorship"), output_field=models.BooleanField()
        ),
        small_agricultural_coopera_temp=Cast(
            F("small_agricultural_coopera"), output_field=models.BooleanField()
        ),
        international_organization_temp=Cast(
            F("international_organization"), output_field=models.BooleanField()
        ),
        us_government_entity_temp=Cast(
            F("us_government_entity"), output_field=models.BooleanField()
        ),
        emerging_small_business_temp=Cast(
            F("emerging_small_business"), output_field=models.BooleanField()
        ),
        c8a_program_participant_temp=Cast(
            F("c8a_program_participant"), output_field=models.BooleanField()
        ),
        sba_certified_8_a_joint_ve_temp=Cast(
            F("sba_certified_8_a_joint_ve"), output_field=models.BooleanField()
        ),
        dot_certified_disadvantage_temp=Cast(
            F("dot_certified_disadvantage"), output_field=models.BooleanField()
        ),
        self_certified_small_disad_temp=Cast(
            F("self_certified_small_disad"), output_field=models.BooleanField()
        ),
        historically_underutilized_temp=Cast(
            F("historically_underutilized"), output_field=models.BooleanField()
        ),
        small_disadvantaged_busine_temp=Cast(
            F("small_disadvantaged_busine"), output_field=models.BooleanField()
        ),
        the_ability_one_program_temp=Cast(
            F("the_ability_one_program"), output_field=models.BooleanField()
        ),
        historically_black_college_temp=Cast(
            F("historically_black_college"), output_field=models.BooleanField()
        ),
        c1862_land_grant_college_temp=Cast(
            F("c1862_land_grant_college"), output_field=models.BooleanField()
        ),
        c1890_land_grant_college_temp=Cast(
            F("c1890_land_grant_college"), output_field=models.BooleanField()
        ),
        c1994_land_grant_college_temp=Cast(
            F("c1994_land_grant_college"), output_field=models.BooleanField()
        ),
        minority_institution_temp=Cast(
            F("minority_institution"), output_field=models.BooleanField()
        ),
        private_university_or_coll_temp=Cast(
            F("private_university_or_coll"), output_field=models.BooleanField()
        ),
        school_of_forestry_temp=Cast(
            F("school_of_forestry"), output_field=models.BooleanField()
        ),
        state_controlled_instituti_temp=Cast(
            F("state_controlled_instituti"), output_field=models.BooleanField()
        ),
        tribal_college_temp=Cast(
            F("tribal_college"), output_field=models.BooleanField()
        ),
        veterinary_college_temp=Cast(
            F("veterinary_college"), output_field=models.BooleanField()
        ),
        educational_institution_temp=Cast(
            F("educational_institution"), output_field=models.BooleanField()
        ),
        alaskan_native_servicing_i_temp=Cast(
            F("alaskan_native_servicing_i"), output_field=models.BooleanField()
        ),
        community_development_corp_temp=Cast(
            F("community_development_corp"), output_field=models.BooleanField()
        ),
        native_hawaiian_servicing_temp=Cast(
            F("native_hawaiian_servicing"), output_field=models.BooleanField()
        ),
        domestic_shelter_temp=Cast(
            F("domestic_shelter"), output_field=models.BooleanField()
        ),
        manufacturer_of_goods_temp=Cast(
            F("manufacturer_of_goods"), output_field=models.BooleanField()
        ),
        hospital_flag_temp=Cast(F("hospital_flag"), output_field=models.BooleanField()),
        veterinary_hospital_temp=Cast(
            F("veterinary_hospital"), output_field=models.BooleanField()
        ),
        hispanic_servicing_institu_temp=Cast(
            F("hispanic_servicing_institu"), output_field=models.BooleanField()
        ),
        foundation_temp=Cast(F("foundation"), output_field=models.BooleanField()),
        woman_owned_business_temp=Cast(
            F("woman_owned_business"), output_field=models.BooleanField()
        ),
        minority_owned_business_temp=Cast(
            F("minority_owned_business"), output_field=models.BooleanField()
        ),
        women_owned_small_business_temp=Cast(
            F("women_owned_small_business"), output_field=models.BooleanField()
        ),
        economically_disadvantaged_temp=Cast(
            F("economically_disadvantaged"), output_field=models.BooleanField()
        ),
        joint_venture_women_owned_temp=Cast(
            F("joint_venture_women_owned"), output_field=models.BooleanField()
        ),
        joint_venture_economically_temp=Cast(
            F("joint_venture_economically"), output_field=models.BooleanField()
        ),
        veteran_owned_business_temp=Cast(
            F("veteran_owned_business"), output_field=models.BooleanField()
        ),
        service_disabled_veteran_o_temp=Cast(
            F("service_disabled_veteran_o"), output_field=models.BooleanField()
        ),
        ...
        receives_contracts_and_gra_temp=Cast(
            F("receives_contracts_and_gra"), output_field=models.BooleanField()
        ),
        airport_authority_temp=Cast(
            F("airport_authority"), output_field=models.BooleanField()
        ),
        council_of_governments_temp=Cast(
            F("council_of_governments"), output_field=models.BooleanField()
        ),
        housing_authorities_public_temp=Cast(
            F("housing_authorities_public"), output_field=models.BooleanField()
        ),
        interstate_entity_temp=Cast(
            F("interstate_entity"), output_field=models.BooleanField()
        ),
        planning_commission_temp=Cast(
            F("planning_commission"), output_field=models.BooleanField()
        ),
        port_authority_temp=Cast(
            F("port_authority"), output_field=models.BooleanField()
        ),
        transit_authority_temp=Cast(
            F("transit_authority"), output_field=models.BooleanField()
        ),
        subchapter_s_corporation_temp=Cast(
            F("subchapter_s_corporation"), output_field=models.BooleanField()
        ),
        limited_liability_corporat_temp=Cast(
            F("limited_liability_corporat"), output_field=models.BooleanField()
        ),
        foreign_owned_and_located_temp=Cast(
            F("foreign_owned_and_located"), output_field=models.BooleanField()
        ),
        american_indian_owned_busi_temp=Cast(
            F("american_indian_owned_busi"), output_field=models.BooleanField()
        ),
        alaskan_native_owned_corpo_temp=Cast(
            F("alaskan_native_owned_corpo"), output_field=models.BooleanField()
        ),
        indian_tribe_federally_rec_temp=Cast(
            F("indian_tribe_federally_rec"), output_field=models.BooleanField()
        ),
        native_hawaiian_owned_busi_temp=Cast(
            F("native_hawaiian_owned_busi"), output_field=models.BooleanField()
        ),
        tribally_owned_business_temp=Cast(
            F("tribally_owned_business"), output_field=models.BooleanField()
        ),
        asian_pacific_american_own_temp=Cast(
            F("asian_pacific_american_own"), output_field=models.BooleanField()
        ),
        black_american_owned_busin_temp=Cast(
            F("black_american_owned_busin"), output_field=models.BooleanField()
        ),
        hispanic_american_owned_bu_temp=Cast(
            F("hispanic_american_owned_bu"), output_field=models.BooleanField()
        ),
        native_american_owned_busi_temp=Cast(
            F("native_american_owned_busi"), output_field=models.BooleanField()
        ),
        subcontinent_asian_asian_i_temp=Cast(
            F("subcontinent_asian_asian_i"), output_field=models.BooleanField()
        ),
        other_minority_owned_busin_temp=Cast(
            F("other_minority_owned_busin"), output_field=models.BooleanField()
        ),
        for_profit_organization_temp=Cast(
            F("for_profit_organization"), output_field=models.BooleanField()
        ),
        nonprofit_organization_temp=Cast(
            F("nonprofit_organization"), output_field=models.BooleanField()
        ),
        other_not_for_profit_organ_temp=Cast(
            F("other_not_for_profit_organ"), output_field=models.BooleanField()
        ),
        us_local_government_temp=Cast(
            F("us_local_government"), output_field=models.BooleanField()
        ),
    )
...
def reverse_copy_fields(apps, _):
    ...
    SourceProcurementTransaction.objects.all().update(
        small_business_competitive=Cast(
            F("small_business_competitive_temp"), output_field=models.TextField()
        ),
        city_local_government=Cast(
            F("city_local_government_temp"), output_field=models.TextField()
        ),
        county_local_government=Cast(
            F("county_local_government_temp"), output_field=models.TextField()
        ),
        inter_municipal_local_gove=Cast(
            F("inter_municipal_local_gove_temp"), output_field=models.TextField()
        ),
        local_government_owned=Cast(
            F("local_government_owned_temp"), output_field=models.TextField()
        ),
        municipality_local_governm=Cast(
            F("municipality_local_governm_temp"), output_field=models.TextField()
        ),
        school_district_local_gove=Cast(
            F("school_district_local_gove_temp"), output_field=models.TextField()
        ),
        township_local_government=Cast(
            F("township_local_government_temp"), output_field=models.TextField()
        ),
        us_state_government=Cast(
            F("us_state_government_temp"), output_field=models.TextField()
        ),
        us_federal_government=Cast(
            F("us_federal_government_temp"), output_field=models.TextField()
        ),
        federal_agency=Cast(F("federal_agency_temp"), output_field=models.TextField()),
        federally_funded_research=Cast(
            F("federally_funded_research_temp"), output_field=models.TextField()
        ),
        us_tribal_government=Cast(
            F("us_tribal_government_temp"), output_field=models.TextField()
        ),
        foreign_government=Cast(
            F("foreign_government_temp"), output_field=models.TextField()
        ),
        community_developed_corpor=Cast(
            F("community_developed_corpor_temp"), output_field=models.TextField()
        ),
        labor_surplus_area_firm=Cast(
            F("labor_surplus_area_firm_temp"), output_field=models.TextField()
        ),
        corporate_entity_not_tax_e=Cast(
            F("corporate_entity_not_tax_e_temp"), output_field=models.TextField()
        ),
        corporate_entity_tax_exemp=Cast(
            F("corporate_entity_tax_exemp_temp"), output_field=models.TextField()
        ),
        partnership_or_limited_lia=Cast(
            F("partnership_or_limited_lia_temp"), output_field=models.TextField()
        ),
        sole_proprietorship=Cast(
            F("sole_proprietorship_temp"), output_field=models.TextField()
        ),
        small_agricultural_coopera=Cast(
            F("small_agricultural_coopera_temp"), output_field=models.TextField()
        ),
        international_organization=Cast(
            F("international_organization_temp"), output_field=models.TextField()
        ),
        us_government_entity=Cast(
            F("us_government_entity_temp"), output_field=models.TextField()
        ),
        emerging_small_business=Cast(
            F("emerging_small_business_temp"), output_field=models.TextField()
        ),
        c8a_program_participant=Cast(
            F("c8a_program_participant_temp"), output_field=models.TextField()
        ),
        sba_certified_8_a_joint_ve=Cast(
            F("sba_certified_8_a_joint_ve_temp"), output_field=models.TextField()
        ),
        dot_certified_disadvantage=Cast(
            F("dot_certified_disadvantage_temp"), output_field=models.TextField()
        ),
        self_certified_small_disad=Cast(
            F("self_certified_small_disad_temp"), output_field=models.TextField()
        ),
        historically_underutilized=Cast(
            F("historically_underutilized_temp"), output_field=models.TextField()
        ),
        small_disadvantaged_busine=Cast(
            F("small_disadvantaged_busine_temp"), output_field=models.TextField()
        ),
        the_ability_one_program=Cast(
            F("the_ability_one_program_temp"), output_field=models.TextField()
        ),
        historically_black_college=Cast(
            F("historically_black_college_temp"), output_field=models.TextField()
        ),
        c1862_land_grant_college=Cast(
            F("c1862_land_grant_college_temp"), output_field=models.TextField()
        ),
        c1890_land_grant_college=Cast(
            F("c1890_land_grant_college_temp"), output_field=models.TextField()
        ),
        c1994_land_grant_college=Cast(
            F("c1994_land_grant_college_temp"), output_field=models.TextField()
        ),
        minority_institution=Cast(
            F("minority_institution_temp"), output_field=models.TextField()
        ),
        private_university_or_coll=Cast(
            F("private_university_or_coll_temp"), output_field=models.TextField()
        ),
        school_of_forestry=Cast(
            F("school_of_forestry_temp"), output_field=models.TextField()
        ),
        state_controlled_instituti=Cast(
            F("state_controlled_instituti_temp"), output_field=models.TextField()
        ),
        tribal_college=Cast(F("tribal_college_temp"), output_field=models.TextField()),
        veterinary_college=Cast(
            F("veterinary_college_temp"), output_field=models.TextField()
        ),
        educational_institution=Cast(
            F("educational_institution_temp"), output_field=models.TextField()
        ),
        alaskan_native_servicing_i=Cast(
            F("alaskan_native_servicing_i_temp"), output_field=models.TextField()
        ),
        community_development_corp=Cast(
            F("community_development_corp_temp"), output_field=models.TextField()
        ),
        native_hawaiian_servicing=Cast(
            F("native_hawaiian_servicing_temp"), output_field=models.TextField()
        ),
        domestic_shelter=Cast(
            F("domestic_shelter_temp"), output_field=models.TextField()
        ),
        manufacturer_of_goods=Cast(
            F("manufacturer_of_goods_temp"), output_field=models.TextField()
        ),
        hospital_flag=Cast(F("hospital_flag_temp"), output_field=models.TextField()),
        veterinary_hospital=Cast(
            F("veterinary_hospital_temp"), output_field=models.TextField()
        ),
        hispanic_servicing_institu=Cast(
            F("hispanic_servicing_institu_temp"), output_field=models.TextField()
        ),
        foundation=Cast(F("foundation_temp"), output_field=models.TextField()),
        woman_owned_business=Cast(
            F("woman_owned_business_temp"), output_field=models.TextField()
        ),
        minority_owned_business=Cast(
            F("minority_owned_business_temp"), output_field=models.TextField()
        ),
        women_owned_small_business=Cast(
            F("women_owned_small_business_temp"), output_field=models.TextField()
        ),
        economically_disadvantaged=Cast(
            F("economically_disadvantaged_temp"), output_field=models.TextField()
        ),
        joint_venture_women_owned=Cast(
            F("joint_venture_women_owned_temp"), output_field=models.TextField()
        ),
        joint_venture_economically=Cast(
            F("joint_venture_economically_temp"), output_field=models.TextField()
        ),
        veteran_owned_business=Cast(
            F("veteran_owned_business_temp"), output_field=models.TextField()
        ),
        service_disabled_veteran_o=Cast(
            F("service_disabled_veteran_o_temp"), output_field=models.TextField()
        ),
        contracts=Cast(F("contracts_temp"), output_field=models.TextField()),
        grants=Cast(F("grants_temp"), output_field=models.TextField()),
        receives_contracts_and_gra=Cast(
            F("receives_contracts_and_gra_temp"), output_field=models.TextField()
        ),
        airport_authority=Cast(
            F("airport_authority_temp"), output_field=models.TextField()
        ),
        council_of_governments=Cast(
            F("council_of_governments_temp"), output_field=models.TextField()
        ),
        housing_authorities_public=Cast(
            F("housing_authorities_public_temp"), output_field=models.TextField()
        ),
        interstate_entity=Cast(
            F("interstate_entity_temp"), output_field=models.TextField()
        ),
        planning_commission=Cast(
            F("planning_commission_temp"), output_field=models.TextField()
        ),
        port_authority=Cast(F("port_authority_temp"), output_field=models.TextField()),
        transit_authority=Cast(
            F("transit_authority_temp"), output_field=models.TextField()
        ),
        subchapter_s_corporation=Cast(
            F("subchapter_s_corporation_temp"), output_field=models.TextField()
        ),
        limited_liability_corporat=Cast(
            F("limited_liability_corporat_temp"), output_field=models.TextField()
        ),
        foreign_owned_and_located=Cast(
            F("foreign_owned_and_located_temp"), output_field=models.TextField()
        ),
        american_indian_owned_busi=Cast(
            F("american_indian_owned_busi_temp"), output_field=models.TextField()
        ),
        alaskan_native_owned_corpo=Cast(
            F("alaskan_native_owned_corpo_temp"), output_field=models.TextField()
        ),
        indian_tribe_federally_rec=Cast(
            F("indian_tribe_federally_rec_temp"), output_field=models.TextField()
        ),
        native_hawaiian_owned_busi=Cast(
            F("native_hawaiian_owned_busi_temp"), output_field=models.TextField()
        ),
        tribally_owned_business=Cast(
            F("tribally_owned_business_temp"), output_field=models.TextField()
        ),
        asian_pacific_american_own=Cast(
            F("asian_pacific_american_own_temp"), output_field=models.TextField()
        ),
        black_american_owned_busin=Cast(
            F("black_american_owned_busin_temp"), output_field=models.TextField()
        ),
        hispanic_american_owned_bu=Cast(
            F("hispanic_american_owned_bu_temp"), output_field=models.TextField()
        ),
        native_american_owned_busi=Cast(
            F("native_american_owned_busi_temp"), output_field=models.TextField()
        ),
        subcontinent_asian_asian_i=Cast(
            F("subcontinent_asian_asian_i_temp"), output_field=models.TextField()
        ),
        other_minority_owned_busin=Cast(
            F("other_minority_owned_busin_temp"), output_field=models.TextField()
        ),
        for_profit_organization=Cast(
            F("for_profit_organization_temp"), output_field=models.TextField()
        ),
        nonprofit_organization=Cast(
            F("nonprofit_organization_temp"), output_field=models.TextField()
        ),
        other_not_for_profit_organ=Cast(
            F("other_not_for_profit_organ_temp"), output_field=models.TextField()
        ),
        us_local_government=Cast(
            F("us_local_government_temp"), output_field=models.TextField()
        ),
    )
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.RemoveField(
            model_name="sourceprocurementtransaction", name="city_local_government_old"
        ),
        migrations.RemoveField(
            model_name="sourceprocurementtransaction",
        ...
        migrations.RemoveField(
            model_name="sourceprocurementtransaction", name="local_government_owned_old"
        ),
        migrations.RemoveField(
            model_name="sourceprocurementtransaction",
        ...
        migrations.RemoveField(
            model_name="sourceprocurementtransaction", name="us_state_government_old"
        ),
        migrations.RemoveField(
            model_name="sourceprocurementtransaction", name="us_federal_government_old"
        ),
        migrations.RemoveField(
            model_name="sourceprocurementtransaction", name="federal_agency_old"
        ),
        migrations.RemoveField(
            model_name="sourceprocurementtransaction",
        ...
        migrations.RemoveField(
            model_name="sourceprocurementtransaction", name="us_tribal_government_old"
        ),
        migrations.RemoveField(
            model_name="sourceprocurementtransaction", name="foreign_government_old"
        ),
        migrations.RemoveField(
            model_name="sourceprocurementtransaction",
        ...
        migrations.RemoveField(
            model_name="sourceprocurementtransaction", name="sole_proprietorship_old"
        ),
        migrations.RemoveField(
            model_name="sourceprocurementtransaction",
        ...
        migrations.RemoveField(
            model_name="sourceprocurementtransaction", name="us_government_entity_old"
        ),
        migrations.RemoveField(
            model_name="sourceprocurementtransaction",
        ...
        migrations.RemoveField(
            model_name="sourceprocurementtransaction", name="minority_institution_old"
        ),
        migrations.RemoveField(
            model_name="sourceprocurementtransaction",
        ...
        migrations.RemoveField(
            model_name="sourceprocurementtransaction", name="school_of_forestry_old"
        ),
        migrations.RemoveField(
            model_name="sourceprocurementtransaction",
        ...
        migrations.RemoveField(
            model_name="sourceprocurementtransaction", name="tribal_college_old"
        ),
        migrations.RemoveField(
            model_name="sourceprocurementtransaction", name="veterinary_college_old"
        ),
        migrations.RemoveField(
            model_name="sourceprocurementtransaction",
        ...
        migrations.RemoveField(
            model_name="sourceprocurementtransaction", name="domestic_shelter_old"
        ),
        migrations.RemoveField(
            model_name="sourceprocurementtransaction", name="manufacturer_of_goods_old"
        ),
        migrations.RemoveField(
            model_name="sourceprocurementtransaction", name="hospital_flag_old"
        ),
        migrations.RemoveField(
            model_name="sourceprocurementtransaction", name="veterinary_hospital_old"
        ),
        migrations.RemoveField(
            model_name="sourceprocurementtransaction",
        ...
        migrations.RemoveField(
            model_name="sourceprocurementtransaction", name="foundation_old"
        ),
        migrations.RemoveField(
            model_name="sourceprocurementtransaction", name="woman_owned_business_old"
        ),
        migrations.RemoveField(
            model_name="sourceprocurementtransaction",
        ...
        migrations.RemoveField(
            model_name="sourceprocurementtransaction", name="veteran_owned_business_old"
        ),
        migrations.RemoveField(
            model_name="sourceprocurementtransaction",
        ...
        migrations.RemoveField(
            model_name="sourceprocurementtransaction", name="contracts_old"
        ),
        migrations.RemoveField(
            model_name="sourceprocurementtransaction", name="grants_old"
        ),
        migrations.RemoveField(
            model_name="sourceprocurementtransaction",
        ...
        migrations.RemoveField(
            model_name="sourceprocurementtransaction", name="airport_authority_old"
        ),
        migrations.RemoveField(
            model_name="sourceprocurementtransaction", name="council_of_governments_old"
        ),
        migrations.RemoveField(
            model_name="sourceprocurementtransaction",
        ...
        migrations.RemoveField(
            model_name="sourceprocurementtransaction", name="interstate_entity_old"
        ),
        migrations.RemoveField(
            model_name="sourceprocurementtransaction", name="planning_commission_old"
        ),
        migrations.RemoveField(
            model_name="sourceprocurementtransaction", name="port_authority_old"
        ),
        migrations.RemoveField(
            model_name="sourceprocurementtransaction", name="transit_authority_old"
        ),
        migrations.RemoveField(
            model_name="sourceprocurementtransaction",
        ...
        migrations.RemoveField(
            model_name="sourceprocurementtransaction", name="nonprofit_organization_old"
        ),
        migrations.RemoveField(
            model_name="sourceprocurementtransaction",
        ...
        migrations.RemoveField(
            model_name="sourceprocurementtransaction", name="us_local_government_old"
        ),
    ]
