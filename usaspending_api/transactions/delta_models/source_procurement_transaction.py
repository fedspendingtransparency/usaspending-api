source_procurement_transaction_sql_string = r"""
CREATE OR REPLACE TABLE {DESTINATION_TABLE} (
  detached_award_procurement_id INTEGER NOT NULL,
  detached_award_proc_unique STRING NOT NULL,
  ...
  high_comp_officer1_amount STRING,
  high_comp_officer1_full_na STRING,
  high_comp_officer2_amount STRING,
  high_comp_officer2_full_na STRING,
  high_comp_officer3_amount STRING,
  high_comp_officer3_full_na STRING,
  high_comp_officer4_amount STRING,
  high_comp_officer4_full_na STRING,
  high_comp_officer5_amount STRING,
