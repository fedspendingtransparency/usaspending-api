...
TRANSACTION_FABS_COLUMN_INFO = [
    ...
    TransactionColumn("is_historical", "is_historical", "BOOLEAN"),
...
FABS_TO_NORMALIZED_COLUMN_INFO = [
    ...
    TransactionColumn("drv_award_transaction_usaspend", "NULL", "NUMERIC(23, 2)", "literal"),
    TransactionColumn("drv_current_total_award_value_amount_adjustment", "NULL", "NUMERIC(23, 2)", "literal"),
    TransactionColumn("drv_potential_total_award_value_amount_adjustment", "NULL", "NUMERIC(23, 2)", "literal"),
    TransactionColumn("face_value_loan_guarantee", "face_value_loan_guarantee", "NUMERIC(23,2)"),
    TransactionColumn("federal_action_obligation", "federal_action_obligation", "NUMERIC(23,2)"),
