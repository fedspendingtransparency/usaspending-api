...
TRANSACTION_SEARCH_COLUMNS = {
    ...
    "airport_authority": {"delta": "STRING", "postgres": "TEXT"},
    "alaskan_native_owned_corpo": {"delta": "STRING", "postgres": "TEXT"},
    "alaskan_native_servicing_i": {"delta": "STRING", "postgres": "TEXT"},
    "american_indian_owned_busi": {"delta": "STRING", "postgres": "TEXT"},
    "asian_pacific_american_own": {"delta": "STRING", "postgres": "TEXT"},
    "base_and_all_options_value": {"delta": "STRING", "postgres": "TEXT"},
    "base_exercised_options_val": {"delta": "STRING", "postgres": "TEXT"},
    "black_american_owned_busin": {"delta": "STRING", "postgres": "TEXT"},
    "c1862_land_grant_college": {"delta": "STRING", "postgres": "TEXT"},
    "c1890_land_grant_college": {"delta": "STRING", "postgres": "TEXT"},
    "c1994_land_grant_college": {"delta": "STRING", "postgres": "TEXT"},
    "c8a_program_participant": {"delta": "STRING", "postgres": "TEXT"},
    "cage_code": {"delta": "STRING", "postgres": "TEXT"},
    "city_local_government": {"delta": "STRING", "postgres": "TEXT"},
    ...
    "community_developed_corpor": {"delta": "STRING", "postgres": "TEXT"},
    "community_development_corp": {"delta": "STRING", "postgres": "TEXT"},
    ...
    "corporate_entity_not_tax_e": {"delta": "STRING", "postgres": "TEXT"},
    "corporate_entity_tax_exemp": {"delta": "STRING", "postgres": "TEXT"},
    ...
    "council_of_governments": {"delta": "STRING", "postgres": "TEXT"},
    ...
    "domestic_shelter": {"delta": "STRING", "postgres": "TEXT"},
    "dot_certified_disadvantage": {"delta": "STRING", "postgres": "TEXT"},
    "economically_disadvantaged": {"delta": "STRING", "postgres": "TEXT"},
    "educational_institution": {"delta": "STRING", "postgres": "TEXT"},
    "emerging_small_business": {"delta": "STRING", "postgres": "TEXT"},
    ...
    "federal_agency": {"delta": "STRING", "postgres": "TEXT"},
    "federally_funded_research": {"delta": "STRING", "postgres": "TEXT"},
    "for_profit_organization": {"delta": "STRING", "postgres": "TEXT"},
    "foreign_funding": {"delta": "STRING", "postgres": "TEXT"},
    "foreign_funding_desc": {"delta": "STRING", "postgres": "TEXT"},
    "foreign_government": {"delta": "STRING", "postgres": "TEXT"},
    "foreign_owned_and_located": {"delta": "STRING", "postgres": "TEXT"},
    "foundation": {"delta": "STRING", "postgres": "TEXT"},
    "government_furnished_desc": {"delta": "STRING", "postgres": "TEXT"},
    "government_furnished_prope": {"delta": "STRING", "postgres": "TEXT"},
    "grants": {"delta": "STRING", "postgres": "TEXT"},
    "hispanic_american_owned_bu": {"delta": "STRING", "postgres": "TEXT"},
    "hispanic_servicing_institu": {"delta": "STRING", "postgres": "TEXT"},
    "historically_black_college": {"delta": "STRING", "postgres": "TEXT"},
    "historically_underutilized": {"delta": "STRING", "postgres": "TEXT"},
    "hospital_flag": {"delta": "STRING", "postgres": "TEXT"},
    "housing_authorities_public": {"delta": "STRING", "postgres": "TEXT"},
    "idv_type": {"delta": "STRING", "postgres": "TEXT"},
    "idv_type_description": {"delta": "STRING", "postgres": "TEXT"},
    "indian_tribe_federally_rec": {"delta": "STRING", "postgres": "TEXT"},
    ...
    "inter_municipal_local_gove": {"delta": "STRING", "postgres": "TEXT"},
    "interagency_contract_desc": {"delta": "STRING", "postgres": "TEXT"},
    "interagency_contracting_au": {"delta": "STRING", "postgres": "TEXT"},
    "international_organization": {"delta": "STRING", "postgres": "TEXT"},
    "interstate_entity": {"delta": "STRING", "postgres": "TEXT"},
    "joint_venture_economically": {"delta": "STRING", "postgres": "TEXT"},
    "joint_venture_women_owned": {"delta": "STRING", "postgres": "TEXT"},
    "labor_standards": {"delta": "STRING", "postgres": "TEXT"},
    "labor_standards_descrip": {"delta": "STRING", "postgres": "TEXT"},
    "labor_surplus_area_firm": {"delta": "STRING", "postgres": "TEXT"},
    "limited_liability_corporat": {"delta": "STRING", "postgres": "TEXT"},
    "local_area_set_aside": {"delta": "STRING", "postgres": "TEXT"},
    "local_area_set_aside_desc": {"delta": "STRING", "postgres": "TEXT"},
    "local_government_owned": {"delta": "STRING", "postgres": "TEXT"},
    "major_program": {"delta": "STRING", "postgres": "TEXT"},
    "manufacturer_of_goods": {"delta": "STRING", "postgres": "TEXT"},
    "materials_supplies_article": {"delta": "STRING", "postgres": "TEXT"},
    "materials_supplies_descrip": {"delta": "STRING", "postgres": "TEXT"},
    "minority_institution": {"delta": "STRING", "postgres": "TEXT"},
    "minority_owned_business": {"delta": "STRING", "postgres": "TEXT"},
    ...
    "municipality_local_governm": {"delta": "STRING", "postgres": "TEXT"},
    "national_interest_action": {"delta": "STRING", "postgres": "TEXT"},
    "national_interest_desc": {"delta": "STRING", "postgres": "TEXT"},
    "native_american_owned_busi": {"delta": "STRING", "postgres": "TEXT"},
    "native_hawaiian_owned_busi": {"delta": "STRING", "postgres": "TEXT"},
    "native_hawaiian_servicing": {"delta": "STRING", "postgres": "TEXT"},
    "nonprofit_organization": {"delta": "STRING", "postgres": "TEXT"},
    ...
    "other_minority_owned_busin": {"delta": "STRING", "postgres": "TEXT"},
    "other_not_for_profit_organ": {"delta": "STRING", "postgres": "TEXT"},
    ...
    "partnership_or_limited_lia": {"delta": "STRING", "postgres": "TEXT"},
    ...
    "planning_commission": {"delta": "STRING", "postgres": "TEXT"},
    "port_authority": {"delta": "STRING", "postgres": "TEXT"},
    "potential_total_value_awar": {"delta": "STRING", "postgres": "TEXT"},
    "price_evaluation_adjustmen": {"delta": "STRING", "postgres": "TEXT"},
    "private_university_or_coll": {"delta": "STRING", "postgres": "TEXT"},
    ...
    "receives_contracts_and_gra": {"delta": "STRING", "postgres": "TEXT"},
    ...
    "sba_certified_8_a_joint_ve": {"delta": "STRING", "postgres": "TEXT"},
    "school_district_local_gove": {"delta": "STRING", "postgres": "TEXT"},
    "school_of_forestry": {"delta": "STRING", "postgres": "TEXT"},
    "sea_transportation": {"delta": "STRING", "postgres": "TEXT"},
    "sea_transportation_desc": {"delta": "STRING", "postgres": "TEXT"},
    "self_certified_small_disad": {"delta": "STRING", "postgres": "TEXT"},
    "service_disabled_veteran_o": {"delta": "STRING", "postgres": "TEXT"},
    "small_agricultural_coopera": {"delta": "STRING", "postgres": "TEXT"},
    "small_business_competitive": {"delta": "STRING", "postgres": "TEXT"},
    "small_disadvantaged_busine": {"delta": "STRING", "postgres": "TEXT"},
    "sole_proprietorship": {"delta": "STRING", "postgres": "TEXT"},
    ...
    "state_controlled_instituti": {"delta": "STRING", "postgres": "TEXT"},
    "subchapter_s_corporation": {"delta": "STRING", "postgres": "TEXT"},
    "subcontinent_asian_asian_i": {"delta": "STRING", "postgres": "TEXT"},
    "subcontracting_plan": {"delta": "STRING", "postgres": "TEXT"},
    "subcontracting_plan_desc": {"delta": "STRING", "postgres": "TEXT"},
    "the_ability_one_program": {"delta": "STRING", "postgres": "TEXT"},
    "total_obligated_amount": {"delta": "STRING", "postgres": "TEXT"},
    "township_local_government": {"delta": "STRING", "postgres": "TEXT"},
    "transaction_number": {"delta": "STRING", "postgres": "TEXT"},
    "transit_authority": {"delta": "STRING", "postgres": "TEXT"},
    "tribal_college": {"delta": "STRING", "postgres": "TEXT"},
    "tribally_owned_business": {"delta": "STRING", "postgres": "TEXT"},
    ...
    "us_federal_government": {"delta": "STRING", "postgres": "TEXT"},
    "us_government_entity": {"delta": "STRING", "postgres": "TEXT"},
    "us_local_government": {"delta": "STRING", "postgres": "TEXT"},
    "us_state_government": {"delta": "STRING", "postgres": "TEXT"},
    "us_tribal_government": {"delta": "STRING", "postgres": "TEXT"},
    ...
    "veteran_owned_business": {"delta": "STRING", "postgres": "TEXT"},
    "veterinary_college": {"delta": "STRING", "postgres": "TEXT"},
    "veterinary_hospital": {"delta": "STRING", "postgres": "TEXT"},
    "woman_owned_business": {"delta": "STRING", "postgres": "TEXT"},
    "women_owned_small_business": {"delta": "STRING", "postgres": "TEXT"},
    ...
    "pop_code": {"delta": "STRING", "postgres": "TEXT"},
    "pop_scope": {"delta": "STRING", "postgres": "TEXT"},
    ...
    "pop_zip4a": {"delta": "STRING", "postgres": "TEXT"},
    "pop_last4": {"delta": "STRING", "postgres": "TEXT"},
    ...
    "pop_forei": {"delta": "STRING", "postgres": "TEXT"},
    ...
    "recipient_location_zip4": {"delta": "STRING", "postgres": "TEXT"},
    "recipient_location_zip_last4": {"delta": "STRING", "postgres": "TEXT"},
    "recipient_location_city_code": {"delta": "STRING", "postgres": "TEXT"},
    "recipient_location_city_name": {"delta": "STRING", "postgres": "TEXT"},
    "recipient_location_address_line_1": {"delta": "STRING", "postgres": "TEXT"},
    "recipient_location_address_line_2": {"delta": "STRING", "postgres": "TEXT"},
    "recipient_location_address_line_3": {"delta": "STRING", "postgres": "TEXT"},
    "recipient_location_foreign_city": {"delta": "STRING", "postgres": "TEXT"},
    "recipient_location_foreign_descr": {"delta": "STRING", "postgres": "TEXT"},
    "recipient_location_foreign_posta": {"delta": "STRING", "postgres": "TEXT"},
    "recipient_location_foreign_provi": {"delta": "STRING", "postgres": "TEXT"},
...
transaction_search_load_sql_string = fr"""
    ...
    SELECT
        ...
        transaction_fabs.place_of_performance_code AS pop_code,
        transaction_fabs.place_of_performance_scope AS pop_scope,
        ...
        TRIM(TRAILING FROM COALESCE(transaction_fpds.place_of_perform_city_name, transaction_fabs.place_of_performance_city))
            AS pop_city_name,
        transaction_fabs.place_of_performance_forei AS pop_forei,
        ...
        COALESCE(transaction_fpds.legal_entity_zip_last4, transaction_fabs.legal_entity_zip_last4)
            AS recipient_location_zip_last4,
        transaction_fabs.legal_entity_city_code AS recipient_location_city_code,        
        ...
        COALESCE(transaction_fpds.legal_entity_address_line1, transaction_fabs.legal_entity_address_line1)
            AS recipient_location_address_line_1,
        COALESCE(transaction_fpds.legal_entity_address_line2, transaction_fabs.legal_entity_address_line2)
            AS recipient_location_address_line_2,
        COALESCE(transaction_fpds.legal_entity_address_line3, transaction_fabs.legal_entity_address_line3)
            AS recipient_location_address_line_3,
        transaction_fabs.legal_entity_foreign_city AS recipient_location_foreign_city,
        transaction_fabs.legal_entity_foreign_descr AS recipient_location_foreign_descr,
        transaction_fabs.legal_entity_foreign_posta AS recipient_location_foreign_posta,
        transaction_fabs.legal_entity_foreign_provi AS recipient_location_foreign_provi,
