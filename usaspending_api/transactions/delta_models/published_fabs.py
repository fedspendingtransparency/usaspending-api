PUBLISHED_FABS_COLUMNS = {
    "published_fabs_id": {"delta": "INTEGER", "postgres": "UUID"},
    ...
    "business_categories": {"delta": "ARRAY<STRING>", "postgres": "ARRAY[]TEXT"},
    ...
    "face_value_loan_guarantee": {"delta": "NUMERIC(23,2)", "postgres": "NUMERIC"},
    "fain": {"delta": "STRING", "postgres": "TEXT"},
    "federal_action_obligation": {"delta": "NUMERIC(23,2)", "postgres": "NUMERIC"},
    ...
    "indirect_federal_sharing": {"delta": "NUMERIC(23,2)", "postgres": "NUMERIC"},
    ...
    "non_federal_funding_amount": {"delta": "NUMERIC(23,2)", "postgres": "NUMERIC"},
    "original_loan_subsidy_cost": {"delta": "NUMERIC(23,2)", "postgres": "NUMERIC"},
    ...
    "submission_id": {"delta": "NUMERIC(23,2)", "postgres": "NUMERIC"},
