...
# Spending By Country [/api/v2/search/spending_by_category/country/]

This endpoint supports the advanced search page and allow for complex filtering for specific subsets of spending data.

## POST

This endpoint returns a list of the top results of Countries sorted by the total amounts in descending order.
...
+ Response 200 (application/json)
    + Attributes (object)
        + `category`: `country` (required, string)
