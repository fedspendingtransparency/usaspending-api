...
# Spending By NAICS [/api/v2/search/spending_by_category/naics/]

This endpoint supports the advanced search page and allow for complex filtering for specific subsets of spending data.

## POST

This endpoint returns a list of the top results of NAICS sorted by the total amounts in descending order.
