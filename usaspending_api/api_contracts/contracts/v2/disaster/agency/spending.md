...
# Agencies receiving disaster/emergency spending [/api/v2/disaster/agency/spending/]

This endpoint provides insights on the Agencies which received disaster/emergency spending per the requested filters.

## POST

This endpoint returns details of Agencies receiving supplimental spending budgetary resources
