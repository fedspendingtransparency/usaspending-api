...
class FinancialAccountsByProgramActivityObjectClassSummarized(models.Model):
    # for the materialized view financial_accounts_by_program_activity_object_class_summarized
    ...
    treasury_account = models.ForeignKey(TreasuryAppropriationAccount, models.CASCADE, related_name="+", null=True)
    # aggregated_col_bitmap =
    is_summed_on_program_activity_code = models.BooleanField(null=False),
    is_summed_on_object_class = models.BooleanField(null=False),
    is_summed_on_tas = models.BooleanField(null=False),
    ussgl480100_undelivered_orders_obligations_unpaid_fyb = models.DecimalField(max_digits=21, decimal_places=2)
    ussgl480100_undelivered_orders_obligations_unpaid_cpe = models.DecimalField(max_digits=21, decimal_places=2)
    ussgl483100_undelivered_orders_oblig_transferred_unpaid_cpe = models.DecimalField(max_digits=21, decimal_places=2)
    ussgl488100_upward_adjust_pri_undeliv_order_oblig_unpaid_cpe = models.DecimalField(max_digits=21, decimal_places=2)
    ...
    class Meta:
        managed = False
        db_table = 'financial_accounts_by_program_activity_object_class_summarized'
