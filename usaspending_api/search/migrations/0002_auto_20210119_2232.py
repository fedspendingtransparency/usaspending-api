# Generated by Django 2.2.14 on 2021-01-19 22:32
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('award', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='awards.Award')),
        ...
        migrations.AddIndex(
            model_name='transactionsearch',
            index=models.Index(condition=models.Q(('action_date__gte', '2007-10-01'), ('type__isnull', False)), fields=['type'], name='ts_idx_type'),
        ),
        migrations.AddIndex(
            model_name='transactionsearch',
        ...
        migrations.AddIndex(
            model_name='transactionsearch',
            index=models.Index(condition=models.Q(('action_date__gte', '2007-10-01'), ('pop_zip5__isnull', False)), fields=['pop_zip5'], name='ts_idx_pop_zip5'),
        ),
        migrations.AddIndex(
            model_name='transactionsearch',
            index=models.Index(condition=models.Q(('action_date__gte', '2007-10-01'), ('recipient_unique_id__isnull', False)), fields=['recipient_unique_id'], name='ts_idx_recipient_unique_id'),
        ),
        migrations.AddIndex(
            model_name='transactionsearch',
            index=models.Index(condition=models.Q(('action_date__gte', '2007-10-01'), ('parent_recipient_unique_id__isnull', False)), fields=['parent_recipient_unique_id'], name='ts_idx_parent_recipient_unique'),
        ),
        migrations.AddIndex(
            model_name='transactionsearch',
            index=models.Index(condition=models.Q(('action_date__gte', '2007-10-01'), ('pop_country_code', 'USA'), ('pop_state_code__isnull', False)), fields=['pop_state_code', 'action_date'], name='ts_idx_simple_pop_geolocation'),
        ),
        migrations.AddIndex(
            model_name='transactionsearch',
