    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "sub_ultimate_parent_legal_enti_raw",
                    models.TextField(blank=True, null=True),
                ),
                (
                    "sub_legal_entity_country_code_raw",
                    models.TextField(blank=True, null=True),
                ),
                (
                    "sub_legal_entity_country_name_raw",
                    models.TextField(blank=True, null=True),
                ),
                (
                ...
                (
                    "sub_place_of_perform_country_name",
                    models.TextField(blank=True, null=True),
                ),
                (
                ...
                (
                    "sub_place_of_perform_city_code",
                    models.TextField(blank=True, null=True),
                ),
                (
                ...
                (
                    "recipient_name_ts_vector",
                    django.contrib.postgres.search.SearchVectorField(null=True),
                ),
                ("award", models.BigIntegerField(null=True, db_column="award_id")),
                (
                    "awarding_agency",
                    models.IntegerField(null=True, db_column="awarding_agency_id"),
                ),
                ("cfda", models.IntegerField(null=True, db_column="cfda_id")),
                (
                    "funding_agency",
                    models.IntegerField(null=True, db_column="funding_agency_id"),
                ),
            ],
            options={
        ...
        migrations.AddIndex(
            model_name="subawardsearch",
            index=models.Index(
                condition=models.Q(("prime_award_type__isnull", False)),
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                django.db.models.expressions.OrderBy(
                    django.db.models.expressions.F("subaward_number"),
                    descending=True,
                    nulls_last=True,
                ),
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                django.db.models.expressions.OrderBy(
                    django.db.models.expressions.F("prime_award_type"),
                    descending=True,
                    nulls_last=True,
                ),
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                django.db.models.expressions.OrderBy(
                    django.db.models.functions.text.Upper("fain"),
                    descending=True,
                    nulls_last=True,
                ),
                condition=models.Q(("fain__isnull", False)),
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                django.db.models.expressions.OrderBy(
                    django.db.models.functions.text.Upper("piid"),
                    descending=True,
                    nulls_last=True,
                ),
                condition=models.Q(("piid__isnull", False)),
        ...
        migrations.AddIndex(
            model_name="subawardsearch",
            index=models.Index(
                condition=models.Q(("subaward_amount__isnull", False)),
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                django.db.models.expressions.OrderBy(
                    django.db.models.expressions.F("subaward_amount"),
                    descending=True,
                    nulls_last=True,
                ),
        ...
        migrations.AddIndex(
            model_name="subawardsearch",
            index=models.Index(
                fields=["sub_total_obl_bin"], name="ss_idx_sub_total_obl_bin"
            ),
        ),
        migrations.AddIndex(
            model_name="subawardsearch",
        ...
        migrations.AddIndex(
            model_name="subawardsearch",
            index=models.Index(
                condition=models.Q(("sub_awardee_or_recipient_legal__isnull", False)),
                fields=["sub_awardee_or_recipient_legal"],
        ...
        migrations.AddIndex(
            model_name="subawardsearch",
            index=models.Index(
                condition=models.Q(("sub_awardee_or_recipient_uniqu__isnull", False)),
        ...
        migrations.AddIndex(
            model_name="subawardsearch",
            index=models.Index(
                condition=models.Q(("sub_awardee_or_recipient_uei__isnull", False)),
        ...
        migrations.AddIndex(
            model_name="subawardsearch",
            index=models.Index(
                condition=models.Q(("sub_ultimate_parent_unique_ide__isnull", False)),
        ...
        migrations.AddIndex(
            model_name="subawardsearch",
            index=models.Index(
                condition=models.Q(("sub_ultimate_parent_uei__isnull", False)),
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                django.db.models.expressions.OrderBy(
                    django.db.models.expressions.F("sub_action_date"),
                    descending=True,
                    nulls_last=True,
                ),
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                django.db.models.expressions.OrderBy(
                    django.db.models.expressions.F("last_modified_date"),
                    descending=True,
                    nulls_last=True,
                ),
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                django.db.models.expressions.OrderBy(
                    django.db.models.expressions.F("sub_fiscal_year"),
                    descending=True,
                    nulls_last=True,
                ),
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                django.db.models.expressions.OrderBy(
                    django.db.models.expressions.F("awarding_agency_id"),
                    nulls_last=True,
                ),
                condition=models.Q(("awarding_agency_id__isnull", False)),
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                django.db.models.expressions.OrderBy(
                    django.db.models.expressions.F("funding_agency_id"), nulls_last=True
                ),
                condition=models.Q(("funding_agency_id__isnull", False)),
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                django.db.models.expressions.OrderBy(
                    django.db.models.expressions.F("awarding_toptier_agency_name"),
                    descending=True,
                    nulls_last=True,
                ),
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                django.db.models.expressions.OrderBy(
                    django.db.models.expressions.F("awarding_subtier_agency_name"),
                    descending=True,
                    nulls_last=True,
                ),
        ...
        migrations.AddIndex(
            model_name="subawardsearch",
            index=models.Index(
                condition=models.Q(("awarding_toptier_agency_name__isnull", False)),
        ...
        migrations.AddIndex(
            model_name="subawardsearch",
            index=models.Index(
                condition=models.Q(("awarding_subtier_agency_name__isnull", False)),
        ...
        migrations.AddIndex(
            model_name="subawardsearch",
            index=models.Index(
                condition=models.Q(("funding_toptier_agency_name__isnull", False)),
        ...
        migrations.AddIndex(
            model_name="subawardsearch",
            index=models.Index(
                condition=models.Q(("funding_subtier_agency_name__isnull", False)),
        ...
        migrations.AddIndex(
            model_name="subawardsearch",
            index=models.Index(
                condition=models.Q(("sub_legal_entity_country_code__isnull", False)),
        ...
        migrations.AddIndex(
            model_name="subawardsearch",
            index=models.Index(
                condition=models.Q(("sub_legal_entity_state_code__isnull", False)),
        ...
        migrations.AddIndex(
            model_name="subawardsearch",
            index=models.Index(
                condition=models.Q(("sub_legal_entity_county_code__isnull", False)),
        ...
        migrations.AddIndex(
            model_name="subawardsearch",
            index=models.Index(
                condition=models.Q(("sub_legal_entity_zip5__isnull", False)),
        ...
        migrations.AddIndex(
            model_name="subawardsearch",
            index=models.Index(
                condition=models.Q(("sub_legal_entity_congressional__isnull", False)),
        ...
        migrations.AddIndex(
            model_name="subawardsearch",
            index=models.Index(
                condition=models.Q(("sub_legal_entity_city_name__isnull", False)),
        ...
        migrations.AddIndex(
            model_name="subawardsearch",
            index=models.Index(
                condition=models.Q(("sub_place_of_perform_country_co__isnull", False)),
        ...
        migrations.AddIndex(
            model_name="subawardsearch",
            index=models.Index(
                condition=models.Q(("sub_place_of_perform_state_code__isnull", False)),
        ...
        migrations.AddIndex(
            model_name="subawardsearch",
            index=models.Index(
                condition=models.Q(("sub_place_of_perform_county_code__isnull", False)),
        ...
        migrations.AddIndex(
            model_name="subawardsearch",
            index=models.Index(
                condition=models.Q(("sub_place_of_perform_zip5__isnull", False)),
        ...
        migrations.AddIndex(
            model_name="subawardsearch",
            index=models.Index(
                condition=models.Q(("sub_place_of_perform_congressio__isnull", False)),
        ...
        migrations.AddIndex(
            model_name="subawardsearch",
            index=models.Index(
                condition=models.Q(("sub_place_of_perform_city_name__isnull", False)),
        ...
        migrations.AddIndex(
            model_name="subawardsearch",
            index=models.Index(
                condition=models.Q(("cfda_number__isnull", False)),
                fields=["cfda_number"],
        ...
        migrations.AddIndex(
            model_name="subawardsearch",
            index=models.Index(
                condition=models.Q(("type_of_contract_pricing__isnull", False)),
        ...
        migrations.AddIndex(
            model_name="subawardsearch",
            index=models.Index(
                condition=models.Q(("extent_competed__isnull", False)),
        ...
        migrations.AddIndex(
            model_name="subawardsearch",
            index=models.Index(
                condition=models.Q(("type_set_aside__isnull", False)),
        ...
        migrations.AddIndex(
            model_name="subawardsearch",
            index=models.Index(
                condition=models.Q(("product_or_service_code__isnull", False)),
        ...
        migrations.AddIndex(
            model_name="subawardsearch",
            index=django.contrib.postgres.indexes.GinIndex(
                fields=["business_categories"], name="ss_idx_gin_business_categories"
            ),
        ),
        migrations.AddIndex(
            model_name="subawardsearch",
            index=django.contrib.postgres.indexes.GinIndex(
                fields=["keyword_ts_vector"], name="ss_idx_gin_keyword_ts_vector"
            ),
        ),
        migrations.AddIndex(
            model_name="subawardsearch",
            index=django.contrib.postgres.indexes.GinIndex(
                fields=["award_ts_vector"], name="ss_idx_gin_award_ts_vector"
            ),
        ),
        migrations.AddIndex(
            model_name="subawardsearch",
