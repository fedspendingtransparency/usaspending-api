...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddIndex(
            model_name='transactionsearch',
            index= models.Index(fields=["generated_unique_award_id"], name="ts_idx_award_key_pre2008",
                                condition=Q(action_date__lt="2007-10-01"))
        ),
        migrations.AddIndex(
            model_name='transactionsearch',
            index=models.Index(fields=["piid"], name="ts_idx_piid_pre2008", condition=Q(action_date__lt="2007-10-01"))
        ),
        migrations.AddIndex(
            model_name='transactionsearch',
            index=models.Index(fields=["parent_award_id"], name="ts_idx_parent_award_id_pre2008",
                               condition=Q(action_date__lt="2007-10-01"))
        ),
        migrations.AddIndex(
            model_name='transactionsearch',
            index=models.Index(fields=["fain"], name="ts_idx_fain_pre2008", condition=Q(action_date__lt="2007-10-01"))
        ),
        migrations.AddIndex(
            model_name='transactionsearch',
            index=models.Index(fields=["uri"], name="ts_idx_uri_pre2008", condition=Q(action_date__lt="2007-10-01"))
        ),
    ]
