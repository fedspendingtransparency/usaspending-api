...
subaward_search_load_sql_string = fr"""
    ...
    SELECT
        ...
        bs.place_of_performance_county_code,
        bs.place_of_performance_county_name,
        ...
        bs.sub_place_of_performance_county_code,
        UPPER(bs.sub_place_of_performance_county_name) AS sub_place_of_performance_county_name,
