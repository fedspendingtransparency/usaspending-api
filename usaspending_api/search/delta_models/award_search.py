...
award_search_load_sql_string = fr"""
  ...
  UPPER(COALESCE(recipient_lookup_testing.legal_business_name, transaction_fpds.awardee_or_recipient_legal, transaction_fabs.awardee_or_recipient_legal)) AS recipient_name,
