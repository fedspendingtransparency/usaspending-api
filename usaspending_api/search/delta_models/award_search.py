...
AWARD_SEARCH_COLUMNS = {
    ...
    "award_id": {"delta": "LONG NOT NULL", "postgres": "BIGINT NOT NULL", "gold": True},
    ...
    "category": {"delta": "STRING", "postgres": "TEXT", "gold": True},
    "type": {"delta": "STRING", "postgres": "TEXT", "gold": True},
    "type_description": {"delta": "STRING", "postgres": "TEXT", "gold": True},
    "is_fpds": {"delta": "boolean", "postgres": "boolean", "gold": True},
    "generated_unique_award_id": {"delta": "STRING", "postgres": "TEXT", "gold": True},
    "display_award_id": {"delta": "STRING", "postgres": "TEXT", "gold": False},
    "update_date": {"delta": "TIMESTAMP", "postgres": "TIMESTAMP", "gold": True},
    "certified_date": {"delta": "DATE", "postgres": "DATE", "gold": True},
    "create_date": {"delta": "TIMESTAMP", "postgres": "TIMESTAMP", "gold": True},
    "piid": {"delta": "STRING", "postgres": "TEXT", "gold": True},
    "fain": {"delta": "STRING", "postgres": "TEXT", "gold": True},
    "uri": {"delta": "STRING", "postgres": "TEXT", "gold": True},
    "parent_award_piid": {"delta": "STRING", "postgres": "TEXT", "gold": True},
    "award_amount": {"delta": "NUMERIC(23, 2)", "postgres": "NUMERIC(23, 2)", "gold": False},
    "total_obligation": {"delta": "NUMERIC(23, 2)", "postgres": "NUMERIC(23, 2)", "gold": True},
    "description": {"delta": "STRING", "postgres": "TEXT", "gold": True},
    "total_obl_bin": {"delta": "STRING", "postgres": "TEXT", "gold": False},
    "total_subsidy_cost": {"delta": "NUMERIC(23, 2)", "postgres": "NUMERIC(23, 2)", "gold": True},
    "total_loan_value": {"delta": "NUMERIC(23, 2)", "postgres": "NUMERIC(23, 2)", "gold": True},
    ...
    "fiscal_year": {"delta": "INTEGER", "postgres": "INTEGER", "gold": True},
    "last_modified_date": {"delta": "DATE", "postgres": "DATE", "gold": True},
    "period_of_performance_start_date": {"delta": "DATE", "postgres": "DATE", "gold": True},
    "period_of_performance_current_end_date": {"delta": "DATE", "postgres": "DATE", "gold": True},
    "date_signed": {"delta": "DATE", "postgres": "DATE", "gold": True},
    ...
    "awarding_agency_id": {"delta": "INTEGER", "postgres": "INTEGER", "gold": True},
    "funding_agency_id": {"delta": "INTEGER", "postgres": "INTEGER", "gold": True},
