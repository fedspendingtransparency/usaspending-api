...
AWARD_SEARCH_COLUMNS = {
    ...
    "transaction_unique_id": {"delta": "STRING", "postgres": "TEXT"},
    "latest_transaction_id": {"delta": "LONG", "postgres": "BIGINT"},
    "earliest_transaction_id": {"delta": "LONG", "postgres": "BIGINT"},
    "latest_transaction_search_id": {"delta": "LONG", "postgres": "BIGINT"},
    "earliest_transaction_search_id": {"delta": "LONG", "postgres": "BIGINT"},
    "category": {"delta": "STRING", "postgres": "TEXT"},
    "type_raw": {"delta": "STRING", "postgres": "TEXT"},
    "type_description_raw": {"delta": "STRING", "postgres": "TEXT"},
    "type": {"delta": "STRING", "postgres": "TEXT"},
    "type_description": {"delta": "STRING", "postgres": "TEXT"},
    "is_fpds": {"delta": "boolean", "postgres": "boolean"},
    ...
    "parent_award_piid": {"delta": "STRING", "postgres": "TEXT"},
    ...
    "total_indirect_federal_sharing": {"delta": "NUMERIC(23, 2)", "postgres": "NUMERIC(23, 2)"},
    "base_and_all_options_value": {"delta": "NUMERIC(23, 2)", "postgres": "NUMERIC(23, 2)"},
    "base_exercised_options_val": {"delta": "NUMERIC(23, 2)", "postgres": "NUMERIC(23, 2)"},
    ...
    "raw_recipient_name": {"delta": "STRING", "postgres": "TEXT"},
    ...
    "total_subaward_amount": {"delta": "NUMERIC(23, 2)", "postgres": "NUMERIC(23, 2)"},
    "subaward_count": {"delta": "INTEGER", "postgres": "INTEGER"},
    ...
    "awarding_subtier_agency_name_raw": {"delta": " STRING", "postgres": " STRING"},
    ...
    "awarding_toptier_agency_code_raw": {"delta": "STRING", "postgres": "TEXT"},
    "funding_toptier_agency_code_raw": {"delta": "STRING", "postgres": "TEXT"},
    "awarding_subtier_agency_code_raw": {"delta": "STRING", "postgres": "TEXT"},
    "funding_subtier_agency_code_raw": {"delta": "STRING", "postgres": "TEXT"},
    "funding_toptier_agency_id": {"delta": "INTEGER", "postgres": "INTEGER"},
    "funding_subtier_agency_id": {"delta": "INTEGER", "postgres": "INTEGER"},
    "fpds_agency_id": {"delta": "STRING", "postgres": "TEXT"},
    "fpds_parent_agency_id": {"delta": "STRING", "postgres": "TEXT"},
    ...
    "recipient_location_county_fips": {"delta": "STRING", "postgres": "TEXT"},
    ...
    "pop_county_fips": {"delta": "STRING", "postgres": "TEXT"},
    ...
    "iija_spending_by_defc": {"delta": "STRING", "postgres": "JSONB"},
    "total_iija_outlay": {"delta": "NUMERIC(23, 2)", "postgres": "NUMERIC(23, 2)"},
    "total_iija_obligation": {"delta": "NUMERIC(23, 2)", "postgres": "NUMERIC(23, 2)"},
...
award_search_incremental_load_sql_string = [
    ...
    WHEN MATCHED AND 
      ({" OR ".join([f"s.{col} != t.{col}" for col in AWARD_SEARCH_POSTGRES_COLUMNS])})
      THEN UPDATE SET *
