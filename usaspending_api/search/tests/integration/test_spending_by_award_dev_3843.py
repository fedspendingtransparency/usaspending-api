...
def award_id_search_data(spending_by_award_test_data):
    ...
    SubawardSearch.objects.filter(broker_subaward_id=1).update(piid="abc111")
    SubawardSearch.objects.filter(broker_subaward_id=2).update(piid="abc111")
    SubawardSearch.objects.filter(broker_subaward_id=3).update(piid="abc 111")
    SubawardSearch.objects.filter(broker_subaward_id=6).update(piid="abc       111")
