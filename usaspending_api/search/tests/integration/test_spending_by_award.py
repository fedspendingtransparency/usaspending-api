...
@pytest.mark.django_db
def test_correct_response_for_each_filter(client, monkeypatch, spending_by_award_test_data, elasticsearch_award_index, elasticsearch_subaward_index):
    """
    ...
    assert resp.json()["results"][0] == {
        ...
        "prime_award_internal_id": 3,
        "internal_id": "66666",
        "prime_award_recipient_id": "41874914-2c27-813b-1505-df94f35b42dc-R", # Here
        "recipient_id": None,
        "prime_award_generated_internal_id": "CONT_AWD_TESTING_3", #
    }
    assert resp.json()["results"][1] == {
...
@pytest.mark.django_db
def test_uei_recipient_filter_subaward(client, monkeypatch, spending_by_award_test_data, elasticsearch_award_index, elasticsearch_subaward_index):
    setup_elasticsearch_test(monkeypatch, elasticsearch_award_index)
    setup_elasticsearch_test(monkeypatch, elasticsearch_subaward_index)
