...
def test_tas_filter_not_object_or_list(client, monkeypatch, elasticsearch_award_index, subaward_with_tas):
...
@pytest.mark.django_db
def test_tas_unparsable_too_long(client, monkeypatch, elasticsearch_award_index, subaward_with_tas):
    _setup_es(client, monkeypatch, elasticsearch_award_index)
...
@pytest.mark.django_db
def test_tas_unparsable_no_ata(client, monkeypatch, elasticsearch_award_index, subaward_with_tas):
    _setup_es(client, monkeypatch, elasticsearch_award_index)
...
@pytest.mark.django_db
def test_tas_unparsable_no_sub(client, monkeypatch, elasticsearch_award_index, subaward_with_tas):
    _setup_es(client, monkeypatch, elasticsearch_award_index)
...
@pytest.mark.django_db
def test_tas_unparsable_no_main(client, monkeypatch, elasticsearch_award_index, subaward_with_tas):
    _setup_es(client, monkeypatch, elasticsearch_award_index)
...
@pytest.mark.django_db
def test_tas_filter_is_legacy(client, monkeypatch, elasticsearch_award_index, subaward_with_tas):
    _setup_es(client, monkeypatch, elasticsearch_award_index)
...
def test_treasury_account_component_filter_appropriate_characters(
    client, monkeypatch, elasticsearch_award_index, subaward_with_tas
):
    _setup_es(client, monkeypatch, elasticsearch_award_index)
