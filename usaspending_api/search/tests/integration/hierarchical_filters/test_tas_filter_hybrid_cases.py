...
from usaspending_api.search.tests.integration.hierarchical_filters.es_search_test_helpers import (
    _setup_es,
    _query_by_treasury_account_components,
)
...
def test_match_from_code_filter_only(client, monkeypatch, elasticsearch_award_index, award_with_tas):
    ...
    resp = _query_by_treasury_account_components(client, {"require": [_agency_path(BASIC_TAS)]}, None)
...
def test_match_from_component_filter_only(client, monkeypatch, elasticsearch_award_index, award_with_tas):
    _setup_es(client, monkeypatch, elasticsearch_award_index)
    resp = _query_by_treasury_account_components(client, None, [component_dictionary(BASIC_TAS)])
...
def test_match_from_component_both_filters(client, monkeypatch, elasticsearch_award_index, award_with_tas):
    _setup_es(client, monkeypatch, elasticsearch_award_index)
    resp = _query_by_treasury_account_components(
