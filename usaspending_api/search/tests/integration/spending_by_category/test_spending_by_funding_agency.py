...
def test_correct_response(client, monkeypatch, elasticsearch_transaction_index, basic_award, subagency_award):
    ...
    expected_response = {
        ...
        "results": [
            {"amount": 10.0, "name": "Funding Toptier Agency 2", "code": "TA2", "id": 1002, "total_outlays": None},
            {"amount": 5.0, "name": "Funding Toptier Agency 4", "code": "TA4", "id": 1004, "total_outlays": None},
        ],
