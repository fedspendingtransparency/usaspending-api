...
def test_correct_response(client, monkeypatch, elasticsearch_transaction_index, awards_and_transactions):
    ...
    expected_response = {
        ...
        "results": [
            {"amount": 500000.0, "code": "222220", "id": None, "name": "NAICS 2", "total_outlays": None, "year_retired": None},
            {"amount": 50000.0, "code": "111110", "id": None, "name": "NAICS 1", "total_outlays": None, "year_retired": None},
        ],
