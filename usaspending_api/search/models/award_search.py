...
class AwardSearch(models.Model):
    ...
    fpds_agency_id = models.IntegerField(null=True)
    fpds_parent_agency_id = models.IntegerField(null=True)
    latest_transaction_id = models.IntegerField(null=True)
    ...
    parent_award_piid = models.TextField(null=True)
    ...
    earliest_transaction_id = models.IntegerField(null=True)
