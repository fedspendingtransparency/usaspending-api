...
class TransactionSearch(models.Model):
    ...
    airport_authority = models.TextField(null=True)
    alaskan_native_owned_corpo = models.TextField(null=True)
    alaskan_native_servicing_i = models.TextField(null=True)
    american_indian_owned_busi = models.TextField(null=True)
    asian_pacific_american_own = models.TextField(null=True)
    base_and_all_options_value = models.TextField(null=True)
    base_exercised_options_val = models.TextField(null=True)
    black_american_owned_busin = models.TextField(null=True)
    c1862_land_grant_college = models.TextField(null=True)
    c1890_land_grant_college = models.TextField(null=True)
    c1994_land_grant_college = models.TextField(null=True)
    c8a_program_participant = models.TextField(null=True)
    cage_code = models.TextField(null=True)
    city_local_government = models.TextField(null=True)
    ...
    community_developed_corpor = models.TextField(null=True)
    community_development_corp = models.TextField(null=True)
    ...
    contracts = models.TextField(null=True)
    corporate_entity_not_tax_e = models.TextField(null=True)
    corporate_entity_tax_exemp = models.TextField(null=True)
    ...
    council_of_governments = models.TextField(null=True)
    ...
    domestic_shelter = models.TextField(null=True)
    dot_certified_disadvantage = models.TextField(null=True)
    economically_disadvantaged = models.TextField(null=True)
    educational_institution = models.TextField(null=True)
    emerging_small_business = models.TextField(null=True)
    ...
    federal_agency = models.TextField(null=True)
    federally_funded_research = models.TextField(null=True)
    for_profit_organization = models.TextField(null=True)
    foreign_funding = models.TextField(null=True)
    foreign_funding_desc = models.TextField(null=True)
    foreign_government = models.TextField(null=True)
    foreign_owned_and_located = models.TextField(null=True)
    ...
    grants = models.TextField(null=True)
    hispanic_american_owned_bu = models.TextField(null=True)
    hispanic_servicing_institu = models.TextField(null=True)
    historically_black_college = models.TextField(null=True)
    historically_underutilized = models.TextField(null=True)
    hospital_flag = models.TextField(null=True)
    housing_authorities_public = models.TextField(null=True)
    idv_type = models.TextField(null=True)
    idv_type_description = models.TextField(null=True)
    indian_tribe_federally_rec = models.TextField(null=True)
    ...
    inter_municipal_local_gove = models.TextField(null=True)
    interagency_contract_desc = models.TextField(null=True)
    interagency_contracting_au = models.TextField(null=True)
    international_organization = models.TextField(null=True)
    interstate_entity = models.TextField(null=True)
    joint_venture_economically = models.TextField(null=True)
    joint_venture_women_owned = models.TextField(null=True)
    labor_standards = models.TextField(null=True)
    labor_standards_descrip = models.TextField(null=True)
    labor_surplus_area_firm = models.TextField(null=True)
    limited_liability_corporat = models.TextField(null=True)
    local_area_set_aside = models.TextField(null=True)
    local_area_set_aside_desc = models.TextField(null=True)
    local_government_owned = models.TextField(null=True)
    major_program = models.TextField(null=True)
    manufacturer_of_goods = models.TextField(null=True)
    materials_supplies_article = models.TextField(null=True)
    materials_supplies_descrip = models.TextField(null=True)
    minority_institution = models.TextField(null=True)
    minority_owned_business = models.TextField(null=True)
    ...
    municipality_local_governm = models.TextField(null=True)
    national_interest_action = models.TextField(null=True)
    national_interest_desc = models.TextField(null=True)
    native_american_owned_busi = models.TextField(null=True)
    native_hawaiian_owned_busi = models.TextField(null=True)
    native_hawaiian_servicing = models.TextField(null=True)
    nonprofit_organization = models.TextField(null=True)
    ...
    other_minority_owned_busin = models.TextField(null=True)
    other_not_for_profit_organ = models.TextField(null=True)
    ...
    partnership_or_limited_lia = models.TextField(null=True)
    ...
    planning_commission = models.TextField(null=True)
    port_authority = models.TextField(null=True)
    potential_total_value_awar = models.TextField(null=True)
    price_evaluation_adjustmen = models.TextField(null=True)
    private_university_or_coll = models.TextField(null=True)
    ...
    receives_contracts_and_gra = models.TextField(null=True)
    ...
    sba_certified_8_a_joint_ve = models.TextField(null=True)
    school_district_local_gove = models.TextField(null=True)
    school_of_forestry = models.TextField(null=True)
    sea_transportation = models.TextField(null=True)
    sea_transportation_desc = models.TextField(null=True)
    self_certified_small_disad = models.TextField(null=True)
    service_disabled_veteran_o = models.TextField(null=True)
    small_agricultural_coopera = models.TextField(null=True)
    small_business_competitive = models.TextField(null=True)
    small_disadvantaged_busine = models.TextField(null=True)
    sole_proprietorship = models.TextField(null=True)
    ...
    state_controlled_instituti = models.TextField(null=True)
    subchapter_s_corporation = models.TextField(null=True)
    subcontinent_asian_asian_i = models.TextField(null=True)
    subcontracting_plan = models.TextField(null=True)
    subcontracting_plan_desc = models.TextField(null=True)
    the_ability_one_program = models.TextField(null=True)
    total_obligated_amount = models.TextField(null=True)
    township_local_government = models.TextField(null=True)
    transaction_number = models.TextField(null=True)
    transit_authority = models.TextField(null=True)
    tribal_college = models.TextField(null=True)
    tribally_owned_business = models.TextField(null=True)
    ...
    us_federal_government = models.TextField(null=True)
    us_government_entity = models.TextField(null=True)
    us_local_government = models.TextField(null=True)
    us_state_government = models.TextField(null=True)
    us_tribal_government = models.TextField(null=True)
    ...
    veteran_owned_business = models.TextField(null=True)
    veterinary_college = models.TextField(null=True)
    veterinary_hospital = models.TextField(null=True)
    woman_owned_business = models.TextField(null=True)
    women_owned_small_business = models.TextField(null=True)
