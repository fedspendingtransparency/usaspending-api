...
@pytest.fixture
def fixture_data(db):
    mommy.make("agencies.ToptierAgency", cgac_code="001", abbreviation="ABCD", name="Dept. of Depts")
    mommy.make("agencies.ToptierAgency", cgac_code="002", abbreviation="EFGH", name="The Bureau")
    mommy.make("agencies.ToptierAgency", cgac_code="1601", abbreviation="DOL", name="Department of Labor")
    mommy.make("agencies.ToptierAgency", cgac_code="097", abbreviation="DOD", name="Department of Defense")
    mommy.make("agencies.ToptierAgency", cgac_code="021", abbreviation="DOD", name="Department of Navy")
