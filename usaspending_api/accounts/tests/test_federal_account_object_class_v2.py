...
def financial_spending_data(db):
    ...
    object_class_1 = mommy.make('references.ObjectClass', major_object_class="10", major_object_class_name="mocName1",
                                object_class="111", object_class_name="ocName1")
    object_class_2 = mommy.make('references.ObjectClass', major_object_class="20", major_object_class_name="mocName2",
                                object_class="222", object_class_name="ocName2")
    object_class_4 = mommy.make('references.ObjectClass', major_object_class="20", major_object_class_name="mocName2",
                                object_class="444", object_class_name="ocName4")
    mommy.make('references.ObjectClass', major_object_class="30", major_object_class_name="mocName3",
               object_class="333", object_class_name="ocName3")
    ...
    mommy.make('financial_activities.FinancialAccountsByProgramActivityObjectClass', treasury_account=tas,
