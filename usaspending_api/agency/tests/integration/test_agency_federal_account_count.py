...
def agency_data():
    ...
    tas1 = mommy.make("accounts.TreasuryAppropriationAccount", funding_toptier_agency=ta1, federal_account=fa1)
    tas2 = mommy.make("accounts.TreasuryAppropriationAccount", funding_toptier_agency=ta2, federal_account=fa2)
    tas3 = mommy.make("accounts.TreasuryAppropriationAccount", funding_toptier_agency=ta3, federal_account=fa3)
