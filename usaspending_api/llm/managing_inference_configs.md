...
AI Assistants are configured entities that combine an AI model, system prompt, and inference configurations. Each Assistant can be independently configured and updated using management commands.
