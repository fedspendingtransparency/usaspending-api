...
def ai_model_data(db):
    ...
    return baker.make("llm.AIModel", name="nova micro", model_id="amazon.nova-micro-v1:0", provider="amazon")
...
class TestFilterSearch:
    ...
    def test_endpoint_uses_environment_model(self, client, mock_llm_api_key, mock_bedrock_client, system_prompt_data):
        ...
        custom_model = baker.make(
            "llm.AIModel", name="claude 4.5", model_id="anthropic.claude-sonnet-4-5-20250929-v1:0", provider="anthropic"
        )
