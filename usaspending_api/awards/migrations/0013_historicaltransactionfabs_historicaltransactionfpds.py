    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('transaction', models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='awards.TransactionNormalized')),
            ],
            options={
                'verbose_name': 'historical transaction fabs',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('detached_award_proc_unique', models.TextField(db_index=True)),
            ...
            options={
                'verbose_name': 'historical transaction fpds',
                'ordering': ('-history_date', '-history_id'),
                'get_latest_by': 'history_date',
            },
        ),
