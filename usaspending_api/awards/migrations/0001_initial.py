    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('small_business_competitive', models.NullBooleanField()),
                ...
                ('city_local_government', models.NullBooleanField()),
                ('county_local_government', models.NullBooleanField()),
                ('inter_municipal_local_gove', models.NullBooleanField()),
                ('local_government_owned', models.NullBooleanField()),
                ('municipality_local_governm', models.NullBooleanField()),
                ('school_district_local_gove', models.NullBooleanField()),
                ('township_local_government', models.NullBooleanField()),
                ('us_state_government', models.NullBooleanField()),
                ('us_federal_government', models.NullBooleanField()),
                ('federal_agency', models.NullBooleanField()),
                ('federally_funded_research', models.NullBooleanField()),
                ('us_tribal_government', models.NullBooleanField()),
                ('foreign_government', models.NullBooleanField()),
                ('community_developed_corpor', models.NullBooleanField()),
                ('labor_surplus_area_firm', models.NullBooleanField()),
                ('corporate_entity_not_tax_e', models.NullBooleanField()),
                ('corporate_entity_tax_exemp', models.NullBooleanField()),
                ('partnership_or_limited_lia', models.NullBooleanField()),
                ('sole_proprietorship', models.NullBooleanField()),
                ('small_agricultural_coopera', models.NullBooleanField()),
                ('international_organization', models.NullBooleanField()),
                ('us_government_entity', models.NullBooleanField()),
                ('emerging_small_business', models.NullBooleanField()),
                ('c8a_program_participant', models.NullBooleanField()),
                ('sba_certified_8_a_joint_ve', models.NullBooleanField()),
                ('dot_certified_disadvantage', models.NullBooleanField()),
                ('self_certified_small_disad', models.NullBooleanField()),
                ('historically_underutilized', models.NullBooleanField()),
                ('small_disadvantaged_busine', models.NullBooleanField()),
                ('the_ability_one_program', models.NullBooleanField()),
                ('historically_black_college', models.NullBooleanField()),
                ...
                ('minority_institution', models.NullBooleanField()),
                ('private_university_or_coll', models.NullBooleanField()),
                ('school_of_forestry', models.NullBooleanField()),
                ('state_controlled_instituti', models.NullBooleanField()),
                ('tribal_college', models.NullBooleanField()),
                ('veterinary_college', models.NullBooleanField()),
                ('educational_institution', models.NullBooleanField()),
                ('alaskan_native_servicing_i', models.NullBooleanField()),
                ('community_development_corp', models.NullBooleanField()),
                ('native_hawaiian_servicing', models.NullBooleanField()),
                ('domestic_shelter', models.NullBooleanField()),
                ('manufacturer_of_goods', models.NullBooleanField()),
                ('hospital_flag', models.NullBooleanField()),
                ('veterinary_hospital', models.NullBooleanField()),
                ('hispanic_servicing_institu', models.NullBooleanField()),
                ('foundation', models.NullBooleanField()),
                ('woman_owned_business', models.NullBooleanField()),
                ('minority_owned_business', models.NullBooleanField()),
                ('women_owned_small_business', models.NullBooleanField()),
                ('economically_disadvantaged', models.NullBooleanField()),
                ('joint_venture_women_owned', models.NullBooleanField()),
                ('joint_venture_economically', models.NullBooleanField()),
                ('veteran_owned_business', models.NullBooleanField()),
                ('service_disabled_veteran_o', models.NullBooleanField()),
                ('contracts', models.NullBooleanField()),
                ('grants', models.NullBooleanField()),
                ('receives_contracts_and_gra', models.NullBooleanField()),
                ('airport_authority', models.NullBooleanField()),
                ('council_of_governments', models.NullBooleanField()),
                ('housing_authorities_public', models.NullBooleanField()),
                ('interstate_entity', models.NullBooleanField()),
                ('planning_commission', models.NullBooleanField()),
                ('port_authority', models.NullBooleanField()),
                ('transit_authority', models.NullBooleanField()),
                ('subchapter_s_corporation', models.NullBooleanField()),
                ('limited_liability_corporat', models.NullBooleanField()),
                ('foreign_owned_and_located', models.NullBooleanField()),
                ('american_indian_owned_busi', models.NullBooleanField()),
                ('alaskan_native_owned_corpo', models.NullBooleanField()),
                ('indian_tribe_federally_rec', models.NullBooleanField()),
                ('native_hawaiian_owned_busi', models.NullBooleanField()),
                ('tribally_owned_business', models.NullBooleanField()),
                ('asian_pacific_american_own', models.NullBooleanField()),
                ('black_american_owned_busin', models.NullBooleanField()),
                ('hispanic_american_owned_bu', models.NullBooleanField()),
                ('native_american_owned_busi', models.NullBooleanField()),
                ('subcontinent_asian_asian_i', models.NullBooleanField()),
                ('other_minority_owned_busin', models.NullBooleanField()),
                ('for_profit_organization', models.NullBooleanField()),
                ('nonprofit_organization', models.NullBooleanField()),
                ('other_not_for_profit_organ', models.NullBooleanField()),
                ('us_local_government', models.NullBooleanField()),
