    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    models.TextField(
                        blank=True,
                        db_index=True,
                        help_text="The uri of the award",
                        null=True,
                    ),
                ),
                (
                ...
                (
                    ...
                    models.DateField(
                        blank=True,
                        help_text="The date this award was last modified",
                        null=True,
                    ),
                ),
                (
                    ...
                    models.DateField(
                        blank=True,
                        help_text="The date this record was certified",
                        null=True,
                    ),
                ),
                (
                ...
                (
                    ...
                    models.TextField(
                        default="NONE", verbose_name="Generated Unique Award ID"
                    ),
                ),
                ...
                (
                    ...
                    models.IntegerField(
                        blank=True,
                        help_text="Fiscal Year calculated based on Action Date",
                        null=True,
                    ),
                ),
                (
                    "total_subaward_amount",
                    models.DecimalField(decimal_places=2, max_digits=23, null=True),
                ),
                ...
                (
                    ...
                    models.TextField(
                        blank=True,
                        help_text="Executive Compensation Officer 1 Name",
                        null=True,
                    ),
                ),
                (
                ...
                (
                    ...
                    models.TextField(
                        blank=True,
                        help_text="Executive Compensation Officer 2 Name",
                        null=True,
                    ),
                ),
                (
                ...
                (
                    ...
                    models.TextField(
                        blank=True,
                        help_text="Executive Compensation Officer 3 Name",
                        null=True,
                    ),
                ),
                (
                ...
                (
                    ...
                    models.TextField(
                        blank=True,
                        help_text="Executive Compensation Officer 4 Name",
                        null=True,
                    ),
                ),
                (
                ...
                (
                    ...
                    models.TextField(
                        blank=True,
                        help_text="Executive Compensation Officer 5 Name",
                        null=True,
                    ),
                ),
                (
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "description",
                    models.TextField(
                        help_text="The description of this transaction", null=True
                    ),
                ),
                (
                ...
                (
                    ...
                    models.DateField(
                        blank=True,
                        help_text="The date this transaction was certified",
                        null=True,
                    ),
                ),
                (
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "direct_total_obligation",
                    models.DecimalField(decimal_places=2, max_digits=23),
                ),
                (
                    "direct_base_and_all_options_value",
                    models.DecimalField(decimal_places=2, max_digits=23),
                ),
                (
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                null=True,
                on_delete=django.db.models.deletion.DO_NOTHING,
                to="references.RefProgramActivity",
            ),
        ),
        migrations.AddField(
            model_name="financialaccountsbyawards",
        ...
        migrations.AddIndex(
            model_name="award",
            index=models.Index(
                fields=["-update_date"], name="awards_update_date_desc_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="award",
            index=models.Index(
                fields=["generated_unique_award_id"], name="award_unique_id"
            ),
        ),
        migrations.RunSQL(
            sql=[
