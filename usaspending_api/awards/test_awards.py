...
class AwardTests(TestCase):
    ...
    def test_award_list_summary(self):
        ...
        self.assertEqual(self.client.get('/api/v1/awards/summary/').status_code, 200)
        ...
        self.assertEqual(self.client.post('/api/v1/awards/summary/', content_type='application/json', data=json.dumps({"page": 1, "limit": 10, "filters": [{"field": "funding_agency__toptier_agency__fpds_code", "operation": "equals", "value": "0300"}]})).status_code, 200)
        self.assertEqual(self.client.post('/api/v1/awards/summary/', content_type='application/json', data=json.dumps({"page": 1, "limit": 10, "filters": [{"combine_method": "OR", "filters": [{"field": "funding_agency__toptier_agency__fpds_code", "operation": "equals", "value": "0300"}, {"field": "awarding_agency__toptier_agency__fpds_code", "operation": "equals", "value": "0300"}]}]})).status_code, 200)
        self.assertEqual(self.client.post('/api/v1/awards/summary/', content_type='application/json', data=json.dumps({"page": 1, "limit": 10, "filters": [{"field": "funding_agency__toptier_agency__fpds_code", "operation": "ff", "value": "0300"}]})).status_code, 400)
