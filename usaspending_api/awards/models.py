...
class AwardAction(models.Model):
    ...
    award_modification_amendment_number = models.CharField(max_length=50, blank=True, null=True)
...
class Procurement(AwardAction):
    ...
    potential_total_value_of_award = models.DecimalField(max_digits=20, decimal_places=0, blank=True, null=True)
    ...
    drv_current_aggregated_total_value_of_award = models.DecimalField(max_digits=20, decimal_places=0, blank=True, null=True)
    drv_current_total_value_of_award = models.DecimalField(max_digits=20, decimal_places=0, blank=True, null=True)
    drv_potential_award_idv_amount_total_estimate = models.DecimalField(max_digits=20, decimal_places=0, blank=True, null=True)
    drv_potential_aggregated_award_idv_amount_total_estimate = models.DecimalField(max_digits=20, decimal_places=0, blank=True, null=True)
    drv_potential_aggregated_total_value_of_award = models.DecimalField(max_digits=20, decimal_places=0, blank=True, null=True)
    drv_potential_total_value_of_award = models.DecimalField(max_digits=20, decimal_places=0, blank=True, null=True)
    create_date = models.DateTimeField(auto_now_add=True, blank=True, null=True)
    update_date = models.DateTimeField(auto_now=True, null=True)
    reporting_period_start = models.DateField(blank=True, null=True)
    reporting_period_end = models.DateField(blank=True, null=True)
...
class FinancialAssistanceAward(AwardAction):
    ...
    drv_federal_funding_amount = models.DecimalField(max_digits=20, decimal_places=0, blank=True, null=True)
