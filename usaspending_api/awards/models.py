...
class Award(DataSourceTrackedModel):
    ...
    type = models.CharField(max_length=5, choices=AWARD_TYPES, verbose_name="Award Type", default='U', null=True, help_text="The type of the award. For example, A, B, C, D")
    ...
    piid = models.CharField(max_length=50, blank=True, null=True, help_text="The piid of the award")
    parent_award = models.ForeignKey('awards.Award', related_name='child_award', null=True, help_text="The parent award, if applicable")
    fain = models.CharField(max_length=30, blank=True, null=True, help_text="The fain of the award")
    uri = models.CharField(max_length=70, blank=True, null=True, help_text="The uri of the award")
    total_obligation = models.DecimalField(max_digits=15, decimal_places=2, null=True, verbose_name="Total Obligated", help_text="The sum of all federal_action_obligation of assosciated transactions")
    total_outlay = models.DecimalField(max_digits=15, decimal_places=2, null=True, help_text="The total outlay on the award")
    ...
    place_of_performance = models.ForeignKey(Location, null=True, help_text="The location where work is being performed")
