...
class Award(DataSourceTrackedModel):
    ...
    latest_transaction = models.ForeignKey("awards.Transaction", related_name="latest_for_award", null=True, help_text="The latest transaction by action_date associated with this award")  # set during ETL by etl.award_helpers.update_awards
...
class TransactionContract(DataSourceTrackedModel):
    ...
    base_exercised_options_val = models.DecimalField(max_digits=20, decimal_places=2, blank=True, null=True, help_text="The current value of the award")
    base_and_all_options_value = models.DecimalField(max_digits=20, decimal_places=2, blank=True, null=True, verbose_name="Base and all Options Value", help_text="The base and all options value")
