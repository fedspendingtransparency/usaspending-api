...
class Award(DataSourceTrackedModel):
    ...
    latest_transaction = models.ForeignKey("awards.TransactionNormalized", related_name="latest_for_award_2", null=True, help_text="The latest transaction by action_date associated with this award")
