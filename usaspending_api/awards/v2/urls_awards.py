...
from usaspending_api.awards.v2.views.awards import (
    AwardLastUpdatedViewSet,
    AwardRetrieveViewSet,
)
from usaspending_api.awards.v2.views.funding_rollup import AwardFundingRollupViewSet
from usaspending_api.awards.v2.views.count.transaction_count import (
    TransactionCountRetrieveViewSet,
)
from usaspending_api.awards.v2.views.count.subaward_count import (
    SubawardCountRetrieveViewSet,
)
from usaspending_api.awards.v2.views.count.federal_accounts_count import (
    FederalAccountCountRetrieveViewSet,
)
...
urlpatterns = [
    ...
    re_path(
        r"^count/transaction/{}/$".format(award_id_regex),
        TransactionCountRetrieveViewSet.as_view(),
    ),
    re_path(
        r"^count/subaward/{}/$".format(award_id_regex),
        SubawardCountRetrieveViewSet.as_view(),
    ),
    re_path(
        r"^count/federal_account/{}/$".format(award_id_regex),
