...
from usaspending_api.awards.models_matviews import ViewAwardDownload, UniversalTransactionView
...
def universal_award_matview_filter(filters):
    return matview_search_filter(filters, ViewAwardDownload, for_downloads=True)
