...
from usaspending_api.awards.models_matviews import ViewSearchAward, UniversalTransactionView
...
def universal_award_matview_filter(filters):
    return matview_search_filter(filters, ViewSearchAward, for_downloads=True)
