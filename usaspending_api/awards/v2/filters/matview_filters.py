...
from usaspending_api.awards.models_matviews import ReportingAwardDownloadView, UniversalTransactionView
...
def universal_award_matview_filter(filters):
    return matview_search_filter(filters, ReportingAwardDownloadView, for_downloads=True)
