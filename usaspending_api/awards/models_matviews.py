...
class UniversalTransactionView(models.Model):
    ...
    transaction = models.ForeignKey(TransactionNormalized, on_delete=models.DO_NOTHING, null=False, to_field='id')
...
class UniversalAwardView(models.Model):
    ...
    award = models.ForeignKey(Award, on_delete=models.DO_NOTHING, null=False, to_field='id')
