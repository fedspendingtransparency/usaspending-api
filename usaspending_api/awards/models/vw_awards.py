...
class AwardViewManager(models.Manager):
    def get_queryset(self):
        ...
        return super(AwardViewManager, self).get_queryset().filter(~Q(**q_kwargs))


class AwardView(DataSourceTrackedModel):
    """
