...
def trans_exp_data(db):
    mommy.make('awards.TransactionNormalized',
               usaspending_unique_transaction_id='123', federal_action_obligation=0,
               action_date=datetime.date(2018, 1, 1), original_loan_subsidy_cost=100, type='07'
               )

    mommy.make('awards.TransactionNormalized',
               usaspending_unique_transaction_id='1234', federal_action_obligation=200,
               action_date=datetime.date(2018, 1, 1), type='A'
               )
...
def award_exp_data(db):
    mommy.make('awards.Award',
               generated_unique_award_id='123', total_obligation=0, total_subsidy_cost=1000.00, type='07'
               )

    mommy.make('awards.Award',
               generated_unique_award_id='1234', total_obligation=1200.00, type='B'
               )
