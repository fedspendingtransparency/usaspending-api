...
def award_spending_data(db):
    ...
    award = baker.make("search.AwardSearch", award_id=1, category="grants", awarding_agency=agency)
    award1 = baker.make("search.AwardSearch", award_id=2, category="contracts", awarding_agency=agency)
    award2 = baker.make("search.AwardSearch", award_id=3, category=None, awarding_agency=agency)
    baker.make(
