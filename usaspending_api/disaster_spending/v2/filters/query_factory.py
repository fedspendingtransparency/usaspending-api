...
class QueryFactory(object):
    def __init__(self, award_queryset, account_queryset):
    ...
    def recipient(self):
        # Recipients Queryset
        alt_set = (
            self.award_queryset.filter(~Q(transaction_obligated_amount=Decimal("NaN")))
            .filter(
    ...
    def agency(self):
        ...
        queryset = (
            self.account_queryset.filter(treasury_account__funding_toptier_agency__isnull=False)
            .annotate(
