...
def awards_and_transactions(db):
    baker.make("search.AwardSearch", award_id=1, total_obligation="2000", _quantity=2)
    baker.make("search.AwardSearch", award_id=1, total_obligation=None, date_signed=None)
