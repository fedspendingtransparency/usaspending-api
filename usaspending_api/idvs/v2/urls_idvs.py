...
from usaspending_api.idvs.v2.views.count.federal_account import (
    IDVFederalAccountCountViewSet,
)
...
urlpatterns = [
    ...
    re_path(
        "^amounts/(?P<requested_award>(CONT_IDV_.+)|([0-9]+))/$",
        IDVAmountsViewSet.as_view(),
    ),
