...
@pytest.mark.parametrize("path, timestamp, expected_filename", [
    ("awards", "11111", "v1_awards_11111.csv"),
    ("/v1/awards/", "12345", "v1_awards_12345.csv"),
    ("transactions", "11111", "v1_transactions_11111.csv"),
])
def test_create_filename_from_options(path, timestamp, expected_filename):
    assert create_filename_from_options(path, timestamp) == expected_filename
