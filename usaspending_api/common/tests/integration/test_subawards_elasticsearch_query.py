...
from usaspending_api.common.query_with_filters import SubawardsQueryWithFilters
...
def test_keyword_filter_duns(client, monkeypatch, elasticsearch_subaward_index, subaward_test_data_fixture):
    ...
    filter_query = SubawardsQueryWithFilters.generate_subawards_elasticsearch_query(filters)
