...
def recipient_lookup(db):
    ...
    baker.make(
        "recipient.RecipientProfile",
        recipient_hash="b2c8fe8e-b520-c47f-31e3-3620a358ce48",
        recipient_level="C",
    )
    ...
    baker.make(
        ...
        duns=None,
        uei="123",
        recipient_hash="f5ba3b35-167d-8f32-57b0-406c3479de90",
    )
    baker.make(
        "recipient.RecipientLookup",
        duns=None,
        uei="456",
        recipient_hash="ede3440b-e344-a923-035e-feed34773b57",
    )
    baker.make(
        "recipient.RecipientProfile",
        recipient_hash="f5ba3b35-167d-8f32-57b0-406c3479de90",
