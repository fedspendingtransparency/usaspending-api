...
@pytest.mark.parametrize('model, request_data, result', [
    (Award, {'field': 'total_obligation', 'group': 'period_of_performance_start_date'}, [
        {'item': datetime.date(2017, 1, 1), 'aggregate': Decimal('2000.00')},
        {'item': datetime.date(2018, 6, 1), 'aggregate': None},
        {'item': datetime.date(2018, 1, 1), 'aggregate': Decimal('4000.02')},
        {'item': datetime.date(2016, 7, 13), 'aggregate': Decimal('1000.01')}
    ]),
