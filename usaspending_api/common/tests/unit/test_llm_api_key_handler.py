...
class TestLLMAPIKeyHandler:
    ...
    def test_secret_not_found_returns_403_with_message(self, mock_session, api_rf):
        ...
        assert "llm_api_secret" in response.data["detail"]
    ...
    def test_invalid_uuid_returns_403_with_message(self, mock_session, api_rf):
        ...
        """
        mock_client = MagicMock()
        mock_client.get_secret_value.return_value = {"SecretString": "correct-uuid-123"}
        mock_session.return_value.client.return_value = mock_client
    ...
    def test_valid_uuid_with_whitespace_strips_correctly(self, mock_session, api_rf):
        ...
        """
        mock_client = MagicMock()
        mock_client.get_secret_value.return_value = {"SecretString": "  correct-uuid-with-spaces  "}
        mock_session.return_value.client.return_value = mock_client
    ...
    def test_post_request_with_valid_uuid(self, mock_session, api_rf):
        ...
        """
        mock_client = MagicMock()
        mock_client.get_secret_value.return_value = {"SecretString": "post-uuid-123"}
        mock_session.return_value.client.return_value = mock_client
    ...
    def test_uses_aws_region_from_environment(self, mock_session, api_rf):
        ...
        """
        mock_client = MagicMock()
        mock_client.get_secret_value.return_value = {"SecretString": "test-uuid-region"}
        mock_session.return_value.client.return_value = mock_client
        ...
        mock_session.return_value.client.assert_called_with(service_name="secretsmanager", region_name="us-east-1")
        assert response.status_code == 200
    ...
    def test_defaults_to_us_gov_west_1_region(self, mock_session, api_rf):
        ...
        """
        mock_client = MagicMock()
        mock_client.get_secret_value.return_value = {"SecretString": "test-uuid-default-region"}
        mock_session.return_value.client.return_value = mock_client
        ...
        mock_session.return_value.client.assert_called_with(service_name="secretsmanager", region_name="us-gov-west-1")
        assert response.status_code == 200
