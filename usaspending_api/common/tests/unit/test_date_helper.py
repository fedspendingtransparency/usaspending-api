...
from usaspending_api.common.helpers.date_helper import (
    cast_datetime_to_naive, cast_datetime_to_utc, datetime_command_line_argument_type, get_date_from_datetime)
...
def test_datetime_command_line_argument_type():
    ...
    assert datetime_command_line_argument_type(True)('2000-01-02 3:04:05.06') == \
        datetime(2000, 1, 2, 3, 4, 5, 60000, tzinfo=None)
    assert datetime_command_line_argument_type(False)('2000-01-02 3:04:05.06') == \
        datetime(2000, 1, 2, 3, 4, 5, 60000, tzinfo=timezone.utc)

    assert datetime_command_line_argument_type(True)('2 jan 2000 3:04:05.06') == \
        datetime(2000, 1, 2, 3, 4, 5, 60000, tzinfo=None)
    assert datetime_command_line_argument_type(False)('2 jan 2000 3:04:05.06') == \
        datetime(2000, 1, 2, 3, 4, 5, 60000, tzinfo=timezone.utc)

    assert datetime_command_line_argument_type(True)('1/2/2000 3:04:05.06') == \
        datetime(2000, 1, 2, 3, 4, 5, 60000, tzinfo=None)
    assert datetime_command_line_argument_type(False)('1/2/2000 3:04:05.06') == \
        datetime(2000, 1, 2, 3, 4, 5, 60000, tzinfo=timezone.utc)

    assert datetime_command_line_argument_type(True)('2000-01-02 7:04:05.06+0400') == \
        datetime(2000, 1, 2, 3, 4, 5, 60000, tzinfo=None)
    assert datetime_command_line_argument_type(False)('2000-01-02 7:04:05.06+0400') == \
        datetime(2000, 1, 2, 3, 4, 5, 60000, tzinfo=timezone.utc)

    assert datetime_command_line_argument_type(True)('2000-01-02 3:04:05Z') == \
        datetime(2000, 1, 2, 3, 4, 5, tzinfo=None)
    assert datetime_command_line_argument_type(False)('2000-01-02 3:04:05Z') == \
        datetime(2000, 1, 2, 3, 4, 5, tzinfo=timezone.utc)

    assert datetime_command_line_argument_type(True)('2000-01-02T3:04:05Z') == \
        datetime(2000, 1, 2, 3, 4, 5, tzinfo=None)
    assert datetime_command_line_argument_type(False)('2000-01-02T3:04:05Z') == \
        datetime(2000, 1, 2, 3, 4, 5, tzinfo=timezone.utc)

    assert datetime_command_line_argument_type(True)('2000-1-2 3:4:5') == \
        datetime(2000, 1, 2, 3, 4, 5, tzinfo=None)
    assert datetime_command_line_argument_type(False)('2000-1-2 3:4:5') == \
        datetime(2000, 1, 2, 3, 4, 5, tzinfo=timezone.utc)
