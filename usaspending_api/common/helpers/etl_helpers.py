...
def update_c_to_d_linkages(type, count=True, submission_id=None, file_d_tablename="award_search"):
    ...
    for file_name in file_names:
        ...
        for command in sql_commands:
            ...
            command = command.format(submission_id_clause=submission_id_clause, file_d_tablename=file_d_tablename)
            with connection.cursor() as cursor:
