...
def _verify_float_value(value: str | int | float) -> float | None:
    try:
        return float(value)
    except Exception:
        pass
...
def validate_boolean(rule: dict) -> bool:
...
def validate_datetime(rule: dict) -> str:
...
def validate_object(rule: dict) -> dict:
