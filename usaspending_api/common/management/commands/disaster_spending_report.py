...
SELECT
    ...
    "transaction_fpds"."legal_entity_county_code" AS "recipient_country_code",
    "transaction_fpds"."legal_entity_county_name" AS "recipient_country_name",
    ...
    "transaction_fpds"."legal_entity_state_name" AS "recipient_state_name",
    "transaction_fpds"."zip4" AS "recipient_zip_4_code",
    "transaction_fpds"."congressional_code" AS "recipient_congressional_district",
    "transaction_fpds"."vendor_phone_number" AS "recipient_phone",
    ...
    "transaction_fpds"."place_of_perform_county_co" AS "primary_place_of_performance_county_code",
    ...
    "transaction_fpds"."award_or_idv_flag",
    ...
    "transaction_fpds"."type_of_idc_code",
    ...
    "transaction_fpds"."domestic_or_foreign_entity_code",
    "transaction_fpds"."domestic_or_foreign_entity",
    "transaction_fpds"."dod_acquisition_program_code",
    "transaction_fpds"."dod_acquisition_program_description",
    "transaction_fpds"."information_technology_commercial_item_category_code",
    "transaction_fpds"."information_technology_commercial_item_category",
    "transaction_fpds"."epa_designated_product_code",
    "transaction_fpds"."epa_designated_product",
    "transaction_fpds"."country_of_product_or_service_origin_code",
    "transaction_fpds"."country_of_product_or_service_origin",
    "transaction_fpds"."place_of_manufacture_code",
    "transaction_fpds"."place_of_manufacture",
    "transaction_fpds"."subcontracting_plan_code",
    "transaction_fpds"."subcontracting_plan",
    "transaction_fpds"."extent_competed_code",
    "transaction_fpds"."extent_competed",
    "transaction_fpds"."solicitation_procedures_code",
    "transaction_fpds"."solicitation_procedures",
    "transaction_fpds"."type_of_set_aside_code",
    "transaction_fpds"."type_of_set_aside",
    "transaction_fpds"."evaluated_preference_code",
    "transaction_fpds"."evaluated_preference",
    "transaction_fpds"."research_code",
    "transaction_fpds"."research",
    "transaction_fpds"."fair_opportunity_limited_sources_code",
    "transaction_fpds"."fair_opportunity_limited_sources",
    "transaction_fpds"."other_than_full_and_open_competition_code",
    "transaction_fpds"."other_than_full_and_open_competition",
    "transaction_fpds"."number_of_offers_received",
    "transaction_fpds"."commercial_item_acquisition_procedures_code",
    "transaction_fpds"."commercial_item_acquisition_procedures",
    "transaction_fpds"."small_business_competitiveness_demonstration_program",
    "transaction_fpds"."commercial_item_test_program_code",
    "transaction_fpds"."commercial_item_test_program",
    "transaction_fpds"."a76_fair_act_action_code",
    "transaction_fpds"."a76_fair_act_action",
    "transaction_fpds"."fed_biz_opps_code",
    "transaction_fpds"."fed_biz_opps",
    "transaction_fpds"."local_area_set_aside_code",
    "transaction_fpds"."local_area_set_aside",
    "transaction_fpds"."clinger_cohen_act_planning_code",
    "transaction_fpds"."clinger_cohen_act_planning",
    "transaction_fpds"."materials_supplies_articles_equipment_code",
    "transaction_fpds"."materials_supplies_articles_equipment",
    "transaction_fpds"."labor_standards_code",
    "transaction_fpds"."labor_standards",
    "transaction_fpds"."construction_wage_rate_requirements_code",
    "transaction_fpds"."construction_wage_rate_requirements",
    "transaction_fpds"."interagency_contracting_authority_code",
    "transaction_fpds"."interagency_contracting_authority",
    "transaction_fpds"."other_statutory_authority",
    "transaction_fpds"."program_acronym",
    "transaction_fpds"."parent_award_type_code",
    "transaction_fpds"."parent_award_type",
    "transaction_fpds"."parent_award_single_or_multiple_code",
    "transaction_fpds"."parent_award_single_or_multiple",
    "transaction_fpds"."major_program",
    "transaction_fpds"."national_interest_action_code",
    "transaction_fpds"."national_interest_action",
    "transaction_fpds"."cost_or_pricing_data_code",
    "transaction_fpds"."cost_or_pricing_data",
    "transaction_fpds"."cost_accounting_standards_clause_code",
    "transaction_fpds"."cost_accounting_standards_clause",
    "transaction_fpds"."gfe_gfp_code",
    "transaction_fpds"."gfe_gfp",
    "transaction_fpds"."sea_transportation_code",
    "transaction_fpds"."sea_transportation",
    "transaction_fpds"."consolidated_contract_code",
    "transaction_fpds"."consolidated_contract",
    "transaction_fpds"."performance_based_service_acquisition_code",
    "transaction_fpds"."performance_based_service_acquisition",
    "transaction_fpds"."multi_year_contract_code",
    "transaction_fpds"."multi_year_contract",
    "transaction_fpds"."contract_financing_code",
    "transaction_fpds"."contract_financing",
    "transaction_fpds"."purchase_card_as_payment_method_code",
    "transaction_fpds"."purchase_card_as_payment_method",
    "transaction_fpds"."contingency_humanitarian_or_peacekeeping_operation_code",
    "transaction_fpds"."contingency_humanitarian_or_peacekeeping_operation",
    "transaction_fpds"."alaskan_native_owned_corporation_or_firm",
    "transaction_fpds"."american_indian_owned_business",
    "transaction_fpds"."indian_tribe_federally_recognized",
    "transaction_fpds"."native_hawaiian_owned_business",
    "transaction_fpds"."tribally_owned_business",
    "transaction_fpds"."veteran_owned_business",
    "transaction_fpds"."service_disabled_veteran_owned_business",
    "transaction_fpds"."woman_owned_business",
    "transaction_fpds"."women_owned_small_business",
    "transaction_fpds"."economically_disadvantaged_women_owned_small_business",
    "transaction_fpds"."joint_venture_women_owned_small_business",
    "transaction_fpds"."joint_venture_economic_disadvantaged_women_owned_small_bus",
    "transaction_fpds"."minority_owned_business",
    "transaction_fpds"."subcontinent_asian_asian_indian_american_owned_business",
    "transaction_fpds"."asian_pacific_american_owned_business",
    "transaction_fpds"."black_american_owned_business",
    "transaction_fpds"."hispanic_american_owned_business",
    "transaction_fpds"."native_american_owned_business",
    "transaction_fpds"."other_minority_owned_business",
    "transaction_fpds"."contracting_officers_determination_of_business_size",
    "transaction_fpds"."contracting_officers_determination_of_business_size_code",
    "transaction_fpds"."emerging_small_business",
    "transaction_fpds"."community_developed_corporation_owned_firm",
    "transaction_fpds"."labor_surplus_area_firm",
    "transaction_fpds"."us_federal_government",
    "transaction_fpds"."federally_funded_research_and_development_corp",
    ...
    "transaction_fpds"."inter_municipal_local_government",
    "transaction_fpds"."local_government_owned",
    "transaction_fpds"."municipality_local_government",
    "transaction_fpds"."school_district_local_government",
    ...
    "transaction_fpds"."corporate_entity_not_tax_exempt",
    "transaction_fpds"."corporate_entity_tax_exempt",
    "transaction_fpds"."partnership_or_limited_liability_partnership",
    "transaction_fpds"."sole_proprietorship",
    "transaction_fpds"."small_agricultural_cooperative",
    "transaction_fpds"."international_organization",
    "transaction_fpds"."us_government_entity",
    "transaction_fpds"."community_development_corporation",
    ...
    "transaction_fpds"."hispanic_servicing_institution",
    "transaction_fpds"."receives_contracts",
    "transaction_fpds"."receives_grants",
    "transaction_fpds"."receives_contracts_and_grants",
    "transaction_fpds"."airport_authority",
    "transaction_fpds"."council_of_governments",
    "transaction_fpds"."housing_authorities_public_tribal",
    ...
    "transaction_fpds"."subchapter_scorporation",
    "transaction_fpds"."limited_liability_corporation",
    ...
    "transaction_fpds"."other_not_for_profit_organization",
    "transaction_fpds"."the_ability_one_program",
    "transaction_fpds"."number_of_employees",
    "transaction_fpds"."annual_revenue",
    "transaction_fpds"."private_university_or_college",
    "transaction_fpds"."state_controlled_institution_of_higher_learning",
    "transaction_fpds"."1862_land_grant_college",
    "transaction_fpds"."1890_land_grant_college",
    "transaction_fpds"."1994_land_grant_college",
    "transaction_fpds"."minority_institution",
    "transaction_fpds"."historically_black_college",
    "transaction_fpds"."tribal_college",
    "transaction_fpds"."alaskan_native_servicing_institution",
    "transaction_fpds"."native_hawaiian_servicing_institution",
    "transaction_fpds"."school_of_forestry",
    "transaction_fpds"."veterinary_college",
    "transaction_fpds"."dot_certified_disadvantage",
    "transaction_fpds"."self_certified_small_disadvantaged_business",
    "transaction_fpds"."small_disadvantaged_business",
    "transaction_fpds"."c8a_program_participant",
    "transaction_fpds"."historically_underutilized_business_zone_hubzone_firm",
    "transaction_fpds"."sba_certified_8a_joint_venture",
    "transaction_fpds"."last_modified_date"
    FROM
