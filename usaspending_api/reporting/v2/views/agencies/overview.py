...
class AgenciesOverview(PaginationMixin, AgencyBase):
    ...
    def get_agency_overview(self) -> list[dict[str, Any]]:
        agency_filters = []
    ...
    def format_results(self, result_list: QuerySet) -> list[dict[str, Any]]:
        agencies = {
    ...
    def format_result(self, result: Any, agencies: dict) -> list[dict[str, Any]]:
        """
