...
def test_delete_fabs_success():
    ...
    mommy.make(Award, id=1, latest_transaction_id=1, place_of_performance_id=1)
    mommy.make(TransactionNormalized, id=1, award_id=1, place_of_performance_id=1)
    ...
    mommy.make(Award, id=2, latest_transaction_id=2, place_of_performance_id=3)
    mommy.make(TransactionNormalized, id=2, award_id=2, place_of_performance_id=3, action_date="2019-01-01")
    mommy.make(TransactionNormalized, id=3, award_id=2, place_of_performance_id=4, action_date="2019-01-02")
    ...
    mommy.make(Award, id=3, latest_transaction_id=4, place_of_performance_id=7)
    mommy.make(TransactionNormalized, id=4, award_id=3, place_of_performance_id=7)
