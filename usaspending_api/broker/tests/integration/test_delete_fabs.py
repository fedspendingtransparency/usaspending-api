...
def test_delete_fabs_success():
    ...
    mommy.make(
        Award, id=1, latest_transaction_id=1, place_of_performance_id=1, generated_unique_award_id="TEST_AWARD_1"
    )
    mommy.make(TransactionNormalized, id=1, award_id=1, place_of_performance_id=1, unique_award_key="TEST_AWARD_1")
    ...
    mommy.make(
        Award, id=2, latest_transaction_id=2, place_of_performance_id=3, generated_unique_award_id="TEST_AWARD_2"
    )
    mommy.make(
    ...
    mommy.make(
        Award, id=3, latest_transaction_id=4, place_of_performance_id=7, generated_unique_award_id="TEST_AWARD_3"
    )
    mommy.make(TransactionNormalized, id=4, award_id=3, place_of_performance_id=7, unique_award_key="TEST_AWARD_3")
