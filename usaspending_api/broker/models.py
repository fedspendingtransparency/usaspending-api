...
class DetachedAwardProcurement(models.Model):
    ...
    federal_action_obligation = models.DecimalField(max_digits=65535, decimal_places=65535, blank=True, null=True)
...
class PublishedAwardFinancialAssistance(models.Model):
    ...
    face_value_loan_guarantee = models.DecimalField(max_digits=65535, decimal_places=65535, blank=True, null=True)
    ...
    non_federal_funding_amount = models.DecimalField(max_digits=65535, decimal_places=65535, blank=True, null=True)
    original_loan_subsidy_cost = models.DecimalField(max_digits=65535, decimal_places=65535, blank=True, null=True)
    period_of_performance_curr = models.TextField(blank=True, null=True)
    period_of_performance_star = models.TextField(blank=True, null=True)
