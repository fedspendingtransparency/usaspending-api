# -*- coding: utf-8 -*-
# Generated by Django 1.10.7 on 2017-09-18 16:36
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('transaction', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, related_name='assistance_data', serialize=False, to='broker.TransactionNormalized')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('transaction', models.OneToOneField(help_text='Non-specific transaction data, fields shared among both assistance and contract transactions', on_delete=django.db.models.deletion.CASCADE, primary_key=True, related_name='contract_data', serialize=False, to='broker.TransactionNormalized')),
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(help_text='The agency which awarded this transaction', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='broker_transactionnormalized_awarding_agency', to='references.Agency'),
        ),
        migrations.AddField(
            model_name='transactionnormalized',
            name='funding_agency',
            field=models.ForeignKey(help_text='The agency which is funding this transaction', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='broker_transactionnormalized_funding_agency', to='references.Agency'),
        ),
        migrations.AddField(
            model_name='transactionnormalized',
