# -*- coding: utf-8 -*-
# Generated by Django 1.10.7 on 2017-08-28 04:49
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('published_award_financial_assistance_id', models.AutoField(primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('created_at', models.DateTimeField(blank=True, null=True)),
                ('updated_at', models.DateTimeField(blank=True, null=True)),
                ('detached_award_procurement_id', models.AutoField(primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            ...
            options={
                'verbose_name': 'historical transaction new',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fiscal_year', models.IntegerField(blank=True, help_text='Fiscal Year calculated based on Action Date', null=True)),
                ('award', models.ForeignKey(help_text='The award which this transaction is contained in', on_delete=django.db.models.deletion.CASCADE, to='awards.Award')),
                ('awarding_agency', models.ForeignKey(help_text='The agency which awarded this transaction', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='broker_transactionnew_awarding_agency', to='references.Agency')),
                ('funding_agency', models.ForeignKey(help_text='The agency which is funding this transaction', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='broker_transactionnew_funding_agency', to='references.Agency')),
                ('place_of_performance', models.ForeignKey(help_text='The location where the work on this transaction was performed', null=True, on_delete=django.db.models.deletion.CASCADE, to='references.Location')),
                ('recipient', models.ForeignKey(help_text='The recipient for this transaction', null=True, on_delete=django.db.models.deletion.CASCADE, to='references.LegalEntity')),
            ],
            options={
