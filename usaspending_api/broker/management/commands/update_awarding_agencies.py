    ...
    def update_awarding_funding_agency(fiscal_year=None, file_type=None, page=1, limit=500000):
        ...
        if file_type == 'D1':
            ...
            transaction_cgac_subtier_map = [
                                               ...
                                               .filter(transaction__fiscal_year=fiscal_year, tranaction__awarding_agency_code__lt=4354).exclude(
                                                       tranaction__awarding_agency_code__in=(112, 190, 1232, 1033, 915, 777, 729, 857, 217, 255, 273, 361, 696, 462, 577, 689, 838, 765, 620, 555, 660, 533, 767, 552))
