...
TRUNCATE awards_old, transaction_normalized_old, legal_entity_old, references_location_old, transaction_fabs_old, transaction_fpds_old, references_legalentityofficers_old CASCADE;
