    ...
    (
        (
            ...
            SELECT
                ...
                MIN(tfn.period_of_performance_star::DATE)::DATE over w AS period_of_performance_start_date,
                MAX(tfn.period_of_performance_curr::DATE)::DATE over w AS period_of_performance_current_end_date,
