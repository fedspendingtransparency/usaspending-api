...
class ListMonthlyDownloadsViewSet(APIView):
    ...
    s3_handler = S3Handler(
        bucket_name=CONFIG.MONTHLY_DOWNLOAD_S3_BUCKET_NAME, redirect_dir=settings.MONTHLY_DOWNLOAD_S3_REDIRECT_DIR
    )
    ...
    def create_download_response_obj(
        self,
        filename: str,
            fiscal_year: int, type_param: str, agency: dict, is_delta: bool = False) -> dict:
