    ...
    "object_class_program_activity": {
        ...
        "federal_account": OrderedDict(
            [
                ...
                ("disaster_emergency_fund_code", "disaster_emergency_fund__code"),
                ("disaster_emergency_fund_name", "disaster_emergency_fund__title"),
                ("obligations_incurred", None),  # Column is annotated in download_annotation_functions.py
                (
                    "obligations_undelivered_orders_unpaid_total",
                    None,
                ),  # Column is annotated in download_annotation_functions.py
                (
                ...
                ("gross_outlay_amount_FYB", None),  # Column is annotated in account_download.py
                (
                    "gross_outlays_undelivered_orders_prepaid_total",
                    None,
                ),  # Column is annotated in download_annotation_functions.py
