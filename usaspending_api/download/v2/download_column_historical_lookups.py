    ...
    "subaward": {
        "d1": OrderedDict(
            [
                ...
                ("prime_award_period_of_performance_potential_end_date", None),  # Annotation is used to create this column
                ...
                ("prime_award_national_interest_action_code", "award__latest_transaction__contract_data__national_interest_action"),
                ("prime_award_national_interest_action", "award__latest_transaction__contract_data__national_interest_desc"),
