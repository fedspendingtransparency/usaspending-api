    ...
    "transaction_search": {
        ...
        "d2": OrderedDict(
            [
                ...
                ("award_amount_basis_code", FABS_TO_TRANSACTION_SEARCH_COL_MAP["award_amount_basis_code"]),
                ("award_amount_basis_name", FABS_TO_TRANSACTION_SEARCH_COL_MAP["award_amount_basis_name"]),
                ("award_recipient_basis_code", FABS_TO_TRANSACTION_SEARCH_COL_MAP["award_recipient_basis_code"]),
                ("award_recipient_basis_name", FABS_TO_TRANSACTION_SEARCH_COL_MAP["award_recipient_basis_name"]),
