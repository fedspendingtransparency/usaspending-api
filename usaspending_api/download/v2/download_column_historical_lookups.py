...
query_paths = {
    ...
    'subaward': {
        'd1': OrderedDict([
            ...
            ('subawardee_duns', 'recipient_unique_id'),
            ('subawardee_name', 'recipient_name'),
            ('subawardee_dba_name', 'dba_name'),
            ('subawardee_parent_duns', 'parent_recipient_unique_id'),
            ('subawardee_parent_name', 'parent_recipient_name'),
            ('subawardee_address_line_1', 'recipient_location_street_address'),
            ('subawardee_city_name', 'recipient_location_city_name'),
            ('subawardee_state_code', 'recipient_location_state_code'),
            ('subawardee_state_name', 'recipient_location_state_name'),
            ('subawardee_zip_4', 'recipient_location_zip4'),
            ('subawardee_congressional_district', 'recipient_location_congressional_code'),
            ('subawardee_country_code', 'recipient_location_country_code'),
            ('subawardee_country_name', 'recipient_location_country_name'),
            ('subawardee_foreign_postal_code', 'recipient_location_foreign_postal_code'),
            ('subaward_primary_place_of_performance_address_line_1', 'pop_street_address'),
            ('subaward_primary_place_of_performance_city_name', 'pop_city_name'),
            ('subaward_primary_place_of_performance_state_code', 'pop_state_code'),
            ('subaward_primary_place_of_performance_state_name', 'pop_state_name'),
            ('subaward_primary_place_of_performance_address_zip_4', 'pop_zip4'),
            ('subaward_primary_place_of_performance_congressional_district', 'pop_congressional_code'),
            ('subaward_primary_place_of_performance_country_code', 'pop_country_code'),
            ('subaward_primary_place_of_performance_country_name', 'pop_country_name'),
            ...
            ('subawardee_business_type_code', 'business_type_code'),
            ('subawardee_business_type_description', 'business_type_description'),
