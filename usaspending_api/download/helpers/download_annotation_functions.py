...
def universal_transaction_matview_annotations():
    annotation_fields = {
        ...
        "disaster_emergency_fund_codes_for_overall_award": Subquery(
        ...
        "outlayed_amount_funded_by_COVID-19_supplementals_for_overall_award": Subquery(
            FinancialAccountsByAwards.objects.filter(
        ...
        "obligated_amount_funded_by_COVID-19_supplementals_for_overall_award": Subquery(
            FinancialAccountsByAwards.objects.filter(
