...
from usaspending_api.common.helpers.orm_helpers import CFDAs, ConcatAll, FiscalYear, StringAggWithDefault
...
def congressional_district_display_name(state_column_name: str, cd_column_name: str) -> Case:
    expression = Case(
        When(
            Q(
...
def transaction_search_annotations(filters: dict, file_type: str = None) -> dict[str, Any]:
    """
    Args:
...
def award_annotations(filters: dict, file_type: str = None) -> dict[str, Any]:
    """
    Args:
        file_type: Either "d1" or "d2". Required because "d1" and "d2"
        sometimes populate the same field with different values
...
def idv_order_annotations(filters: dict, file_type: str = None) -> dict[str, Any]:
    """
    Args:
        file_type: Either "d1" or "d2". Required because "d1" and "d2"
        sometimes populate the same field with different values
...
def idv_transaction_annotations(filters: dict, file_type: str = None) -> dict[str, Any]:
    """
    Args:
        file_type: Either "d1" or "d2". Required because "d1" and "d2"
        sometimes populate the same field with different values
...
def subaward_annotations(filters: dict, file_type: str = None) -> dict[str, Any]:
    """
    Args:
        file_type: Either "d1" or "d2". Required because "d1" and "d2"
        sometimes populate the same field with different values
...
def object_class_program_activity_annotations(filters: dict, file_type: str = None) -> dict[str, Sum]:
    """
    ...
    annotation_fields = {
        ...
        "gross_outlays_undelivered_orders_prepaid_total_FYB": Sum("gross_outlays_undelivered_orders_prepaid_total_fyb"),
        "obligations_delivered_orders_unpaid_total": Sum("obligations_delivered_orders_unpaid_total_cpe"),
        "obligations_delivered_orders_unpaid_total_FYB": Sum("obligations_delivered_orders_unpaid_total_fyb"),
