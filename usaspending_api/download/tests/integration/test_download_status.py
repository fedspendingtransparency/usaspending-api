...
def download_test_data(transactional_db):
    ...
    # Create Awards
    award1 = baker.make("search.AwardSearch", award_id=123, category="idv", generated_unique_award_id="CONT_IDV_NEW")
    award2 = baker.make(
        "search.AwardSearch", award_id=456, category="contracts", generated_unique_award_id="CONT_AWD_NEW"
    )
    award3 = baker.make(
        "search.AwardSearch", award_id=789, category="assistance", generated_unique_award_id="ASST_NON_NEW"
    )
