...
from usaspending_api.awards.models_matviews import ReportingAwardAllDownloadView, UniversalTransactionView, SubawardView
...
VALUE_MAPPINGS = {
    ...
    "awards": {
        "source_type": "award",
        "table": ReportingAwardAllDownloadView,
        "table_name": "award",
