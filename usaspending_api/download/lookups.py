...
VALUE_MAPPINGS = {
    ...
    "awards": {
        ...
        "download_name": "{agency}{agency_is_optional}{type}_PrimeAwardSummaries_{timestamp}",
    ...
    "transactions": {
        ...
        "download_name": "{agency}{agency_is_optional}{type}_PrimeTransactions_{timestamp}",
    ...
    "sub_awards": {
        ...
        "table_name": "subaward",
        "type_name": "Subawards",
        "download_name": "{agency}{agency_is_optional}{type}_Subawards_{timestamp}",
        "contract_data": "award__latest_transaction__contract_data",
        "assistance_data": "award__latest_transaction__assistance_data",
    ...
    "account_balances": {
        ...
        "zipfile_template": "{data_quarters}_{agency}_{level}_AccountBalances",
    ...
    "object_class_program_activity": {
        ...
        "zipfile_template": "{data_quarters}_{agency}_{level}_AccountBreakdownByProgramActivityObjectClass",
        "filter_function": account_download_filter,
    },
    "award_financial": {
        "source_type": "account",
        ...
        "zipfile_template": "{data_quarters}_{agency}_{level}_AccountBreakdownByAward",
        "filter_function": account_download_filter,
    },
    "idv_orders": {
        "source_type": "award",
