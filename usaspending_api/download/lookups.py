...
VALUE_MAPPINGS = {
    ...
    "awards": {
        ...
        "download_name": "{agency}{if_agency}{type}_PrimeAwardSummaries_{timestamp}",
    ...
    "transactions": {
        ...
        "download_name": "{agency}{if_agency}{type}_PrimeTransactions_{timestamp}",
    ...
    "sub_awards": {
        ...
        "table_name": "subaward",
        "type_name": "Subawards",
        "download_name": "{agency}{if_agency}{type}_Subawards_{timestamp}",
        "contract_data": "award__latest_transaction__contract_data",
        "assistance_data": "award__latest_transaction__assistance_data",
    ...
    "account_balances": {
        ...
        "download_name": "FY{fy}Q1{date_range}_{agency}_{level}_AccountBalances_{timestamp}",
        "zipfile_template": "FY{fy}Q1{date_range}_{agency}_{level}_AccountBalances",
    ...
    "object_class_program_activity": {
        ...
        "download_name": "FY{fy}Q1{date_range}_{agency}_{level}_AccountBreakdownByProgramActivityObjectClass_{timestamp}",
        "zipfile_template": "FY{fy}Q1{date_range}_{agency}_{level}_AccountBreakdownByProgramActivityObjectClass",
        "filter_function": account_download_filter,
    },
    "award_financial": {
        "source_type": "account",
        ...
        "download_name": "FY{fy}Q1{date_range}_{agency}_{level}_AccountBreakdownByAward_{timestamp}",
        "zipfile_template": "FY{fy}Q1{date_range}_{agency}_{level}_AccountBreakdownByAward",
        "filter_function": account_download_filter,
    },
    "idv_orders": {
        "source_type": "award",
