...
VALUE_MAPPINGS = {
    ...
    "award_financial": {
        ...
        "download_name": "{data_quarters}_{agency}_{level}_{extra_file_type}_AccountBreakdownByAward_{timestamp}",
        "zipfile_template": "{data_quarters}_{agency}_{level}_{extra_file_type}_AccountBreakdownByAward_{timestamp}",
