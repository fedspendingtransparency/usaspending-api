...
object_class_program_activity_schema = StructType(
    [
        ...
        StructField("ussgl480210_rein_undel_obs_cpe", DecimalType(23, 2)),
        StructField("ussgl497210_down_adj_refun_cpe", DecimalType(23, 2)),
...
def object_class_program_activity_df(spark: SparkSession) -> DataFrame:
    ...
    return (
        ...
        .select(
            ...
            fabpaoc.ussgl480210_rein_undel_obs_cpe,
            fabpaoc.ussgl497210_down_adj_refun_cpe,
