...
class AccountDownloadFilters(BaseModel):
    ...
    @field_validator("fy", "period", "quarter", "agency", "federal_account", mode="before")
    @classmethod
    ...
    @field_validator("budget_function", "budget_subfunction", mode="before")
    @classmethod
    ...
    @field_validator("federal_account")
    @classmethod
