...
urlpatterns = [
    ...
    re_path(
        r"^api/v1/federal_accounts/",
        include("usaspending_api.accounts.urls_federal_account"),
    ),
    ...
    re_path(
        ...
        include("usaspending_api.references.v2.urls_autocomplete"),
    ),
    re_path(
        r"^api/v2/award_spending/",
        include("usaspending_api.awards.v2.urls_award_spending"),
    ),
    re_path(r"^api/v2/awards/", include("usaspending_api.awards.v2.urls_awards")),
    re_path(
        r"^api/v2/budget_authority/",
        include("usaspending_api.accounts.urls_budget_authority"),
    ),
    re_path(
        r"^api/v2/budget_functions/",
        include("usaspending_api.accounts.v2.urls_budget_functions"),
    ),
    ...
    re_path(
        r"^api/v2/federal_accounts/",
        include("usaspending_api.accounts.urls_federal_accounts_v2"),
    ),
    re_path(
        r"^api/v2/federal_obligations/",
        include("usaspending_api.accounts.urls_federal_obligations"),
    ),
    re_path(
        r"^api/v2/financial_balances/",
        include("usaspending_api.accounts.urls_financial_balances"),
    ),
    re_path(
        r"^api/v2/financial_spending/",
        include("usaspending_api.accounts.urls_financial_spending"),
    ),
