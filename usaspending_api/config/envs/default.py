...
class DefaultConfig(BaseSettings):
    ...
    def build_postgres_dsn(
        ...
        """A builder method that builds a PostgresDsn. If ``postgres_url` is provided, it will use that.
    ...
    def _POSTGRES_DSN_factory(cls, v, values, field: ModelField):
        def factory_func() -> PostgresDsn:
            ...
            If ``POSTGRES_URL`` is provided e.g. as an env var, it will be used. Otherwise this URL is
