...
Expected CLI:
    ...
    $ python3 usaspending_api/database_scripts/job_archive/backfill_fabpaoc_defc_as_text_field.py
...
WHERE   financial_accounts_by_program_activity_object_class_id BETWEEN {minid} AND {maxid}
""",
]


GET_MIN_MAX_SQL = "SELECT MIN(financial_accounts_by_program_activity_object_class_id), MAX(financial_accounts_by_program_activity_object_class_id) FROM financial_accounts_by_program_activity_object_class"
