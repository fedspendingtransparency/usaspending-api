...
CREATE UNIQUE INDEX idx_recipient_profile_uniq ON recipient_profile USING BTREE(recipient_hash, recipient_level);

-- Obligation for past 12 months
UPDATE recipient_profile AS rpv SET last_12_months =
...
UPDATE recipient_profile AS rpv SET all_fiscal_years =
...
UPDATE recipient_profile AS rpv SET recipient_affiliations =
