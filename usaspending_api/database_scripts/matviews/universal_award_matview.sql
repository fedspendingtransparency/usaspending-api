...
ALTER INDEX IF EXISTS idx_27457675__id RENAME TO idx_27457675__id_old;
ALTER INDEX IF EXISTS idx_27457675__category RENAME TO idx_27457675__category_old;
ALTER INDEX IF EXISTS idx_27457675__type RENAME TO idx_27457675__type_old;
ALTER INDEX IF EXISTS idx_27457675__ordered_type RENAME TO idx_27457675__ordered_type_old;
ALTER INDEX IF EXISTS idx_27457675__ordered_type_desc RENAME TO idx_27457675__ordered_type_desc_old;
ALTER INDEX IF EXISTS idx_27457675__ordered_fain RENAME TO idx_27457675__ordered_fain_old;
ALTER INDEX IF EXISTS idx_27457675__ordered_piid RENAME TO idx_27457675__ordered_piid_old;
ALTER INDEX IF EXISTS idx_27457675__total_obligation RENAME TO idx_27457675__total_obligation_old;
ALTER INDEX IF EXISTS idx_27457675__ordered_total_obligation RENAME TO idx_27457675__ordered_total_obligation_old;
ALTER INDEX IF EXISTS idx_27457675__total_obl_bin RENAME TO idx_27457675__total_obl_bin_old;
ALTER INDEX IF EXISTS idx_27457675__period_of_performance_start_date RENAME TO idx_27457675__period_of_performance_start_date_old;
ALTER INDEX IF EXISTS idx_27457675__period_of_performance_current_end_date RENAME TO idx_27457675__period_of_performance_current_end_date_old;
ALTER INDEX IF EXISTS idx_27457675__gin_recipient_name RENAME TO idx_27457675__gin_recipient_name_old;
ALTER INDEX IF EXISTS idx_27457675__recipient_name RENAME TO idx_27457675__recipient_name_old;
ALTER INDEX IF EXISTS idx_27457675__recipient_unique_id RENAME TO idx_27457675__recipient_unique_id_old;
ALTER INDEX IF EXISTS idx_27457675__parent_recipient_unique_id RENAME TO idx_27457675__parent_recipient_unique_id_old;
ALTER INDEX IF EXISTS idx_27457675__action_date RENAME TO idx_27457675__action_date_old;
ALTER INDEX IF EXISTS idx_27457675__fiscal_year RENAME TO idx_27457675__fiscal_year_old;
ALTER INDEX IF EXISTS idx_27457675__awarding_agency_id RENAME TO idx_27457675__awarding_agency_id_old;
ALTER INDEX IF EXISTS idx_27457675__funding_agency_id RENAME TO idx_27457675__funding_agency_id_old;
ALTER INDEX IF EXISTS idx_27457675__ordered_awarding_toptier_agency_name RENAME TO idx_27457675__ordered_awarding_toptier_agency_name_old;
ALTER INDEX IF EXISTS idx_27457675__ordered_awarding_subtier_agency_name RENAME TO idx_27457675__ordered_awarding_subtier_agency_name_old;
ALTER INDEX IF EXISTS idx_27457675__awarding_toptier_agency_name RENAME TO idx_27457675__awarding_toptier_agency_name_old;
ALTER INDEX IF EXISTS idx_27457675__awarding_subtier_agency_name RENAME TO idx_27457675__awarding_subtier_agency_name_old;
ALTER INDEX IF EXISTS idx_27457675__funding_toptier_agency_name RENAME TO idx_27457675__funding_toptier_agency_name_old;
ALTER INDEX IF EXISTS idx_27457675__funding_subtier_agency_name RENAME TO idx_27457675__funding_subtier_agency_name_old;
ALTER INDEX IF EXISTS idx_27457675__recipient_location_country_code RENAME TO idx_27457675__recipient_location_country_code_old;
ALTER INDEX IF EXISTS idx_27457675__recipient_location_state_code RENAME TO idx_27457675__recipient_location_state_code_old;
ALTER INDEX IF EXISTS idx_27457675__recipient_location_county_code RENAME TO idx_27457675__recipient_location_county_code_old;
ALTER INDEX IF EXISTS idx_27457675__recipient_location_zip5 RENAME TO idx_27457675__recipient_location_zip5_old;
ALTER INDEX IF EXISTS idx_27457675__recipient_location_cong_code RENAME TO idx_27457675__recipient_location_cong_code_old;
ALTER INDEX IF EXISTS idx_27457675__pop_country_code RENAME TO idx_27457675__pop_country_code_old;
ALTER INDEX IF EXISTS idx_27457675__pop_state_code RENAME TO idx_27457675__pop_state_code_old;
ALTER INDEX IF EXISTS idx_27457675__pop_county_code RENAME TO idx_27457675__pop_county_code_old;
ALTER INDEX IF EXISTS idx_27457675__pop_zip5 RENAME TO idx_27457675__pop_zip5_old;
ALTER INDEX IF EXISTS idx_27457675__pop_congressional_code RENAME TO idx_27457675__pop_congressional_code_old;
ALTER INDEX IF EXISTS idx_27457675__cfda_number RENAME TO idx_27457675__cfda_number_old;
ALTER INDEX IF EXISTS idx_27457675__pulled_from RENAME TO idx_27457675__pulled_from_old;
ALTER INDEX IF EXISTS idx_27457675__type_of_contract_pricing RENAME TO idx_27457675__type_of_contract_pricing_old;
ALTER INDEX IF EXISTS idx_27457675__extent_competed RENAME TO idx_27457675__extent_competed_old;
ALTER INDEX IF EXISTS idx_27457675__type_set_aside RENAME TO idx_27457675__type_set_aside_old;
ALTER INDEX IF EXISTS idx_27457675__product_or_service_code RENAME TO idx_27457675__product_or_service_code_old;
ALTER INDEX IF EXISTS idx_27457675__gin_product_or_service_description RENAME TO idx_27457675__gin_product_or_service_description_old;
ALTER INDEX IF EXISTS idx_27457675__naics RENAME TO idx_27457675__naics_old;
ALTER INDEX IF EXISTS idx_27457675__gin_naics_code RENAME TO idx_27457675__gin_naics_code_old;
ALTER INDEX IF EXISTS idx_27457675__gin_naics_description RENAME TO idx_27457675__gin_naics_description_old;
ALTER INDEX IF EXISTS idx_27457675__gin_business_categories RENAME TO idx_27457675__gin_business_categories_old;
ALTER INDEX IF EXISTS idx_27457675__gin_keyword_string RENAME TO idx_27457675__gin_keyword_string_old;
ALTER INDEX IF EXISTS idx_27457675__gin_award_id_string RENAME TO idx_27457675__gin_award_id_string_old;
ALTER INDEX IF EXISTS idx_27457675__tuned_type_and_idv RENAME TO idx_27457675__tuned_type_and_idv_old;

ALTER MATERIALIZED VIEW universal_award_matview_temp RENAME TO universal_award_matview;
ALTER INDEX idx_27457675__id_temp RENAME TO idx_27457675__id;
ALTER INDEX idx_27457675__category_temp RENAME TO idx_27457675__category;
ALTER INDEX idx_27457675__type_temp RENAME TO idx_27457675__type;
ALTER INDEX idx_27457675__ordered_type_temp RENAME TO idx_27457675__ordered_type;
ALTER INDEX idx_27457675__ordered_type_desc_temp RENAME TO idx_27457675__ordered_type_desc;
ALTER INDEX idx_27457675__ordered_fain_temp RENAME TO idx_27457675__ordered_fain;
ALTER INDEX idx_27457675__ordered_piid_temp RENAME TO idx_27457675__ordered_piid;
ALTER INDEX idx_27457675__total_obligation_temp RENAME TO idx_27457675__total_obligation;
ALTER INDEX idx_27457675__ordered_total_obligation_temp RENAME TO idx_27457675__ordered_total_obligation;
ALTER INDEX idx_27457675__total_obl_bin_temp RENAME TO idx_27457675__total_obl_bin;
ALTER INDEX idx_27457675__period_of_performance_start_date_temp RENAME TO idx_27457675__period_of_performance_start_date;
ALTER INDEX idx_27457675__period_of_performance_current_end_date_temp RENAME TO idx_27457675__period_of_performance_current_end_date;
ALTER INDEX idx_27457675__gin_recipient_name_temp RENAME TO idx_27457675__gin_recipient_name;
ALTER INDEX idx_27457675__recipient_name_temp RENAME TO idx_27457675__recipient_name;
ALTER INDEX idx_27457675__recipient_unique_id_temp RENAME TO idx_27457675__recipient_unique_id;
ALTER INDEX idx_27457675__parent_recipient_unique_id_temp RENAME TO idx_27457675__parent_recipient_unique_id;
ALTER INDEX idx_27457675__action_date_temp RENAME TO idx_27457675__action_date;
ALTER INDEX idx_27457675__fiscal_year_temp RENAME TO idx_27457675__fiscal_year;
ALTER INDEX idx_27457675__awarding_agency_id_temp RENAME TO idx_27457675__awarding_agency_id;
ALTER INDEX idx_27457675__funding_agency_id_temp RENAME TO idx_27457675__funding_agency_id;
ALTER INDEX idx_27457675__ordered_awarding_toptier_agency_name_temp RENAME TO idx_27457675__ordered_awarding_toptier_agency_name;
ALTER INDEX idx_27457675__ordered_awarding_subtier_agency_name_temp RENAME TO idx_27457675__ordered_awarding_subtier_agency_name;
ALTER INDEX idx_27457675__awarding_toptier_agency_name_temp RENAME TO idx_27457675__awarding_toptier_agency_name;
ALTER INDEX idx_27457675__awarding_subtier_agency_name_temp RENAME TO idx_27457675__awarding_subtier_agency_name;
ALTER INDEX idx_27457675__funding_toptier_agency_name_temp RENAME TO idx_27457675__funding_toptier_agency_name;
ALTER INDEX idx_27457675__funding_subtier_agency_name_temp RENAME TO idx_27457675__funding_subtier_agency_name;
ALTER INDEX idx_27457675__recipient_location_country_code_temp RENAME TO idx_27457675__recipient_location_country_code;
ALTER INDEX idx_27457675__recipient_location_state_code_temp RENAME TO idx_27457675__recipient_location_state_code;
ALTER INDEX idx_27457675__recipient_location_county_code_temp RENAME TO idx_27457675__recipient_location_county_code;
ALTER INDEX idx_27457675__recipient_location_zip5_temp RENAME TO idx_27457675__recipient_location_zip5;
ALTER INDEX idx_27457675__recipient_location_cong_code_temp RENAME TO idx_27457675__recipient_location_cong_code;
ALTER INDEX idx_27457675__pop_country_code_temp RENAME TO idx_27457675__pop_country_code;
ALTER INDEX idx_27457675__pop_state_code_temp RENAME TO idx_27457675__pop_state_code;
ALTER INDEX idx_27457675__pop_county_code_temp RENAME TO idx_27457675__pop_county_code;
ALTER INDEX idx_27457675__pop_zip5_temp RENAME TO idx_27457675__pop_zip5;
ALTER INDEX idx_27457675__pop_congressional_code_temp RENAME TO idx_27457675__pop_congressional_code;
ALTER INDEX idx_27457675__cfda_number_temp RENAME TO idx_27457675__cfda_number;
ALTER INDEX idx_27457675__pulled_from_temp RENAME TO idx_27457675__pulled_from;
ALTER INDEX idx_27457675__type_of_contract_pricing_temp RENAME TO idx_27457675__type_of_contract_pricing;
ALTER INDEX idx_27457675__extent_competed_temp RENAME TO idx_27457675__extent_competed;
ALTER INDEX idx_27457675__type_set_aside_temp RENAME TO idx_27457675__type_set_aside;
ALTER INDEX idx_27457675__product_or_service_code_temp RENAME TO idx_27457675__product_or_service_code;
ALTER INDEX idx_27457675__gin_product_or_service_description_temp RENAME TO idx_27457675__gin_product_or_service_description;
ALTER INDEX idx_27457675__naics_temp RENAME TO idx_27457675__naics;
ALTER INDEX idx_27457675__gin_naics_code_temp RENAME TO idx_27457675__gin_naics_code;
ALTER INDEX idx_27457675__gin_naics_description_temp RENAME TO idx_27457675__gin_naics_description;
ALTER INDEX idx_27457675__gin_business_categories_temp RENAME TO idx_27457675__gin_business_categories;
ALTER INDEX idx_27457675__gin_keyword_string_temp RENAME TO idx_27457675__gin_keyword_string;
ALTER INDEX idx_27457675__gin_award_id_string_temp RENAME TO idx_27457675__gin_award_id_string;
ALTER INDEX idx_27457675__tuned_type_and_idv_temp RENAME TO idx_27457675__tuned_type_and_idv;
