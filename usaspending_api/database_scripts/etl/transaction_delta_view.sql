...
SELECT
  ...
  "action_date",
  "fiscal_action_date",
  TO_CHAR(last_modified_date, 'yyyy-MM-dd HH24:mm:ss') AS last_modified_date,
  "fiscal_year",
  "award_certified_date",
  "award_fiscal_year",
  "award_date_signed",
  TO_CHAR(update_date, 'yyyy-MM-dd HH24:mm:ss') AS update_date,
  "award_update_date",
  TO_CHAR(etl_update_date, 'yyyy-MM-dd HH24:mm:ss') AS etl_update_date,
