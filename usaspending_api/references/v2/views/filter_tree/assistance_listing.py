...
class AssistanceListingViewSet(PaginationMixin, APIView):
    ...
    def _business_logic(self, cfda_code: int | None, cfda_filter: str | None) -> QuerySet:
        ...
        if cfda_code is None and cfda_filter:
            ...
            results = qs.annotate(**annotations).values(**annotations).order_by(*self.pagination.robust_order_by_fields)
            return results
