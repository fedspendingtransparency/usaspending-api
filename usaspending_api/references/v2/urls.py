...
from usaspending_api.references.v2.views import agency, toptier_agencies, federal_accounts
...
urlpatterns = [
    ...
    url(r'^federal_accounts/$', federal_accounts.FederalAccountsViewSet.as_view())
]
