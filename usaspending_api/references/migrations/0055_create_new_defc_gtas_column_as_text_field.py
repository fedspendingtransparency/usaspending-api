...
def copy_def_code(apps, _):
    ...
    """
    DisasterEmergencyFundCode = apps.get_model(
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            field=models.CharField(
                max_length=2, primary_key=True, serialize=False, db_column="code_old"
            ),
        ),
        migrations.AddField(
            model_name="disasteremergencyfundcode",
        ...
        migrations.AddField(
            ...
            field=models.TextField(
                null=True, db_column="disaster_emergency_fund_code_temp"
            ),
        ),
    ]
