    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "hash",
                    models.TextField(unique=True, verbose_name="Hash of JSON Filter"),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "recipient_name",
                    models.TextField(
                        blank=True, null=True, verbose_name="Recipient Name"
                    ),
                ),
                (
                ...
                (
                    ...
                    models.TextField(
                        blank=True, null=True, verbose_name="Parent Recipient Name"
                    ),
                ),
                (
                ...
                (
                    "airport_authority",
                    models.BooleanField(
                        null=True, default=False, verbose_name="Airport Authority"
                    ),
                ),
                (
                ...
                (
                    ...
                    models.TextField(
                        default="NONE", verbose_name="Transaction Unique ID"
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.TextField(
                        blank=True, null=True, verbose_name="Location Country Code"
                    ),
                ),
                (
                    "country_name",
                ...
                (
                    "state_code",
                    models.TextField(blank=True, null=True, verbose_name="State Code"),
                ),
                (
                    "state_name",
                ...
                (
                    "state_description",
                    models.TextField(
                        blank=True, null=True, verbose_name="State Description"
                    ),
                ),
                (
                    "city_name",
                    models.TextField(blank=True, null=True, verbose_name="City Name"),
                ),
                ...
                (
                    ...
                    models.TextField(
                        blank=True,
                        null=True,
                        verbose_name="Congressional District Code",
                    ),
                ),
                (
                    "performance_code",
                    models.TextField(
                        blank=True,
                        null=True,
                        verbose_name="Primary Place Of Performance Location Code",
                    ),
                ),
                ...
                (
                    ...
                    models.BooleanField(
                        default=False,
                        verbose_name="Location used as place of performance",
                    ),
                ),
                (
                    "recipient_flag",
                    models.BooleanField(
                        default=False,
                        verbose_name="Location used as recipient location",
                    ),
                ),
                ("is_fpds", models.BooleanField(default=False, verbose_name="Is FPDS")),
                (
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.TextField(
                        choices=[
                            ...
                            ("Acquisition of assets", "30"),
                            ("Grants and fixed charges", "40"),
                            ("Other", "90"),
                        ]
                    ),
                ),
                ...
                (
                    ...
                    models.TextField(
                        blank=True,
                        choices=[(None, None), ("D", "Direct"), ("R", "Reimbursable")],
                        db_index=True,
                        null=True,
                    ),
                ),
                (
                    ...
                    models.TextField(
                        blank=True,
                        choices=[(None, None), ("Direct", "D"), ("Reimbursable", "R")],
                        null=True,
                    ),
                ),
                ("create_date", models.DateTimeField(auto_now_add=True, null=True)),
        ...
        migrations.AlterIndexTogether(
            name="legalentity",
            index_together=set(
                [("recipient_unique_id", "recipient_name", "update_date")]
            ),
        ),
        migrations.RunSQL(
            sql=[
