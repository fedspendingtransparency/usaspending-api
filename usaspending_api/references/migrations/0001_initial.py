    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('limited_liability_corporation', models.NullBooleanField(default=False)),
                ('sole_proprietorship', models.NullBooleanField(default=False)),
                ('partnership_or_limited_liability_partnership', models.NullBooleanField(default=False)),
                ('subchapter_scorporation', models.NullBooleanField(default=False)),
                ('foundation', models.NullBooleanField(default=False)),
                ('for_profit_organization', models.NullBooleanField(default=False)),
                ('nonprofit_organization', models.NullBooleanField(default=False)),
                ('corporate_entity_tax_exempt', models.NullBooleanField(default=False)),
                ('corporate_entity_not_tax_exempt', models.NullBooleanField(default=False)),
                ('other_not_for_profit_organization', models.NullBooleanField(default=False)),
                ('sam_exception', models.TextField(blank=True, null=True)),
                ('city_local_government', models.NullBooleanField(default=False)),
                ('county_local_government', models.NullBooleanField(default=False)),
                ('inter_municipal_local_government', models.NullBooleanField(default=False)),
                ('local_government_owned', models.NullBooleanField(default=False)),
                ('municipality_local_government', models.NullBooleanField(default=False)),
                ('school_district_local_government', models.NullBooleanField(default=False)),
                ('township_local_government', models.NullBooleanField(default=False)),
                ('us_state_government', models.NullBooleanField(default=False)),
                ('us_federal_government', models.NullBooleanField(default=False)),
                ('federal_agency', models.NullBooleanField(default=False)),
                ('federally_funded_research_and_development_corp', models.NullBooleanField(default=False)),
                ('us_tribal_government', models.NullBooleanField(default=False)),
                ('foreign_government', models.NullBooleanField(default=False)),
                ('community_developed_corporation_owned_firm', models.NullBooleanField(default=False)),
                ('labor_surplus_area_firm', models.NullBooleanField(default=False)),
                ('small_agricultural_cooperative', models.NullBooleanField(default=False)),
                ('international_organization', models.NullBooleanField(default=False)),
                ('us_government_entity', models.NullBooleanField(default=False)),
                ('emerging_small_business', models.NullBooleanField(default=False)),
                ('c8a_program_participant', models.NullBooleanField(db_column='8a_program_participant', default=False, max_length=1, verbose_name='8a Program Participant')),
                ('sba_certified_8a_joint_venture', models.NullBooleanField(default=False)),
                ('dot_certified_disadvantage', models.NullBooleanField(default=False)),
                ('self_certified_small_disadvantaged_business', models.NullBooleanField(default=False)),
                ('historically_underutilized_business_zone', models.NullBooleanField(default=False)),
                ('small_disadvantaged_business', models.NullBooleanField(default=False)),
                ('the_ability_one_program', models.NullBooleanField(default=False)),
                ('historically_black_college', models.NullBooleanField(default=False)),
                ('c1862_land_grant_college', models.NullBooleanField(db_column='1862_land_grant_college', default=False, max_length=1, verbose_name='1862 Land Grant College')),
                ('c1890_land_grant_college', models.NullBooleanField(db_column='1890_land_grant_college', default=False, max_length=1, verbose_name='1890 Land Grant College')),
                ('c1994_land_grant_college', models.NullBooleanField(db_column='1994_land_grant_college', default=False, max_length=1, verbose_name='1894 Land Grant College')),
                ('minority_institution', models.NullBooleanField(default=False)),
                ('private_university_or_college', models.NullBooleanField(default=False)),
                ('school_of_forestry', models.NullBooleanField(default=False)),
                ('state_controlled_institution_of_higher_learning', models.NullBooleanField(default=False)),
                ('tribal_college', models.NullBooleanField(default=False)),
                ('veterinary_college', models.NullBooleanField(default=False)),
                ('educational_institution', models.NullBooleanField(default=False)),
                ('alaskan_native_servicing_institution', models.NullBooleanField(default=False, verbose_name='Alaskan Native Owned Servicing Institution')),
                ('community_development_corporation', models.NullBooleanField(default=False)),
                ('native_hawaiian_servicing_institution', models.NullBooleanField(default=False)),
                ('domestic_shelter', models.NullBooleanField(default=False)),
                ('manufacturer_of_goods', models.NullBooleanField(default=False)),
                ('hospital_flag', models.NullBooleanField(default=False)),
                ('veterinary_hospital', models.NullBooleanField(default=False)),
                ('hispanic_servicing_institution', models.NullBooleanField(default=False)),
                ('woman_owned_business', models.NullBooleanField(default=False)),
                ('minority_owned_business', models.NullBooleanField(default=False)),
                ('women_owned_small_business', models.NullBooleanField(default=False)),
                ('economically_disadvantaged_women_owned_small_business', models.NullBooleanField(default=False)),
                ('joint_venture_women_owned_small_business', models.NullBooleanField(default=False)),
                ('joint_venture_economic_disadvantaged_women_owned_small_bus', models.NullBooleanField(default=False)),
                ('veteran_owned_business', models.NullBooleanField(default=False)),
                ('service_disabled_veteran_owned_business', models.NullBooleanField(default=False)),
                ('contracts', models.NullBooleanField(default=False)),
                ('grants', models.NullBooleanField(default=False)),
                ('receives_contracts_and_grants', models.NullBooleanField(default=False)),
                ('airport_authority', models.NullBooleanField(default=False, verbose_name='Airport Authority')),
                ('council_of_governments', models.NullBooleanField(default=False)),
                ('housing_authorities_public_tribal', models.NullBooleanField(default=False)),
                ('interstate_entity', models.NullBooleanField(default=False)),
                ('planning_commission', models.NullBooleanField(default=False)),
                ('port_authority', models.NullBooleanField(default=False)),
                ('transit_authority', models.NullBooleanField(default=False)),
                ('foreign_owned_and_located', models.NullBooleanField(default=False)),
                ('american_indian_owned_business', models.NullBooleanField(default=False, verbose_name='American Indian Owned Business')),
                ('alaskan_native_owned_corporation_or_firm', models.NullBooleanField(default=False, verbose_name='Alaskan Native Owned Corporation or Firm')),
                ('indian_tribe_federally_recognized', models.NullBooleanField(default=False)),
                ('native_hawaiian_owned_business', models.NullBooleanField(default=False)),
                ('tribally_owned_business', models.NullBooleanField(default=False)),
                ('asian_pacific_american_owned_business', models.NullBooleanField(default=False, verbose_name='Asian Pacific American Owned business')),
                ('black_american_owned_business', models.NullBooleanField(default=False)),
                ('hispanic_american_owned_business', models.NullBooleanField(default=False)),
                ('native_american_owned_business', models.NullBooleanField(default=False)),
                ('subcontinent_asian_asian_indian_american_owned_business', models.NullBooleanField(default=False)),
                ('other_minority_owned_business', models.NullBooleanField(default=False)),
                ('us_local_government', models.NullBooleanField(default=False)),
