...
def test_remove_empty_federal_accounts():
    ...
    """
    mommy.make(FederalAccount, pk=1, agency_identifier="ab1", main_account_code="0987")
    mommy.make(FederalAccount, pk=2, agency_identifier="ab2", main_account_code="0987")
    mommy.make(FederalAccount, pk=4, agency_identifier="ab4", main_account_code="0987")
    mommy.make(FederalAccount, pk=5, agency_identifier="ab5", main_account_code="0987")
    mommy.make(FederalAccount, pk=6, agency_identifier="ab6", main_account_code="0987")

    mommy.make(TreasuryAppropriationAccount, pk=1, agency_id="ab1", main_account_code="0987", federal_account_id=1)
    mommy.make(TreasuryAppropriationAccount, pk=2, agency_id="ab2", main_account_code="0987")
...
def test_link_treasury_accounts_to_federal_accounts():
    ...
    mommy.make(TreasuryAppropriationAccount, pk=1, agency_id="ab1", main_account_code="0987", federal_account_id=1)
    mommy.make(TreasuryAppropriationAccount, pk=2, agency_id="ab2", main_account_code="0987")
    mommy.make(TreasuryAppropriationAccount, pk=3, agency_id="ab3", main_account_code="0987")
    mommy.make(TreasuryAppropriationAccount, pk=4, agency_id="ab4", main_account_code="0987", federal_account_id=1)
    mommy.make(TreasuryAppropriationAccount, pk=5, agency_id="ab5", main_account_code="0987", federal_account_id=1)
