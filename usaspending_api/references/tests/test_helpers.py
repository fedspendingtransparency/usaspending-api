...
def load_agency_data(db):
    ...
    mommy.make("references.FREC", agency_name="frec_400", frec_code="400")
    mommy.make("references.FREC", agency_name="frec_401", frec_code="401")
    mommy.make("references.FREC", agency_name="frec_402", frec_code="402")
    mommy.make("references.FREC", agency_name="frec_403", frec_code="403")
    mommy.make("references.FREC", agency_name="frec_404", frec_code="404")
    mommy.make("references.FREC", agency_name="frec_4100", frec_code="4100")
    mommy.make("references.FREC", agency_name="frec_4200", frec_code="4200")
    mommy.make("references.FREC", agency_name="frec_4300", frec_code="4300")
    mommy.make("references.FREC", agency_name="frec_4400", frec_code="4400")
    mommy.make("references.FREC", agency_name="frec_4500", frec_code="4500")
    mommy.make("references.FREC", agency_name="frec_4600", frec_code="4600")
