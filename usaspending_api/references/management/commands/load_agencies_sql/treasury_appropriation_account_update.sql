...
from
    ...
    left outer join toptier_agency as ata on ata.toptier_code = taa.allocation_transfer_agency_id
    left outer join toptier_agency as aid_cgac on aid_cgac.toptier_code = taa.agency_id
    left outer join toptier_agency as aid_frec on aid_frec.toptier_code = taa.fr_entity_code
where
