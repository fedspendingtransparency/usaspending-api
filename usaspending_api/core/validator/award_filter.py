...
AWARD_FILTER = [
    ...
    {'name': 'award_type_codes', 'type': 'array', 'array_type': 'enum', 'enum_values': award_type_mapping.keys()},
    ...
    {'name': 'time_period', 'type': 'array', 'array_type': 'object', 'min': 1, 'object_keys': {
        'start_date': {'type': 'date', 'optional': False},
        'end_date': {'type': 'date', 'optional': False}
    }},
    {'name': 'award_amounts', 'type': 'array', 'array_type': 'object', 'min': 1, 'object_keys': {
        'lower_bound': {'type': 'float', 'optional': True},
        'upper_bound': {'type': 'float', 'optional': True}
    }},
    {'name': 'agencies', 'type': 'array', 'array_type': 'object', 'min': 1, 'object_keys': {
    ...
    {'name': 'recipient_locations', 'type': 'array', 'array_type': 'object', 'min': 1, 'object_keys': {
    ...
    {'name': 'place_of_performance_locations', 'type': 'array', 'array_type': 'object', 'min': 1, 'object_keys': {
        'country': {'type': 'text', 'text_type': 'search', 'optional': False},
        'state': {'type': 'text', 'text_type': 'search', 'optional': True},
        'zip': {'type': 'text', 'text_type': 'search', 'optional': True},
        'district': {'type': 'text', 'text_type': 'search', 'optional': True},
