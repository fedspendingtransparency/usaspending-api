...
from usaspending_api.recipient.v2.views.states import (
    StateMetaDataViewSet,
    StateAwardBreakdownViewSet,
    ListStates,
)
from usaspending_api.recipient.v2.views.recipients import (
    RecipientOverViewDuns,
    RecipientOverView,
)
from usaspending_api.recipient.v2.views.recipients import ChildRecipients
from usaspending_api.recipient.v2.views.list_recipients import (
    ListRecipients,
    ListRecipientsByDuns,
    RecipientCount,
)
...
urlpatterns = [
    ...
    re_path(
        r"^children/(?P<duns_or_uei>(?:[0-9]{9}|[0-9a-zA-Z]{12}))/$",
        ChildRecipients.as_view(),
    ),
