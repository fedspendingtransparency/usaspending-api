...
SELECT
  DISTINCT ON (ultimate_parent_unique_ide, ultimate_parent_uei, ultimate_parent_legal_enti)
  MD5(UPPER(
...
ORDER BY ultimate_parent_unique_ide, ultimate_parent_uei, ultimate_parent_legal_enti, update_date DESC
