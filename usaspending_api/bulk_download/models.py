...
class BulkJobStatus(models.Model):
    bulk_job_status_id = models.AutoField(primary_key=True)
...
class BulkDownloadJob(models.Model):
    ...
    job_status = models.ForeignKey(BulkJobStatus, models.DO_NOTHING, null=False)
