...
DEBUG = True  # os.environ.get("DJANGO_DEBUG", "").lower() in ["true", "1", "yes"]
...
# TODO: Remove and update CONFIG.AWS_REGION use use ENV approach; update usages to use CONFIG.AWS_REGION
...
def _configure_database_connection(environment_variable: str, test_options: dict | None = None) -> dict:
    """
