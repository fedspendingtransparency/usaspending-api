...
DELETED_TRANSACTION_JOURNAL_S3_BUCKET = FPDS_BUCKET_NAME or DELETED_TRANSACTIONS_S3_BUCKET_NAME
if not DELETED_TRANSACTION_JOURNAL_S3_BUCKET:
    DELETED_TRANSACTION_JOURNAL_S3_BUCKET = os.environ.get("DELETED_TRANSACTION_JOURNAL_S3_BUCKET")
