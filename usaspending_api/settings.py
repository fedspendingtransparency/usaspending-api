...
IS_LOCAL = not os.getenv('DOWNLOAD_TO_S3')
...
TERSE_TO_LONG_LABELS = {
    ...
    "responsible_agency_id": "agency_id",
    "beginning_period_of_availa": "beginning_period_of_availability",
    "ending_period_of_availabil": "ending_period_of_availability",
    "availability_type_code": "availability_type_code",
    "main_account_code": "main_account_code",
    "sub_account_code": "sub_account_code",
    "budget_authority_unobligat_fyb": "budget_authority_unobligated_balance_brought_forward_fyb",
    "adjustments_to_unobligated_cpe": "adjustments_to_unobligated_balance_brought_forward_cpe",
    "budget_authority_appropria_cpe": "budget_authority_appropriated_amount_cpe",
    "borrowing_authority_amount_cpe": "borrowing_authority_amount_total_cpe",
    "contract_authority_amount_cpe": "contract_authority_amount_total_cpe",
    "spending_authority_from_of_cpe": "spending_authority_from_offsetting_collections_amount_cpe",
    "other_budgetary_resources_cpe": "other_budgetary_resources_amount_cpe",
    "budget_authority_available_cpe": "budget_authority_available_amount_total_cpe",
    "gross_outlay_amount_by_tas_cpe": "gross_outlay_amount_by_tas_cpe",
    "obligations_incurred_total_cpe": "obligations_incurred_total_by_tas_cpe",
    "deobligations_recoveries_r_cpe": "deobligations_recoveries_refunds_by_tas_cpe",
    "unobligated_balance_cpe": "unobligated_balance_cpe",
    "status_of_budgetary_resour_cpe": "status_of_budgetary_resources_total_cpe",
    "piid": "piid",
    "awarding_sub_tier_agency_c": "awarding_sub_tier_agency_code",
    "awarding_sub_tier_agency_n": "awarding_sub_tier_agency_name",
    ...
    "legal_entity_city_name": "recipient_city_name",
    "legal_entity_state_description": "recipient_state_description",
    "legal_entity_zip4": "recipient_zip4",
    "legal_entity_congressional": "recipient_congressional_district",
    "legal_entity_address_line1": "recipient_address_line1",
    "legal_entity_address_line2": "recipient_address_line2",
    "legal_entity_address_line3": "recipient_address_line3",
    "legal_entity_country_code": "recipient_country_code",
    "legal_entity_country_name": "recipient_country_name",
    ...
    "period_of_perf_potential_e": "period_of_performance_potential_end_date",
    ...
    "funding_office_name": "funding_agency_office_name",
    ...
    "place_of_performance_locat": "primary_place_of_performance_location_code",
    "place_of_performance_state": "primary_place_of_performance_state_code",
    "place_of_perform_country_c": "primary_place_of_performance_country_code",
    "idv_type": "idv_type",
    "vendor_doing_as_business_n": "vendor_doing_as_business_name",
    "vendor_phone_number": "vendor_phone_number",
    "vendor_fax_number": "vendor_fax_number",
    "multiple_or_single_award_i": "multiple_or_single_award_idv",
    ...
    "contingency_humanitarian_o": "contingency_humanitarian_or_peacekeeping_operation",
    "contract_bundling": "contract_bundling",
    "contract_financing": "contract_financing",
    "contracting_officers_deter": "contracting_officers_determination_of_business_size",
    "cost_accounting_standards": "cost_accounting_standards",
    "cost_or_pricing_data": "cost_or_pricing_data",
    "country_of_product_or_serv": "country_of_product_or_service_origin",
    ...
    "performance_based_service": "performance_based_service_acquisition",
    "place_of_manufacture": "place_of_manufacture",
    "price_evaluation_adjustmen": "price_evaluation_adjustment_preference_percent_difference",
    "product_or_service_code": "product_or_service_code",
    "program_acronym": "program_acronym",
    "other_than_full_and_open_c": "other_than_full_and_open_competition",
    "recovered_materials_sustai": "recovered_materials_sustainability",
    "research": "research",
    "sea_transportation": "sea_transportation",
    "service_contract_act": "service_contract_act",
    "small_business_competitive": "small_business_competitiveness_demonstration _program",
    "solicitation_identifier": "solicitation_identifier",
    "solicitation_procedures": "solicitation_procedures",
    "fair_opportunity_limited_s": "fair_opportunity_limited_sources",
    "subcontracting_plan": "subcontracting_plan",
    "program_system_or_equipmen": "program_system_or_equipment_code",
    ...
    "historically_underutilized": "historically_underutilized_business_zone _hubzone_firm",
    ...
    "referenced_idv_modificatio": "referenced_idv_modification_number",
    ...
    "ussgl483100_undelivered_or_cpe": "ussgl483100_undelivered_orders_oblig_transferred_unpaid_cpe",
    "ussgl488100_upward_adjustm_cpe": "ussgl488100_upward_adjust_pri_undeliv_order_oblig_unpaid_cpe",
    "obligations_undelivered_or_fyb": "obligations_undelivered_orders_unpaid_total_fyb",
    "obligations_undelivered_or_cpe": "obligations_undelivered_orders_unpaid_total_cpe",
    "ussgl490100_delivered_orde_fyb": "ussgl490100_delivered_orders_obligations_unpaid_fyb",
    "ussgl490100_delivered_orde_cpe": "ussgl490100_delivered_orders_obligations_unpaid_cpe",
    "ussgl493100_delivered_orde_cpe": "ussgl493100_delivered_orders_oblig_transferred_unpaid_cpe",
    "ussgl498100_upward_adjustm_cpe": "ussgl488100_upward_adjust_pri_undeliv_order_oblig_unpaid_cpe",
    "obligations_delivered_orde_fyb": "obligations_delivered_orders_unpaid_total_fyb",
    "obligations_delivered_orde_cpe": "obligations_delivered_orders_unpaid_total_cpe",
    "ussgl480200_undelivered_or_fyb": "ussgl480200_undelivered_orders_oblig_prepaid_advanced_fyb",
    "ussgl480200_undelivered_or_cpe": "ussgl480200_undelivered_orders_oblig_prepaid_advanced_cpe",
    "ussgl483200_undelivered_or_cpe": "ussgl483200_undeliv_orders_oblig_transferred_prepaid_adv_cpe",
    "ussgl488200_upward_adjustm_cpe": "ussgl488200_up_adjust_pri_undeliv_order_oblig_ppaid_adv_cpe",
    "gross_outlays_undelivered_fyb": "gross_outlays_undelivered_orders_prepaid_total_fyb",
    "gross_outlays_undelivered_cpe": "gross_outlays_undelivered_orders_prepaid_total_cpe",
    "ussgl490200_delivered_orde_cpe": "ussgl490200_delivered_orders_obligations_paid_cpe",
    "ussgl490800_authority_outl_fyb": "ussgl490800_authority_outlayed_not_yet_disbursed_fyb",
    "ussgl490800_authority_outl_cpe": "ussgl490800_authority_outlayed_not_yet_disbursed_cpe",
    "ussgl498200_upward_adjustm_cpe": "ussgl498200_upward_adjust_pri_deliv_orders_oblig_paid_cpe",
    "gross_outlays_delivered_or_fyb": "gross_outlays_delivered_orders_paid_total_fyb",
    "gross_outlays_delivered_or_cpe": "gross_outlays_delivered_orders_paid_total_cpe",
    "gross_outlay_amount_by_awa_fyb": "gross_outlay_amount_by_award_fyb",
    "gross_outlay_amount_by_awa_cpe": "gross_outlay_amount_by_award_cpe",
    "obligations_incurred_byawa_cpe": "obligations_incurred_total_by_award_cpe",
    "ussgl487100_downward_adjus_cpe": "ussgl487100_down_adj_pri_unpaid_undel_orders_oblig_recov_cpe",
    "ussgl497100_downward_adjus_cpe": "ussgl497100_down_adj_pri_unpaid_deliv_orders_oblig_recov_cpe",
    "ussgl487200_downward_adjus_cpe": "ussgl487200_down_adj_pri_ppaid_undel_orders_oblig_refund_cpe",
    "ussgl497200_downward_adjus_cpe": "ussgl497200_down_adj_pri_paid_deliv_orders_oblig_refund_cpe",
    "deobligations_recov_by_awa_cpe": "deobligations_recoveries_refunds_of_prior_year_by_award_cpe",
    "gross_outlay_amount_by_pro_fyb": "gross_outlay_amount_by_program_object_class_fyb",
    "gross_outlay_amount_by_pro_cpe": "gross_outlay_amount_by_program_object_class_cpe",
    "obligations_incurred_by_pr_cpe": "obligations_incurred_by_program_object_class_cpe",
    "deobligations_recov_by_pro_cpe": "deobligations_recoveries_refund_pri_program_object_class_cpe",
    "sub_awardee_or_recipient_l": "sub_recipient_name",
    "sub_awardee_or_recipient_u": "sub_recipient_unique_id",
    "sub_awardee_ultimate_pa_id": "sub_recipient_ultimate_parent_unique_id",
    "sub_awardee_ultimate_paren": "sub_recipient_ultimate_parent_name",
    "legal_entity_foreign_posta": "recipient_foreign_postal_code",
    "high_comp_officer_full_nam": "high_comp_officer_full_name",
    ...
    "place_of_performance_addre": "primary_place_of_performance_address_line1",
    "place_of_performance_zip4": "primary_place_of_performance_zip4",
    "place_of_perform_country_n": "primary_place_of_performance_country_name",
    ...
    "high_comp_officer_first_na": "high_comp_officer_first_name",
    "high_comp_officer_middle_i": "high_comp_officer_middle_initial",
    "high_comp_officer_last_nam": "high_comp_officer_last_name",
    "action_type": "action_type",
    ...
    "legal_entity_city_code": "recipient_city_code",
    "legal_entity_county_name": "recipient_county_name",
    "legal_entity_county_code": "recipient_county_code",
    "legal_entity_state_name": "recipient_state_name",
    "legal_entity_zip5": "recipient_zip5",
    "legal_entity_zip_last4": "recipient_zip_last4",
    "legal_entity_foreign_city": "recipient_foreign_city_name",
    "legal_entity_foreign_provi": "recipient_foreign_province_name",
    "business_types": "business_types",
    "cfda_number": "cfda_number",
    "cfda_title": "cfda_title",
    "place_of_performance_code": "primary_place_of_performance_code",
    "place_of_perform_state_nam": "primary_place_of_performance_state_name",
    "place_of_perform_county_na": "primary_place_of_performance_county_name",
    "place_of_performance_forei": "primary_place_of_performance_foreign_location_description",
    ...
    "ussgl498200_upward_adjustm_cpe": "ussgl498100_upward_adjust_pri_deliv_orders_oblig_unpaid_cpe"
}
...
LONG_TO_TERSE_LABELS = {
    ...
    "ussgl488100_upward_adjust_pri_undeliv_order_oblig_unpaid_cpe": "ussgl498100_upward_adjustm_cpe",
    ...
    "ussgl498100_upward_adjust_pri_deliv_orders_oblig_unpaid_cpe": "ussgl498200_upward_adjustm_cpe",
