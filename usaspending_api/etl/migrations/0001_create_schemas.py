...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        # -----
        migrations.RunSQL(
            sql="CREATE SCHEMA IF NOT EXISTS raw;", reverse_sql="DROP SCHEMA raw;"
        ),
        migrations.RunSQL(
            sql="CREATE SCHEMA IF NOT EXISTS int;", reverse_sql="DROP SCHEMA int;"
        ),
        migrations.RunSQL(
            sql="CREATE SCHEMA IF NOT EXISTS temp;", reverse_sql="DROP SCHEMA temp;"
        ),
        migrations.RunSQL(
            sql="CREATE SCHEMA IF NOT EXISTS rpt;", reverse_sql="DROP SCHEMA rpt;"
        ),
        # -----
