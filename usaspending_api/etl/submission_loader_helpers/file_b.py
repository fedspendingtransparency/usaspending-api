    ...
    if dupe_oc_count == 0:
        ...
        combine_dupe_oc = f"""
            select
                ...
                sum(ussgl480110_reinstated_del_cpe) as ussgl480110_reinstated_del_cpe,
                ...
                sum(ussgl490110_reinstated_del_cpe) as ussgl490110_reinstated_del_cpe,
