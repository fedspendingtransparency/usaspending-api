...
def agency_data():
    ...
    fpds_transaction1 = baker.make(TransactionFPDS, detached_award_proc_unique="4732_4730_GSMPNB710761_0_GS06F0007J_0")
    fpds_transaction2 = baker.make(
        TransactionFPDS, detached_award_proc_unique="4740_4740_GS02B2365011120_0_GS02B23650_0"
    )
    fpds_transaction3 = baker.make(TransactionFPDS, detached_award_proc_unique="9700_9700_0003_24_W52P1J10D0022_1")
    fpds_transaction4 = baker.make(
        TransactionFPDS, detached_award_proc_unique="9700_-none-_FA520908P0219_P00004_-none-_0"
    )
    fpds_transaction5 = baker.make(TransactionFPDS, detached_award_proc_unique="9700_9700_N407_1_N0017804D4113_14")
