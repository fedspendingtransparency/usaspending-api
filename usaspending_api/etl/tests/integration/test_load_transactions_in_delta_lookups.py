...
class TestInitialRun:
    ...
    def initial_run(
        s3_data_bucket,
        load_source_tables=True,
        load_other_raw_tables=None,
        initial_copy=True,
    ):
    ...
    @staticmethod
    def verify_transaction_ids(
        spark, expected_transaction_id_lookup, expected_last_load=None
    ):
        ...
        with connection.cursor() as cursor:
            cursor.execute(
                f"SELECT setval('transaction_id_seq', {max_transaction_id}, false)"
            )
    ...
    def verify_award_ids(spark, expected_award_id_lookup, expected_last_load=None):
        ...
        query = (
            "SELECT * FROM int.award_id_lookup ORDER BY award_id, transaction_unique_id"
        )
        delta_data = [row.asDict() for row in spark.sql(query).collect()]
        ...
        if expected_award_id_lookup:
            assert max_award_id == max(
                [award["award_id"] for award in expected_award_id_lookup]
            )
        else:
    ...
    def verify_lookup_info(
        ...
        TestInitialRun.verify_award_ids(
            spark, expected_award_id_lookup, expected_load_load_award_id_lookup
        )
    ...
    def verify(
        ...
        actual_count = spark.sql(
            "SELECT COUNT(*) AS count from int.award_ids_delete_modified"
        ).collect()[0]["count"]
        ...
        for table_name, expected_count, _expected_last_load, col_names in zip(
            ...
            actual_count = spark.sql(
                f"SELECT COUNT(*) AS count from int.{table_name}"
            ).collect()[0]["count"]
            ...
            if expected_count > 0:
                ...
                try:
                    ...
                    TestInitialRun.verify_raw_vs_int_tables(
                        spark, table_name, col_names
                    )
...
class _InitialRunWithPostgresLoader:
    expected_initial_transaction_id_lookup = [
        {
            "transaction_id": id,
            "is_fpds": False,
            "transaction_unique_id": _INITIAL_ASSISTS[id - 1][
    ...
    ] + [
        {
            "transaction_id": id,
            "is_fpds": True,
            "transaction_unique_id": _INITIAL_PROCURES[id - 6][
                "detached_award_proc_unique"
            ].upper(),
        }
        for id in range(
            len(_INITIAL_ASSISTS) + 1,
            len(_INITIAL_ASSISTS) + len(_INITIAL_PROCURES) + 1,
        )
    ]
    ...
    expected_initial_award_id_lookup = [
    ...
    ] + [
        {
            "award_id": (
                ...
                + max(
                    [
                        int(assist["unique_award_key"].split("_")[-1])
                        for assist in _INITIAL_ASSISTS
                    ]
                )
            ),
    ...
    expected_initial_transaction_fabs = [
        {
            **assist,
            "action_date": dateutil.parser.parse(assist["action_date"])
            .date()
            .isoformat(),
    ...
    expected_initial_transaction_fpds = [
        {
            **procure,
            "action_date": dateutil.parser.parse(procure["action_date"])
            .date()
            .isoformat(),
            "detached_award_proc_unique": procure["detached_award_proc_unique"].upper(),
            "transaction_id": procure["detached_award_procurement_id"]
            + len(_INITIAL_ASSISTS),
...
class TestInitialRunNoPostgresLoader:
    expected_initial_transaction_id_lookup = [
        {
            "transaction_id": 1,
            "is_fpds": False,
            "transaction_unique_id": _INITIAL_ASSISTS[0][
                "afa_generated_unique"
            ].upper(),
        },
        {
            "transaction_id": 2,
            "is_fpds": True,
            "transaction_unique_id": _INITIAL_PROCURES[0][
                "detached_award_proc_unique"
            ].upper(),
        },
        {
            "transaction_id": 3,
            "is_fpds": False,
            "transaction_unique_id": _INITIAL_ASSISTS[1][
                "afa_generated_unique"
            ].upper(),
        },
        {
            "transaction_id": 4,
            "is_fpds": True,
            "transaction_unique_id": _INITIAL_PROCURES[1][
                "detached_award_proc_unique"
            ].upper(),
        },
        {
            "transaction_id": 5,
            "is_fpds": False,
            "transaction_unique_id": _INITIAL_ASSISTS[2][
                "afa_generated_unique"
            ].upper(),
        },
        {
            "transaction_id": 6,
            "is_fpds": True,
            "transaction_unique_id": _INITIAL_PROCURES[2][
                "detached_award_proc_unique"
            ].upper(),
        },
        {
            "transaction_id": 7,
            "is_fpds": False,
            "transaction_unique_id": _INITIAL_ASSISTS[3][
                "afa_generated_unique"
            ].upper(),
        },
        {
            "transaction_id": 8,
            "is_fpds": False,
            "transaction_unique_id": _INITIAL_ASSISTS[4][
                "afa_generated_unique"
            ].upper(),
        },
        {
            "transaction_id": 9,
            "is_fpds": True,
            "transaction_unique_id": _INITIAL_PROCURES[3][
                "detached_award_proc_unique"
            ].upper(),
        },
        {
            "transaction_id": 10,
            "is_fpds": True,
            "transaction_unique_id": _INITIAL_PROCURES[4][
                "detached_award_proc_unique"
            ].upper(),
        },
    ]
    ...
    expected_initial_award_id_lookup = [
        {
            ...
            "generated_unique_award_id": _INITIAL_ASSISTS[0][
                "unique_award_key"
            ].upper(),
        },
        {
            ...
            "generated_unique_award_id": _INITIAL_ASSISTS[1][
                "unique_award_key"
            ].upper(),
        },
        {
            ...
            "generated_unique_award_id": _INITIAL_ASSISTS[2][
                "unique_award_key"
            ].upper(),
        },
        {
            ...
            "generated_unique_award_id": _INITIAL_PROCURES[0][
                "unique_award_key"
            ].upper(),
        },
        {
            ...
            "generated_unique_award_id": _INITIAL_PROCURES[1][
                "unique_award_key"
            ].upper(),
        },
        {
            ...
            "generated_unique_award_id": _INITIAL_PROCURES[2][
                "unique_award_key"
            ].upper(),
        },
        {
            ...
            "generated_unique_award_id": _INITIAL_ASSISTS[3][
                "unique_award_key"
            ].upper(),
        },
        {
            ...
            "generated_unique_award_id": _INITIAL_ASSISTS[4][
                "unique_award_key"
            ].upper(),
        },
        {
            ...
            "generated_unique_award_id": _INITIAL_PROCURES[3][
                "unique_award_key"
            ].upper(),
        },
        {
            ...
            "generated_unique_award_id": _INITIAL_PROCURES[4][
                "unique_award_key"
            ].upper(),
        },
    ]
    ...
    initial_transaction_normalized = [
        {
            ...
            "action_date": dateutil.parser.parse(
                _INITIAL_ASSISTS[0]["action_date"]
            ).date(),
        ...
        },
        {
            ...
            "business_categories": [],
            "action_date": dateutil.parser.parse(
                _INITIAL_PROCURES[0]["action_date"]
            ).date(),
            "create_date": initial_award_trans_norm_update_create_date,
            "transaction_unique_id": _INITIAL_PROCURES[0][
                "detached_award_proc_unique"
        ...
        },
        {
            ...
            "business_categories": [],
            "action_date": dateutil.parser.parse(
                _INITIAL_ASSISTS[1]["action_date"]
            ).date(),
            "create_date": initial_award_trans_norm_update_create_date,
            "transaction_unique_id": _INITIAL_ASSISTS[1][
                "afa_generated_unique"
        ...
        },
        {
            ...
            "business_categories": [],
            "action_date": dateutil.parser.parse(
                _INITIAL_PROCURES[1]["action_date"]
            ).date(),
            "create_date": initial_award_trans_norm_update_create_date,
            "transaction_unique_id": _INITIAL_PROCURES[1][
                "detached_award_proc_unique"
        ...
        },
        {
            ...
            "business_categories": [],
            "action_date": dateutil.parser.parse(
                _INITIAL_ASSISTS[2]["action_date"]
            ).date(),
            "create_date": initial_award_trans_norm_update_create_date,
            "transaction_unique_id": _INITIAL_ASSISTS[2][
                "afa_generated_unique"
        ...
        },
        {
            ...
            "business_categories": [],
            "action_date": dateutil.parser.parse(
                _INITIAL_PROCURES[2]["action_date"]
            ).date(),
            "create_date": initial_award_trans_norm_update_create_date,
            "transaction_unique_id": _INITIAL_PROCURES[2][
                "detached_award_proc_unique"
        ...
        },
        {
            ...
            "business_categories": [],
            "action_date": dateutil.parser.parse(
                _INITIAL_ASSISTS[3]["action_date"]
            ).date(),
            "create_date": initial_award_trans_norm_update_create_date,
            "transaction_unique_id": _INITIAL_ASSISTS[3][
                "afa_generated_unique"
        ...
        },
        {
            ...
            "business_categories": [],
            "action_date": dateutil.parser.parse(
                _INITIAL_ASSISTS[4]["action_date"]
            ).date(),
            "create_date": initial_award_trans_norm_update_create_date,
            "transaction_unique_id": _INITIAL_ASSISTS[4][
                "afa_generated_unique"
        ...
        },
        {
            ...
            "business_categories": [],
            "action_date": dateutil.parser.parse(
                _INITIAL_PROCURES[3]["action_date"]
            ).date(),
            "create_date": initial_award_trans_norm_update_create_date,
            "transaction_unique_id": _INITIAL_PROCURES[3][
                "detached_award_proc_unique"
    ...
    initial_transaction_fabs = [
        ...
        {
            **_INITIAL_ASSISTS[4],
            "action_date": dateutil.parser.parse(_INITIAL_ASSISTS[4]["action_date"])
            .date()
            .isoformat(),
    ...
    initial_transaction_fpds = [
        ...
        {
            **_INITIAL_PROCURES[3],
            "action_date": dateutil.parser.parse(_INITIAL_PROCURES[3]["action_date"])
            .date()
            .isoformat(),
            "detached_award_proc_unique": _INITIAL_PROCURES[3][
                "detached_award_proc_unique"
            ].upper(),
            "transaction_id": 9,
            "unique_award_key": _INITIAL_PROCURES[3]["unique_award_key"].upper(),
        ...
        {
            **_INITIAL_PROCURES[4],
            "action_date": dateutil.parser.parse(_INITIAL_PROCURES[4]["action_date"])
            .date()
            .isoformat(),
            "detached_award_proc_unique": _INITIAL_PROCURES[4][
                "detached_award_proc_unique"
            ].upper(),
            "transaction_id": 10,
            "unique_award_key": _INITIAL_PROCURES[4]["unique_award_key"].upper(),
    ...
    @mark.django_db(transaction=True)
    @patch(
        "usaspending_api.etl.management.commands.load_transactions_in_delta.Command._insert_orphaned_transactions"
    )
    ...
    def test_happy_path_scenarios(
        ...
        load_other_raw_tables = [
            _TableLoadInfo(
                spark, "transaction_normalized", self.initial_transaction_normalized
            ),
        ...
        TestInitialRun.initial_run(
            s3_unittest_data_bucket, False, load_other_raw_tables
        )
        kwargs["expected_last_load_transaction_normalized"] = (
            _INITIAL_SOURCE_TABLE_LOAD_DATETIME
        )
        kwargs["expected_last_load_transaction_fabs"] = (
            _INITIAL_SOURCE_TABLE_LOAD_DATETIME
        )
        kwargs["expected_last_load_transaction_fpds"] = (
            _INITIAL_SOURCE_TABLE_LOAD_DATETIME
        )
        TestInitialRun.verify(
            spark,
...
class TestTransactionIdLookup:
    ...
    def test_unexpected_paths(
        ...
        TestInitialRun.initial_run(
            s3_unittest_data_bucket, load_source_tables=False, initial_copy=False
        )
        kwargs = {
            "expected_last_load_transaction_id_lookup": _BEGINNING_OF_TIME,
            "expected_last_load_award_id_lookup": _BEGINNING_OF_TIME,
    ...
    def _happy_path_test_core(
        ...
        update_last_load_date(
            "source_assistance_transaction", last_assist_load_datetime
        )
        load_delta_table_from_postgres("published_fabs", s3_data_bucket)
        call_command(
            "load_transactions_in_delta", "--etl-level", "transaction_id_lookup"
        ...
        update_last_load_date(
            "source_procurement_transaction", last_procure_load_datetime
        )
        load_delta_table_from_postgres("detached_award_procurement", s3_data_bucket)
        ...
        expected_transaction_id_lookup.append(
            {
                "transaction_id": 12,
                "is_fpds": True,
                "transaction_unique_id": _NEW_PROCURE[
                    "detached_award_proc_unique"
                ].upper(),
            }
        )
    ...
    def test_happy_path_scenarios_no_pg_loader(
        ...
        load_other_raw_tables = [
            ...
            _TableLoadInfo(
                spark, "awards", TestInitialRunNoPostgresLoader.initial_awards
            ),
        ]
...
class TestAwardIdLookup:
    ...
    def test_unexpected_paths(
        ...
        expected_award_id_lookup = deepcopy(
            _InitialRunWithPostgresLoader.expected_initial_award_id_lookup
        )
    ...
    def _happy_path_test_core(
        ...
        assert (
            max_award_id
            == max(
                [award["id"] for award in TestInitialRunNoPostgresLoader.initial_awards]
            )
            + 1
        )  # Add one for the insert
        ...
        assert equal_datasets(
            [{"award_id": partially_deleted_award_id}], delta_data, ""
        )
