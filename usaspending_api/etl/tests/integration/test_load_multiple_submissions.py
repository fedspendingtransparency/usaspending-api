        ...
        with connection.cursor() as cursor:
            ...
            cursor.execute(
                ...
                insert into certified_object_class_program_activity (
                    ...
                    (5, 2, 1, '101', 'D', 5555, null),
                    (6, 2, 1, '101', 'D', 6666, null),
                    (7, 3, 2, '101', 'D', 7777, 'L'),
                    (8, 3, 2, '1010', 'D', 8888, 'L'),
                    (9, 3, 2, '101', 'D', 9999, 'L'),
                    (10, 4, 2, '101', 'D', 1010, null),
            ...
            cursor.execute(
                ...
                insert into certified_award_financial (
                    ...
                    (1, 1, 1, '101', 'D', 11111, 111110, -11, -111, null),
                    (2, 1, 1, '1010', 'D', 22222, 222220, -22, -222, 'B'),
                    (3, 1, 1, '101', 'D', 33333, 333330, -33, -333, 'L'),
                    (4, 2, 1, '1010', 'D', 44444, 444440, -44, -444, null),
                    (5, 2, 1, '101', 'D', 55555, 555550, -55, -555, null),
                    (6, 2, 1, '101', 'D', 66666, 666660, -66, -666, null),
                    (7, 3, 2, '1010', 'D', 77777, 777770, -77, -777, 'L'),
                    (8, 3, 2, '1010', 'D', 88888, 888880, -88, -888, 'L'),
                    (9, 3, 2, '101', 'D', 99999, 999990, -99, -999, 'L'),
                    (10, 4, 2, '1010', 'D', 10101, 101010, -10, -101, null),
                    (11, 5, 2, '1010', 'D', 11111, 111110, 0, 0, 'B'),
                    (12, 5, 2, '101', 'D', null, null, 0, 0, 'M'), -- this should not load because of 0/null values
                    (13, 5, 2, '101', 'D', 0, 0, null, 0, 'M'), -- this should not load because of 0/null values
                    ...
                    (17, 7, 2, '101', 'D', 13131, 131310, -13, -131, 'N'),
                    (18, 5, 2, '101', 'D', 0, 0, 0, -1010, 'N')
                )
                """
            )
