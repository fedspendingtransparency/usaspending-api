        ...
        with connection.cursor() as cursor:
            ...
            cursor.execute(
                ...
                insert into certified_object_class_program_activity (
                    ...
                    (1, 1, 1, '1010', 1111, null),
                    (2, 1, 1, '101', 2222, 'B'),
                    (3, 1, 1, '101', 3333, 'L'),
                    (4, 2, 1, '1010', 4444, null),
                    (5, 2, 1, '101', 5555, null),
                    (6, 2, 1, '101', 6666, null),
                    (7, 3, 2, '101', 7777, 'L'),
                    (8, 3, 2, '1010', 8888, 'L'),
                    (9, 3, 2, '101', 9999, 'L'),
                    (10, 4, 2, '101', 1010, null),
                    (11, 5, 2, '1010', 1111, 'B'),
                    (12, 6, 2, '1010', 1212, 'L'),
                    (13, 7, 2, '1010', 1313, 'N')
                )
            ...
            cursor.execute(
                ...
                insert into certified_award_financial (
                    ...
                    (1, 1, 1, '101', 11111, 111110, -11, -111, null),
                    (2, 1, 1, '1010', 22222, 222220, -22, -222, 'B'),
                    (3, 1, 1, '101', 33333, 333330, -33, -333, 'L'),
                    (4, 2, 1, '1010', 44444, 444440, -44, -444, null),
                    (5, 2, 1, '101', 55555, 555550, -55, -555, null),
                    (6, 2, 1, '101', 66666, 666660, -66, -666, null),
                    (7, 3, 2, '1010', 77777, 777770, -77, -777, 'L'),
                    (8, 3, 2, '1010', 88888, 888880, -88, -888, 'L'),
                    (9, 3, 2, '101', 99999, 999990, -99, -999, 'L'),
                    (10, 4, 2, '1010', 10101, 101010, -10, -101, null),
                    (11, 5, 2, '1010', 11111, 111110, 0, 0, 'B'),
                    (12, 5, 2, '101', null, null, 0, 0, 'M'), -- this should not load because of 0/null values
                    (13, 5, 2, '101', 0, 0, null, 0, 'M'), -- this should not load because of 0/null values
                    (14, 5, 2, '1010', null, 0, null, 0, 'M'), -- this should not load because of 0/null values
                    (15, 5, 2, '1010', 0, null, 0, null, 'M'), -- this should not load because of 0/null values
                    (16, 6, 2, '1010', 12121, 121210, -12, -121, 'L'),
                    (17, 7, 2, '101', 13131, 131310, -13, -131, 'N'),
                    (18, 5, 2, '101', 0, 0, 0, -1010, 'N')
                )
                """
            )
