...
class Command(BaseCommand):
    help = """
        This command reads transaction fpds data from source / bronze tables in delta and creates the delta silver tables.
    """
    ...
    def handle(*args, **options):
        with prepare_spark() as spark:
            loader = FPDSDeltaTransactionLoader(spark=spark, spark_s3_bucket=options["spark_s3_bucket"])
