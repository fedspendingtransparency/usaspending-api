...
from usaspending_api.etl.elasticsearch_loader_helpers.controller_for_spark import Controller, ensure_view_exists
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        ensure_view_exists(config["sql_view"], spark)
        error_addition = ""
        loader = Controller(config, spark)
...
def parse_cli_args(options: dict, es_client) -> dict:
    ...
    if config["is_incremental_load"] or config["deletes_only"]:
        ...
        # TODO: re-enable write-alias override after testing
