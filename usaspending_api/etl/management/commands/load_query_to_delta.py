...
from usaspending_api.download.delta_models.treasury_account import (
    TREASURY_ACCOUNT_DOWNLOAD_POSTGRES_COLUMNS,
    treasury_account_download_create_sql_string,
    treasury_account_download_load_sql_string,
)
...
TABLE_SPEC = {
    ...
    "treasury_account_download": {
        "model": None,
        "is_from_broker": False,
        "source_query": [treasury_account_download_load_sql_string],
        "source_query_incremental": None,
        "source_database": None,
        "source_table": None,
        "destination_database": "rpt",
        ...
        "partition_column_type": "numeric",
        "is_partition_column_unique": False,
        "delta_table_create_sql": treasury_account_download_create_sql_string,
        "source_schema": TREASURY_ACCOUNT_DOWNLOAD_POSTGRES_COLUMNS,
        "custom_schema": None,
        "column_names": list(TREASURY_ACCOUNT_DOWNLOAD_POSTGRES_COLUMNS),
        "postgres_seq_name": None,
        "tsvectors": None,
        "postgres_partition_spec": None,
    },
