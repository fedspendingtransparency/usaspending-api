...
TABLE_SPEC = {
    ...
    "transaction_search_gold": TableSpec(
        model=TransactionSearch,
        is_from_broker=False,
        source_query=load_transaction_search,
        source_query_incremental=load_transaction_search_incremental,
    ...
    "account_balances_download": TableSpec(
        model=None,
        is_from_broker=False,
    ...
    "award_financial_download": TableSpec(
        model=None,
        is_from_broker=False,
    ...
    "object_class_program_activity_download": TableSpec(
        model=None,
        is_from_broker=False,
    ...
    "transaction_download": TableSpec(
        model=None,
        is_from_broker=False,
