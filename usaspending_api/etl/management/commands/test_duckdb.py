...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        ###################
        print("#" * 50)
        print(f"OS available memory:\t\t{psutil.virtual_memory().available / (1024**3):.2f} GB")
        print(f"OS free memory:\t\t\t{psutil.virtual_memory().free / (1024**3):.2f} GB")
        ...
        print(f"\nDuckDB threads limit:\t\t{duckdb_threads_limit}")
        print("#" * 50)
