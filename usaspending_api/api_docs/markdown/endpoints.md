...
|[/api/v2/agency/<TOPTIER_AGENCY_CODE\>//api/v2/agency/<TOPTIER_AGENCY_CODE\>/subcomponents/<BUREAU_SLUG\>/](/api/v2/agency/012/subcomponents/farm-service-agency/)|GET| Returns a list of federal_accounts by bureau for the agency in a single fiscal year |
