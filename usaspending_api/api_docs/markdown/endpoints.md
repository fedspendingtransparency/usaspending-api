...
|[/api/v2/search/spending_by_category/country/](/api/v2/search/spending_by_category/country/)|POST| Returns data that is grouped in preset units to support the Spending by Country data visualizations on USAspending.gov's Advanced Search page|
