...
| -------- | ------- | ----------- |
|[/api/v2/agency/<AGENCY_ID\>/program_activity/count/](/api/v2/agency/100/program_activity/count/)|GET| Returns the count of unique Program Activity categories for the agency in a single fiscal year |
