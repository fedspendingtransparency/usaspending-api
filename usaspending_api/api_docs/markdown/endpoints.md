...
|[/api/v2/search/spending_by_category/cfda/](/api/v2/search/spending_by_category/cfda/)|POST| Returns data that is grouped in preset units to support the Spending by CFDA Program data visualizations on USAspending.gov's Advanced Search page|
