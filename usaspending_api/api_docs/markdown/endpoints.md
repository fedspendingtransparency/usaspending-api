...
| -------- | ------- | ----------- |
|[/](/)|GET| Home Page and Documentation|
...
|[/api/v2/download/status](/api/v2/download/status)|POST| gets the current status of a download job that that has been requested with the v2/download/awards/ or v2/download/transaction/ endpoint that same day|
