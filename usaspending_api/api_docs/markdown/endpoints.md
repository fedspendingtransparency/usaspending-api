...
|[/api/v2/federal_accounts/<ACCOUNT_CODE\>/pogram_activities/total](/api/v2/federal_account/020-0550/program_activities/total/)|GET| Returns a list of program activities including the sum of their obligations under a federal account based on its federal account code in |
